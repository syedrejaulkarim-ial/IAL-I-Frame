...
namespace iFrames.HDFCSIP
{
    public partial class HDFCSIP : System.Web.UI.Page
    {
        ...
        {
            this.sipbtnshow.Attributes.Add("onclick", "javascript:return validateHDFC();");// Add ClientSide Script for Data Validation function defined in check.js
        ...
        protected void FillNature()
        {
            try
            {
                using (var natureData = new PrincipalCalcDataContext())
                {
                    ...
                    //edited 22-01-2019 by client requirement
        ...
        public void FillDropdownScheme()
        {
            ...
            //edited 22-01-2019 as per client requirement
		...
		public void CalculateReturn()
        {
            ...
            try
            {
                ...
                if (PrdVal == 1)
                {
                    ...
                    // To change Somabrata 14/12/2016
                ...
                {
                    // To Change Somabrata 14/11/2016
                    if (schmeId.ToString().Trim() == "2631" || schmeId.ToString().Trim() == "2632" || schmeId.ToString().Trim() == "16818" || schmeId.ToString().Trim() == "16819")
                    {
        ...
        public void CalculateReturnSTP()
        {
            ...
            try
            {
                ...
                // Somabrata Commented 20.04/2017
        ...
        private void PerformanceReturn()
        {
            ...
            using (var hdfcData = new SIP_ClientDataContext())
            {

                var strNature = (from natr in hdfcData.T_SCHEMES_NATURE_Clients
                                 where natr.Nature_ID == (
                                 from tfm in hdfcData.T_FUND_MASTER_clients
                                 where tfm.FUND_ID ==
                                 (from tsm in hdfcData.T_SCHEMES_MASTER_Clients
            ...
            try
            {
                ...
                if (CompundReturnDayValIndex != 0)
                {
					...
					//dtLsTable.Rows.Add(txtddlsipbnmark.Text, txtinstallLs.Text.ToString(), CompundReturnDayValIndex, profitIndex, daysDiffValINdex);//Comment by koustav 
        ...
        private void SetDistributorCredential()
        {
            ...
            #region Code To Insert Distributor Info Blocked
        ...
        protected void ShowRelativeDiv()
        {
            ...
            {
                trSipInvst.Style.Remove("display");
                ...
                trCategory.Visible = true; lblSchemeName.InnerText = "Scheme Name"; trTransferTo.Visible = false;
                trBenchmark.Visible = true; lblInstallmentAmt.InnerText = "Installment Amount (Rs.)";
                lblDiffDate.InnerText = "SIP Date";
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "LUMP SUM")
            {
                ...
                trLumpInvst.Visible = true; trInitialInvst.Visible = false; 
                //trSipInvst.Visible = false;
                trSipInvst.Style.Add("display", "none");
                trCategory.Visible = true; lblSchemeName.InnerText = "Scheme Name"; trTransferTo.Visible = false;
                trBenchmark.Visible = true; lblInstallmentAmt.InnerText = "Installment Amount (Rs.)";
                lblDiffDate.InnerText = "SIP Date";
                // trTransferWithdrawal.Visible = false;
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
            {
                ...
                trCategory.Visible = true; lblSchemeName.InnerText = "Scheme Name"; trTransferTo.Visible = false;
                trBenchmark.Visible = true; lblInstallmentAmt.InnerText = "Installment Amount (Rs.)";
                txtinstall.Attributes["placeholder"] = "Installment Amount";
                lblDiffDate.InnerText = "SIP Date";
                //trTransferWithdrawal.Visible = false; 
                GridViewSIPResult.Visible = true;
                lblTransferWithdrawal.Visible = false; txtTransferWithdrawal.Visible = false;
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
            {
                ...
                GridViewResultLS.Visible = false; GridViewLumpSum.Visible = false;
                trSipInvst.Visible = true; trLumpInvst.Visible = false; trInitialInvst.Visible = false;
                trCategory.Visible = true; lblSchemeName.InnerText = "Transfer From"; trTransferTo.Visible = false;
                trBenchmark.Visible = false; lblInstallmentAmt.InnerText = "Initial Amount (Rs.)";
                txtinstall.Attributes["placeholder"] ="Initial Amount";
                lblDiffDate.InnerText = "SWP Date";
                //trTransferWithdrawal.Visible = true;
                GridViewSIPResult.Visible = true;
                lblTransferWithdrawal.Visible = true; txtTransferWithdrawal.Visible = true;
                lblTransferWithdrawal.InnerText = "Withdrawal Amount (Rs.)";
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
            {
                ...
                GridViewResultLS.Visible = false; GridViewLumpSum.Visible = false;
                trSipInvst.Visible = true; trLumpInvst.Visible = false; trInitialInvst.Visible = false;
                trCategory.Visible = false; lblSchemeName.InnerText = "Transfer From"; trTransferTo.Visible = true;
                trBenchmark.Visible = false; lblInstallmentAmt.InnerText = "Investment Amount (Rs.)";
                txtinstall.Attributes["placeholder"] = "Investment Amount";
                lblDiffDate.InnerText = "STP Date";
                //trTransferWithdrawal.Visible = true;
                GridViewSIPResult.Visible = true;
                if (!trInception.Visible) trInception.Visible = true;
                lblTransferWithdrawal.Visible = true; txtTransferWithdrawal.Visible = true;
                lblTransferWithdrawal.InnerText = "Transfer Amount (Rs.)";
                txtTransferWithdrawal.Attributes["placeholder"] = "Transfer Amount";
        ...
        private void ShowExcel()
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=HDFC_Detail_Report.xls");
            Response.Charset = "";
            ...
            ImagePath = HttpContext.Current.Server.MapPath("~") + "HDFC_SIP\\img\\";
            ...
            //objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;	font-family: 'Roboto', sans-serif;	color: #ffffff;	font-size: 12px;	font-weight:normal;	line-height: 20px;	background:#113781;	height:25px; width:15px '");
            objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;	font-family: 'Roboto', sans-serif;	color: #ffffff;	font-size: 12px;background:#f7f7f7;	font-weight:normal;'");
            //objFinalstr.Replace(@"class=""grdRow""", "style=' border: #d0d6db solid 1px;    text-align: center; background-color: #ffffff;    font-family: 'Roboto', sans-serif;    color: #000;    font-size: 11px;    font-weight: normal;'");
            //objFinalstr.Replace(@"class=""grdAltRow""", "style='background-color: #f4f4f4;    font-family: 'Roboto', sans-serif;    color: #000;    font-size: 11px; font-weight: normal;    border: #d0d6db solid 1px;     text-align: center;'");
            ...
            try
            {
                ...
                foreach (DataColumn dc in _dt.Columns)
                {
                    ...
                    else
                    {
                        ...
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#113781");// System.Drawing.Color.Blue;//#113781
                ...
                string localImgPath = @"HDFC_SIP\Img";
                ...
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "HDFC_SIP\\IMG", "HDFC_SIP_Temp*");
                ...
                imgPath = System.IO.Path.Combine(localImgPath, "HDFC_SIP_Temp" + Guid.NewGuid().ToString("N") + "_" + tmpChartName);
        ...
        public void BindDataTableToChartGeneralSTPTO(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt)
        {
            ...
            try
            {
                ...
                #region Delete MyRegion
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "HDFC_SIP\\IMG", "STPTO_Temp*");
                foreach (var f in allImageFiles)
                    if (File.GetCreationTime(f) < DateTime.Now.AddHours(-1))
                        File.Delete(f);
        ...
        public void CreateHTMLHDFCSIP()
        {
            ...
            var allFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "HDFC_SIP\\PDF", "HDFC_*");
            ...
            try
            {
                ...
                switch (RadioButtonListCustomerType.SelectedItem.Text.ToUpper().Trim())
                {
                    case "DISTRIBUTOR":
                        ...
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCPDFtemplate3.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCswpPDFtemplate_test.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCstpPDFtemplate_t.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCPDFTemplateInitial.html")));
                        }
                        else
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCLsPDFTemplate.html")));
                        }
                        break;
                    default:
                        if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCPDFtemplateWOD.html")));//
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCswpPDFtemplateWOD_test.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCstpPDFtemplateWOD_t.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCPDFTemplateInitialWOD.html")));
                        }
                        else
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/HDFC_SIP/HDFCLsPDFTemplateWOD.html")));
                        }
                        break;
                }
                ...
                gvFirstTablestr = "<div><table border='0' align='center' width='100%' style='border-collapse: collapse;'  cellpadding='0' cellspacing='0'>" + gvFirstTablestr.Substring(gvFirstTablestr.IndexOf("<th"));
                ...
                if (ddlMode.SelectedItem.Value.ToUpper().StartsWith("SIP"))
                {
                    //  gvFirstTablestr = gvFirstTablestr.Replace(@"scope=""col""", "style ='text-align: left;font-family: 'Roboto', sans-serif;color: #ffffff;font-size: 15px;font-weight: normal;background: #113781;height: 25px;'"); for header left


                    // for header center-Priyanka
                    gvFirstTablestr = gvFirstTablestr.Replace(@"scope=""col""", "style ='text-align:center;font-family: Roboto;color: #000;font-size: 12px;font-weight: normal;background: #f7f7f7;height: 40px; border-bottom:#dddddd solid 1px;vertical-align:middle'");
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""grdRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;'");//font-family:Trebuchet MS;
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""grdAltRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px; border-bottom:#dddddd solid 1px;'");//font-family:Trebuchet MS;
                }
                else// if (ddlMode.SelectedItem.Value.ToUpper() == "SWP")
                {
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""borderbottom""", "style = 'text-align:center;'");
                    gvFirstTablestr = gvFirstTablestr.Replace(@"scope=""col""", "style ='text-align: center;font-family: Roboto;color: #000;font-size: 12px;font-weight: normal;background: #f7f7f7;height: 40px;border-bottom:#dddddd solid 1px;vertical-align:middle'");
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""grdRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;'");//font-family:Trebuchet MS;
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""grdAltRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px; border-bottom:#dddddd solid 1px;'");//font-family:Trebuchet MS;
                }
                ...
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "LUMP SUM")
                {
                    ...
                    // = gvFirstTablestr.Replace(@"class=""borderbottom""", "style = 'border-top:black solid 1px;text-align:center;'");
                ...
                {
                    // somabrata
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""borderlefft""", "style = 'text-align:center;'");
                    //gvFirstTablestr = gvFirstTablestr.Replace(@"class=""borderbottom""", "style = 'border-bottom:#fff solid 1px;text-align:center;'");
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""leftal""", "style = 'width:250px;'");
                }
                ...
                GridViewSIPResultstr = "<div><table border='0' align='left' style='border-collapse: collapse;' width='100%' cellpadding='0' cellspacing='0'>" + GridViewSIPResultstr.Substring(GridViewSIPResultstr.IndexOf("<th"));
                //added 30 oct 2012-
                //GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"scope=""col""", "style ='text-align: center;font-family: 'Roboto', sans-serif;color: #ffffff;font-size: 12;font-weight: normal;background: #113781;height: 45px;'");
                
                // Somabrata Change Historical Performance
                GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"scope=""col""", "style ='text-align:center;font-family: Roboto;color: #000;font-size: 12px;font-weight: normal;background: #f7f7f7;height: 40px; border-bottom:#dddddd solid 1px;vertical-align:middle'");
                ...
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "LUMP SUM")
                {
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""borderlefft""", "style = 'text-align:center;'");
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""borderbottom""", "style = 'text-align:center;'");
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""leftal""", "style = 'width:400px;text-align:left;'");
                    //GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""grdRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;'");//font-family:Trebuchet MS;
                    //GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""grdAltRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;border-bottom:#dddddd solid 1px;'");//font-family:Trebuchet MS;
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""grdRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;'");//font-family:Trebuchet MS;
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""grdAltRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;border-bottom:#dddddd solid 1px;'");//font-family:Trebuchet MS;
                }
                else
                {
                    ...
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""borderlefft""", "style = 'text-align:center;'");
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""borderbottom""", "style = 'text-align:center;'");
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""leftal""", "style = 'width:400px;'");
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""grdRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;'");//font-family:Trebuchet MS;
                    GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"class=""grdAltRow""", "style = 'font-size:12px;	vertical-align:middle;	text-align:center;height: 35px;border-bottom:#dddddd solid 1px;'");//font-family:Trebuchet MS;
                }
                ...
                strHTML = strHTML.Replace(@"class=""grdheader""", "style ='font-family: 'Roboto', sans-serif; font-size:12px;vertical-align:middle;text-align:center;border-bottom:#c6c8ca solid 1px;height: 40px;font-weight: normal; background:#f7f7f7; border-bottom:#dddddd solid 1px'");

                strHTML = strHTML.Replace(@"class=""grdRow""", "style = 'font-family: 'Roboto', sans-serif;	font-size:12px;	vertical-align:middle;	text-align:center;	border-bottom:#c6c8ca solid 1px;height: 40px;'");
                ...
                path = HttpContext.Current.Server.MapPath("~/HDFC_SIP/PDF/" + "HDFC" + "_" + Convert.ToString(Session["GUID"]) + ".htm");
                ...
                if (Session["GUID"] != null)
                {
                    ...
                    pdfName = Convert.ToString(Session["GUID"]) + ".pdf";
                    Response.AppendHeader("Content-Disposition", "attachment; filename=HDFC_Sample.pdf");
                    Response.TransmitFile(Server.MapPath("~/HDFC_SIP/PDF/HDFC_" + pdfName));
                    Response.End();
                }
        ...
        public void _SimpleConversion()
        {
            try
            {
                using (var wk = _GetConverter())
                {
                    ...
                    htmlfile = HttpContext.Current.Server.MapPath("~/HDFC_SIP/PDF/" + "HDFC" + "_" + Convert.ToString(Session["GUID"]) + ".htm");
                    ...
                    savepdfpath = HttpContext.Current.Server.MapPath("~") + "\\HDFC_SIP\\PDF\\HDFC_" + Convert.ToString(Session["GUID"]) + ".pdf";

                    savehtmlpath = HttpContext.Current.Server.MapPath("~") + "\\HDFC_SIP\\PDF\\HDFC_" + Convert.ToString(Session["GUID"]) + ".htm";
