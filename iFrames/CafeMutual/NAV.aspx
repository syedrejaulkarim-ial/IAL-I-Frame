<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true"
    CodeBehind="NAV.aspx.cs" Inherits="iFrames.CafeMutual.NAV" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function BtnReset() {
            window.location.href = "/CafeMutual/Nav.aspx";
        }
        ...
        function ValidateControl() {
            ...
            if (listCount >= 3) {
                OpenAlert("The List can contain maximum 3 Item");
                return false;
            }
            return true;
        }
        ...
        $(function () {
            if (!(($("#HdMessage").val() == "") || ($("#HdMessage").val() == undefined))) {
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <div class="span12" id="content">
                        <div class="row-fluid" style="margin-top: -5px; margin-left: 0px;">
                            <!-- block -->
                            <div class="block1" style="margin-top: 5px;">
                                <div>
                            ...
                            <input type="button" class="btn-sub btn-large" value="RESET" onclick="BtnReset()" />
                        </div>
                        <div class="" style="text-align: right; margin-bottom: 10px; padding-top: 20px;">
                            <p>
                                <a href="https://mfi360.icrainsights.com/AMC/FundScreener"
                                    target="_blank"
                                    style="color: #cc885a; font-size: 12px; font-weight: bold; text-decoration: underline">Compare more Funds</a>
                            </p>
                        </div>

                    </div>
                </div>
                <div id="DivGridContain" class="row-fluid" runat="server" style="margin-top: 0px;">
                    <!-- block -->
                ...
                <div id="DivPlotChart" runat="server" class="row-fluid" style="margin-top: 0px;">
                    <!-- block -->
                    ...
                    <input type="button" value="Plot Chart" class="btn-sub btn-large" id="btplotChart" runat="server" style="margin-right: 33px;" onclick="Javascript: btnPlotclick();" />
                ...
                <div>
                    <table>
                        <tr>
<td  style="text-align: right; font-size: 10px; color: #A7A7A7">
...
href="https://www.icraanalytics.com" target="_blank"> ICRA Analytics Ltd </a>, <a style="text-align: right; font-size: 10px; color: #A7A7A7"
href="https://icraanalytics.com/home/Disclaimer"
            ...
            <input type="hidden" value="" id="HdMessage" runat="server" />
