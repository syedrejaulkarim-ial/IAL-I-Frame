...
function focusOut(controlName, staticLength) {
    ...
    if (staticLength < 160)
        staticLength = 160;
    //OpenAlert(mySelect.style.width);
...
function setDate() {
    ...
    // OpenAlert(ddScheme.options[ddScheme.selectedIndex].text);
    // OpenAlert(ddScheme.options[ddScheme.selectedIndex].value);
    // OpenAlert(ddScheme.options[ddScheme.selectedIndex].title);
    ...
    if (document.getElementById("ddlMode").value == 'STP') {
        ...
        if (allotdateto != null) {
            ...
            OpenAlert("Inception date not found");
        }
...
function checkInvestedValue() {
    ...
    if (mode == 'Lump Sum') {
        ...
        if (isNaN(sipamunt)) {
            OpenAlert("Please enter Numeric value.");
            ...
            if (sipamunt < 5000) {
                OpenAlert('Minimum investment amount should be Rs. 5000/- ');
                document.getElementById('txtinstallLs').value = "";
                document.getElementById("txtinstallLs").focus();
                return false;
            }
            ...
            //                if (sipamunt >= 500) {
            //                    if (sipamunt % 100 != 0) {
            //                        OpenAlert('Minimum amount should be Rs.500/- and in multiples of Rs.100/- thereafter');
            //                        document.getElementById('txtinstallLs').value = "";
            //                        document.getElementById("txtinstallLs").focus();
            //                        return false;
            //                    }
        ...
        if (isNaN(withdrwAmt)) {
            ...
            if (parseFloat(document.getElementById("txtTransferWithdrawal").value) < 500) {
                OpenAlert('Minimum ' + text + ' amount should be Rs.500/-');
                document.getElementById('txtTransferWithdrawal').value = "";
                document.getElementById("txtTransferWithdrawal").focus();
                return false;
            }
                ...
                if (amt % 100 != 0) {
                    OpenAlert('Minimum ' + text + ' amount should be Rs.500/- and in multiples of Rs.100/- thereafter');
                    document.getElementById('txtTransferWithdrawal').value = "";
                    document.getElementById("txtTransferWithdrawal").focus();
                    return false;
                }
        ...
        if (isNaN(sipamunt)) {
            ...
            if (sipamunt < 500) {
                OpenAlert('Minimum installment amount should be Rs. 500/- ');
                document.getElementById('txtinstall').value = "";
                document.getElementById("txtinstall").focus();
                return false;
            }
                ...
                if (sipamunt >= 500) {
                    if (sipamunt % 100 != 0) {
                        OpenAlert('Minimum installment amount should be Rs.500/- and in multiples of Rs.100/- thereafter');
                        document.getElementById('txtinstall').value = "";
                        document.getElementById("txtinstall").focus();
                        return false;
                    }
    ...
    if (ind > 0) {
        ...
        if (mode == 'STP' || mode == 'SWP') {
            if (k < 1 && period == "Monthly") {//ddiff > 0 
                OpenAlert(mode + " is allowed for minimum 1 Installment");
            ...
            if ((ddiff > 0) && period == "Monthly") { //k < 12 || dtdf <= 365
                OpenAlert("SIP is allowed for minimum 1 Installment");
                document.getElementById('txtToDate').value = "";
                document.getElementById('txtToDate').focus();
                return false;
            }
...
function pdfcheck() {
    ...
    if (document.getElementById("txtPreparedby").value == "") {
        OpenAlert('Please Enter your Name.');
        document.getElementById('txtPreparedby').focus();
        return false;
    }
    if (document.getElementById("txtMobile").value == "") {
        OpenAlert('Please Enter your Mobile No.');
        document.getElementById('txtMobile').focus();
        return false;
    }

    //    if (document.getElementById("txtMobile").value.length != 10) {
    //        OpenAlert('Please Enter your proper Mobile No.');
    //        document.getElementById('txtMobile').focus();
    //        return false;
    //    }
    ...
    if (document.getElementById("txtPreparedFor").value == "") {
        OpenAlert('Please Enter Prepared for Name.');
    ...
    if (document.getElementById("txtEmail").value == "") {
        OpenAlert('Please Enter Email Id.');
    ...
    if (!pattern.test(field)) {
        OpenAlert("Please Enter Valid Email Address"); return false;
    }
...
function allLetter(uname) {
    ...
    if (uname.value.match(letters)) {
        ...
        OpenAlert('Name must have alphabet characters only');
        uname.value = "";
        uname.focus();
        return false;
    }
...
function validate_SIP() {
    ...
    //    OpenAlert(document.getElementById("ddlMode").value)

    if (document.getElementById("ddlscheme").value == '0') {
        OpenAlert('Please select any Scheme.');
    ...
    if (document.getElementById("ddlMode").value == 'Lump Sum') {
        ...
        //OpenAlert(sipamunt);
        if (sipamunt == "") {
            OpenAlert("Value of Investment Amount cannot be Blank");
            document.getElementById('txtinstallLs').focus();
            return false;
        }

        if (sipamunt.indexOf(".") > -1) {
            OpenAlert("Please Enter Integral value");
            document.getElementById('txtinstallLs').value = "";
            document.getElementById('txtinstallLs').focus();
            return false;
        }
        ...
        if (isNaN(sipamunt)) {
            ...
            if (sipamunt == 0) {
                OpenAlert("Please enter Valid Numeric value.");
                document.getElementById('txtinstallLs').value = "";
                document.getElementById('txtinstallLs').focus();
                return false;
            }
            if (sipamunt < 5000) {
                OpenAlert('Minimum  installment amount should be Rs. 5000/- ');
                document.getElementById('txtinstallLs').value = "";
                document.getElementById("txtinstallLs").focus();
                return false;
            }
            ...
            //                if (sipamunt % 500 != 0) {
            //                    OpenAlert('Minimum Amount should be Rs.500/- and in multiples of Rs.500/- thereafter');
            //                    document.getElementById('txtinstallLs').value = "";
            //                    document.getElementById("txtinstallLs").focus();
            //                    return false;
            //                }
        ...
        //OpenAlert(todaydate);OpenAlert(dt);
        var i = DateDiff.inDays(dt, todaydate)
        if (i <= 0) {
            OpenAlert("Start Date should be Less than Today");
        ...
        if (i <= 0) {
            OpenAlert("End Date should be Less than Today");
        ...
        if (!IsValidDate(LumpStartdata, LumpEnddata)) {
            OpenAlert("Start Date should be Less than End Date");
            document.getElementById('txtLumpfromDate').value = "";
            document.getElementById('txtLumpfromDate').focus();
            return false;
        }
    ...
    //        OpenAlert('Please select any Period.');
    ...
    //        document.getElementById("txtddSIPdate").value = '';
    //        OpenAlert('Please select valid SIP Date.');
    //        document.getElementById("txtddSIPdate").focus();
    //        return false;
    //    }
    ...
    if (document.getElementById("ddlMode").value == 'SIP with Initial Investment') {
        ...
        if (document.getElementById("txtIniToDate").value == '') {
            OpenAlert('Please enter Initial date.');
        ...
        //OpenAlert(sipamunt);
        if (sipamunt == "") {
            OpenAlert("Value of Initial Amount cannot be Blank");
        ...
        if (isNaN(sipamunt)) {
            ...
            if (sipamunt < 500) {
                OpenAlert('Minimum  initial amount should be Rs. 500/- ');
                document.getElementById('txtiniAmount').value = "";
                document.getElementById("txtiniAmount").focus();
                return false;
            }
        ...
        if (document.getElementById("txtfromDate").value == '') {
            OpenAlert('Please enter From date.');
        ...
        var i = DateDiff.inDays(dt, todaydate)
        if (i <= 0) {
            OpenAlert("initial Date should be Less than Today");
        ...
        if (!IsValidDateEqual(iniStartdata, sipStartdata)) {
            OpenAlert("Initial Date should be Less or Equal to Start Date");
            document.getElementById('txtIniToDate').value = "";
            document.getElementById('txtIniToDate').focus();
            return false;
        }
        ...
        if (!IsValidDate(allotdate, iniStartdata)) {
            OpenAlert("Initial Date should be greater than or Equal to Inception Date " + allotdate);
            document.getElementById('txtIniToDate').value = "";
            document.getElementById('txtIniToDate').focus();
            return false;
        }
    ...
    //OpenAlert(sipamunt);
    if (sipamunt == "") {
        OpenAlert("Value of Installment cannot be Blank");
        document.getElementById('txtinstall').focus();
        return false;
    }
    ...
    if (document.getElementById("txtToDate").value == '') {
        OpenAlert('Please enter To date.');
        document.getElementById("txtToDate").focus();
        return false;
    }

    if (document.getElementById("txtvalason").value == '') {
        OpenAlert('Please enter value as on date.');
    ...
    var i = DateDiff.inDays(dt, todaydate)
    if (i <= 0) {
        OpenAlert("From Date should be Less than Today");
    ...
    if (i <= 0) {
        OpenAlert("Value as on Date should be Less than Today");
    ...
    var period = document.getElementById("ddPeriod_SIP").value;
    //OpenAlert(period);
    //  OpenAlert(ddlscheme.options[ddlscheme.selectedIndex].value);
    // OpenAlert(ddScheme.options[ddScheme.selectedIndex].text);
    //    var x = document.getElementById("ddlscheme").selectedIndex;
    //    OpenAlert(document.getElementsByTagName("option")[x].value);
    ...
    if (dt < startsensexdate) {
        OpenAlert("Please select Value as of Date from 1st January 1980");
        document.getElementById('txtfromDate').value = "";
        document.getElementById('txtfromDate').focus();
        return false;
    }
    ...
    if (!IsValidDate(sipStartdata, sipEnddata)) {
        OpenAlert("From Date should be Less than End Date");
        document.getElementById('txtfromDate').value = "";
        document.getElementById('txtfromDate').focus();
        return false;
    }
    ...
    if (!IsValidDate(sipEnddata, sipAsondata)) {
        OpenAlert("Value as on Date should be greater than End Date ");
        document.getElementById('txtvalason').value = "";
        document.getElementById('txtvalason').focus();
        return false;
    }
    ...
    if (!IsValidDate(allotdate, sipStartdata)) {
        OpenAlert("From Date should be greater than or Equal to Inception Date " + allotdate);
        document.getElementById('txtfromDate').value = "";
        document.getElementById('txtfromDate').focus();
        return false;
    }
...
function validate_SWP() {
    ...
    //        OpenAlert('Please select SWP Date.');
    ...
    //        OpenAlert('Please select valid SWP Date.');
    //        document.getElementById("txtddSWPdate").focus();
    //        return false;
    //    }
    ...
    if (isNaN(sipamunt)) {
        ...
        if (sipamunt == 0) {
            ...
            if (sipamunt % 100 != 0) {
                OpenAlert('Minimum initial amount should be Rs.3000/- and in multiples of Rs.100/- thereafter');
                document.getElementById("txtinstall").focus();
                return false;
            }
        }
        else {
            OpenAlert('Minimum  initial amount should be Rs. 3000/- ');
            document.getElementById("txtinstall").focus();
            return false;
        }
    }

    var sipwdamunt = document.getElementById('txtTransferWithdrawal').value;

    if (sipwdamunt == "") {
        OpenAlert("Value of withdrawal amount cannot be Blank");
        document.getElementById('txtTransferWithdrawal').focus();
        return false;
    }

    if (sipwdamunt.indexOf(".") > -1) {
        OpenAlert("Please Enter Integral value in withdrawal amount ");
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById('txtTransferWithdrawal').focus();
        return false;
    }
    ...
    if (isNaN(sipwdamunt)) {
        OpenAlert("Please enter Numeric value withdrawal amount.");
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById('txtTransferWithdrawal').focus();
        return false;
    }
        ...
        if (sipwdamunt == 0) {
            OpenAlert("Please enter Valid Numeric value withdrawal amount.");
            document.getElementById('txtTransferWithdrawal').value = "";
            document.getElementById('txtTransferWithdrawal').focus();
            return false;
        }
    ...
    //        OpenAlert('Initial amount cannot be less than 25,000/- Rs.');
    ...
    if (parseFloat(document.getElementById("txtTransferWithdrawal").value) < 500) {
        OpenAlert('Minimum withdrawal amount should be Rs.500/- and in multiples of Rs.100/- thereafter');
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById("txtTransferWithdrawal").focus();
        return false;
    }
    ...
    //        OpenAlert('Maximum withdrawal amount should be Rs.25000');
    ...
    var initamt;
    var withamt;
    initamt = document.getElementById("txtinstall").value;
    withamt = document.getElementById("txtTransferWithdrawal").value;

    if (initamt / withamt < 1) {
        OpenAlert('Withdrawal amount cannot be greater than initial amount.');
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById("txtTransferWithdrawal").focus();
        return false;
    }
    ...
    if (initamt / withamt < 6) {
        OpenAlert('Enter Withdrawal amount for minimum 1 transaction.');
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById("txtTransferWithdrawal").focus();
        return false;
    }
    ...
    if (ind > 0) {
        ...
        if (k <= 1 && dydf < 31 && period == "Monthly") {
            OpenAlert("SWP is allowed for minimum 1 Installment");
            document.getElementById('txtfromDate').value = "";
            document.getElementById('txtfromDate').focus();
            return false;
        }
...
function validate_STP() {
    ...
    if (isNaN(sipamunt)) {
        ...
        //            if (sipamunt % 100 != 0) {
        //                OpenAlert('Minimum Investment amount should be Rs.1000/- and in multiples of Rs.100/- thereafter');
        //                document.getElementById("txtinstall").focus();
        //                return false;
        //            }
        //        }
        //        else {
        //            OpenAlert('Minimum Investment amount should be Rs. 1000/- ');
        //            document.getElementById("txtinstall").focus();
        //            return false;
        //        }
    }
    ...
    if (sipwdamunt == "") {
        OpenAlert("Value of transfer amount cannot be Blank");
        document.getElementById('txtTransferWithdrawal').focus();
        return false;
    }

    if (sipwdamunt.indexOf(".") > -1) {
        OpenAlert("Please Enter Integral value in transfer amount ");
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById('txtTransferWithdrawal').focus();
        return false;
    }
    ...
    if (isNaN(sipwdamunt)) {
        OpenAlert("Please enter Numeric value transfer amount.");
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById('txtTransferWithdrawal').focus();
        return false;
    }
        ...
        if (sipwdamunt == 0) {
            OpenAlert("Please enter Valid Numeric value transfer amount.");
            document.getElementById('txtTransferWithdrawal').value = "";
            document.getElementById('txtTransferWithdrawal').focus();
            return false;
        }
    ...
    if (parseFloat(document.getElementById("txtinstall").value) < 3000) {
        OpenAlert('Investment amount cannot be less than Rs.3,000');
        document.getElementById('txtinstall').value = "";
        document.getElementById("txtinstall").focus();
        return false;
    }
    ...
    if (parseFloat(document.getElementById("txtTransferWithdrawal").value) < 500) {
        OpenAlert('Minimum transfer amount should be Rs.500/- and in multiples of Rs.100/- thereafter');
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById("txtTransferWithdrawal").focus();
        return false;
    }

    if (parseFloat(document.getElementById("txtTransferWithdrawal").value) > 30000) {
        OpenAlert('Maximum transfer amount should be Rs.30000');
        document.getElementById('txtTransferWithdrawal').value = "";
        document.getElementById("txtTransferWithdrawal").focus();
        return false;
    }
    ...
    if (initamt / withamt < 1) {
        OpenAlert('Transfer amount cannot be greater than initial amount.');
        document.getElementById("txtTransferWithdrawal").focus();
        return false;
    }

    if (initamt / withamt < 1) {
        OpenAlert('Enter Transfer amount for a minimum 1 transaction.');
        document.getElementById("txtTransferWithdrawal").focus();
        return false;
    }
    ...
    //        OpenAlert('Please select any STP Date.');
    ...
    //        OpenAlert('Please select valid STP Date.');
    //        document.getElementById("txtddSTPDate").focus();
    //        return false;
    //    }
    ...
    var allotdate = ddScheme.options[ddScheme.selectedIndex].title;
    if (!IsValidDate(allotdate, sipStartdata)) {
        OpenAlert("From Date should be greater than or Equal to Inception Date of From Scheme " + allotdate);
        document.getElementById('txtfromDate').value = "";
        document.getElementById('txtfromDate').focus();
        return false;
    }
    ...
    var ddSchemeto = document.getElementById("ddlschtrto");
    var allotdateto = ddSchemeto.options[ddSchemeto.selectedIndex].title;
    //OpenAlert(allotdateto);
    if (allotdateto != null) {
        if (!IsValidDate(allotdateto, sipStartdata)) {
            OpenAlert("From Date should be greater than or Equal to Inception Date of To Scheme " + allotdateto);
            document.getElementById('txtfromDate').value = "";
            document.getElementById('txtfromDate').focus();
            return false;
        }
    } else {
        OpenAlert("No date is found");
    }
    ...
    if (ind > 0) {
        ...
        if (k <= 1 && dydf < 31 && period == "Monthly") {
            OpenAlert("STP is allowed for minimum 1 Installment");
            document.getElementById('txtfromDate').value = "";
            document.getElementById('txtfromDate').focus();
            return false;
        }
...
function setFromDateAfterPostBack() {
    ...
    if (document.getElementById("ddlMode").value == 'STP') {
        var ddSchemeto = document.getElementById("ddlschtrto");
        //OpenAlert(ddSchemeto.selectedIndex);
