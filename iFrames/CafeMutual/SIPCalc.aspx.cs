...
namespace iFrames.CafeMutual
{
    public partial class SIPCalc : System.Web.UI.Page
    {
        ...
        {
            this.sipbtnshow.Attributes.Add("onclick", "javascript:return validateDSP();");
        ...
        protected void sipbtnshow_Click(object sender, ImageClickEventArgs e) 
        {
            ...
            //if (Convert.ToDateTime(txtToDate.Text) > Convert.ToDateTime(txtvalason.Text))
            //{
            //    // Response.Write("Value as on date is not less than to date");
            //    Response.Write("<script>alert('Value as on date is not less than to date')</script>");
            //    //System.Windows.MessageBox.Show("Value as on date is not less than to date");
        ...
        public DataTable FetchScheme()
        {
            ...
            dtScheme = AllMethods.getSebiScheme(Convert.ToInt32(ddlNature.SelectedItem.Value),2, -1,-1, Convert.ToInt32(ddlFundHouse.SelectedValue), false);
            //ddlSchemes.DataBind();
        ...
        public DataTable FetchSchemeWithout(string schid)
        {
            ...
            try
            {
                DataTable dtSch = AllMethods.getSebiScheme(-1, 2, -1, -1, 4,false);
		...
		public void CalculateReturn()
        {
            ...
            try
            {
                ...
                using (var principl = new SIP_ClientDataContext() { CommandTimeout = 600000 })
                {
                    ...
                    //foreach (DataRow row in SipDtable2.Rows)
                    //{
                     SipDtable2.Rows[1].Delete();
                    ...
                    //sipGridView false added by B K rao.
        ...
        private void PerformanceReturn()
        {
            ...
            try
            {
                ...
                dtLsTable.Rows[1].Delete();
                dtLsTable.AcceptChanges();
        ...
        public void Reset()
        {
           ...
           // ddPeriod_SIP.SelectedIndex = 0;
            if (ddPeriod_SIP.SelectedIndex > -1)
                ddPeriod_SIP.SelectedIndex = 0;
        ...
        private void ShowExcel()
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=Birla_Sun_life_Detail_Report.xls");
            Response.Charset = "";
        ...
        private void getSchemesList()
        {
            ...
            //ddlSchemes.SelectedIndex = -1;


            // ddlSchemes.Items.Clear();
            //ddlSchemes.Items.Add(new ListItem("--", "-1"));


            DataTable dtScheme = AllMethods.getSebiScheme(Convert.ToInt32(ddlNature.SelectedItem.Value),-1,-1,-1,               
                 Convert.ToInt32(ddlFundHouse.SelectedValue), false);
        ...
        private void getSchemesListFilter(List<decimal> lstSchmId)
        {
            ...
            try
            {
                DataTable dtScheme = AllMethods.getSebiScheme(Convert.ToInt32(ddlNature.SelectedItem.Value), -1, -1, -1, Convert.ToInt32(ddlFundHouse.SelectedValue), false);
                var dt = dtScheme.AsEnumerable().Where(x => !lstSchmId.Contains(x.Field<decimal>("Scheme_Id")));
                if (dt.Any())
                {
                    DataTable vdtScheme = dt.CopyToDataTable();
                    ddlscheme.DataSource = vdtScheme;
                    ddlscheme.DataTextField = "Sch_Short_Name";
                    ddlscheme.DataValueField = "Scheme_Id";
                    ddlscheme.DataBind();
                }
