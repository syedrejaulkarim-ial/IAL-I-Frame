<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true"
    CodeBehind="Factsheet.aspx.cs" Inherits="iFrames.CafeMutual.Factsheet" %>
    ...
    <script type="text/javascript">
        ...
        function PlotAssetAllocation(data) {
            ...
            var plot1 = $.jqplot('chartAssetAllocationContainer', [dataPlot], {
                seriesColors: ["#106cb5", "#d1925f", "#605d5c", "#e6ab0d", "#49b959"],
                seriesDefaults: {
            ...
            if (typeof schIndId != 'undefined' && schIndId > 0) {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        //debugger;
                        // setChart(msg.d);
                        var fordate = GetFormatDate(msg.d.MaxDate);
                        $('#lblNavDate').text(fordate);
        ...
        function GetFormatDate(date) {
            ...
            var month = todayTime.getMonthName(3);
        ...
        //debugger;
        //var fundId = $("#HiddenFundId").text();
        function HistoricalFactSheet() {
            window.open("https://mfi360.icrainsights.com/FundDashboard/FactSheet/" + fundId, '_blank');
        }
    </script>
    <style>
        kbd {
            ...
            <div class="navbar" align="left" style="margin-left: 7px; margin-top: -55px;">
                <div class="navbar top_bar">
                    <div class="container-fluid">
                        ...
                        <div class="bottom">
                            <div class="">
                                <a href="https://mfi360.icrainsights.com/Account/login" target="_blank">
                                    <img src="img/logo_mfi360.png" />
                                </a>
                            </div>
                        </div>
                        <%--<div class="" style="text-align: right; margin-bottom: 0px; padding-top: 0px;">
                            <span style="font-size: 11px; color: #5f5c5b">NAV as on date: 
                <span id="lblNavDate"></span></span>
                        </div>--%>
                        <div class="" style="text-align: right; margin-bottom: -19px; padding-top: 0px;">
                            <span style="font-size: 11px; color: #5f5c5b">Portfolio as on: 
                <span id="lblPortDate" runat="server"></span></span>
                        </div> 
                    </div>
                </div>
            </div>
            <div class="" style="text-align: right; margin-bottom: 10px; padding-top: 0px;">
                <input type="hidden" id="HiddenFundId" value="Hidden value" runat="server" />
                <a href="" onclick="return HistoricalFactSheet()"
                    target="_blank" cursor="pointer"
                    style="color: #cc885a; font-size: 12px; font-weight: bold; text-decoration: underline; padding-right: 20px; cursor:pointer" runat="server">Historical Factsheets</a>
            </div>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <table id="tblResult" width="100%" border="0" align="left" cellpadding="0" cellspacing="0" runat="server" visible="false">
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="height: 80px">
                                                                            <tr>
                                                                                <td align="left" class="value_news_header1" style="font-weight: bold; width: 35%">&nbsp;<asp:Label runat="server" ID="lblFundName"></asp:Label>
                                                                                </td>

                                                                                <td align="left" style="position: absolute; right: 12px; width: 30%">
                                                                                    <div style="width: 100%; float: left; border: 1px solid #eaeaea; padding: 5px; background: #fbfbfb;">
                                                                                        <p style="margin: 0 0 3px; border-bottom: 1px solid #eaeaea; padding-bottom: 3px; text-align: center; font-weight: 900; font-size: 12px;">
                                                                                            52 Weeks
                                                                                        </p>
                                                                                        <div style="width: 50%; float: left; border-right: 1px solid #eaeaea; text-align: center">
                                                                                            <div style="margin-bottom: 8px; font-weight: 700; font-size: 12px;">
                                                                                                High
                                                                                            </div>
                                                                                            <kbd class="green">
                                                                                ...
                                                                                <td align="left" style="position: absolute; width: 30%">
                                                                                    <table class="table table-bordered cstm_class">
                                                                                        <thead>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <th style="text-align: right">1 Yr</th>
                                                                                                <%-- <th>3 Yrs</th>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="text-align: right"><span id="spn1mth" runat="server"></span></td>
                                                                                                <td style="text-align: right"><span id="spn3mth" runat="server"></span></td>
                                                                                                <td style="text-align: right"><span id="spn6mth" runat="server"></span></td>
                                                                                                <td style="text-align: right"><span id="spn1yr" runat="server"></span></td>
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">&nbsp;<asp:Label runat="server" ID="lblPresentNav"></asp:Label>&nbsp;<img
                                                                                    id="imgArrow"
                                                                            ...
                                                                            <tr>
                                                                                <td align="left">&nbsp;
                                                                                    <div class="" style="margin-bottom: 0px; padding-top: 0px;">
                                                                                        <span style="font-size: 11px; color: #5f5c5b">NAV as on: 
                                                                                        <span id="lblNavDate"></span></span>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" align="center" cellpadding="0"
                                                                            cellspacing="0">
                                                                            <tr>
                                                                                <td class="mutual_fact_header">Investment Info
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="top_text">&nbsp;
                                                                                    <%--<p>Note: on performance and scheme selected for showing performance to be given here.</p>--%>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <table width="100%" border="0" align="left" cellpadding="0"
                                                                                        cellspacing="0" class="mutual_table">
                                                                                        <tr class="mutual_tableheader">
                                                                                            <td class="mutual_tableheader">Fund Name
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Entry Load
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Average Asset Size (Rs cr.)
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="mutual_tablerow" id="tdFundName" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdEntryLoad" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdAssetSize" runat="server"></td>
                                                                                        </tr>
                                                                                        <tr class="mutual_tableheader">
                                                                                            <td class="mutual_tableheader">Investment Plan
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Exit Load
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Minimum Investment (Rs.)
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="mutual_tablerow" id="tdStructure" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdExitLoad" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdMinInvest" runat="server"></td>
                                                                                        </tr>
                                                                                        <tr class="mutual_tableheader">
                                                                                            <td class="mutual_tableheader">Launch Date
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Fund Manager
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Last Dividend
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="mutual_tablerow" id="tdLunchDate" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdFundMan" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdLastDiv" runat="server"></td>
                                                                                        </tr>
                                                                                        <tr class="mutual_tableheader">
                                                                                            <td class="mutual_tableheader">Benchmark
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Email / Website
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">Bonus
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="mutual_tablerow" id="tdBenchMark" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdEmail" runat="server"></td>
                                                                                            <td class="mutual_tablerow" id="tdBonus" runat="server"></td>
                                                                                        </tr>
                                                                                        <tr class="mutual_tableheader">
                                                                                            <td class="mutual_tableheader">AMC Name
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">&nbsp;
                                                                                            </td>
                                                                                            <td class="mutual_tableheader">&nbsp;
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td class="mutual_tablerow" id="tdAmcName" runat="server"
                                                                                                colspan="3"></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="mutual_fact_header">NAV Graph
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>

                                                                                    <div id="DivPlotChart" runat="server" class="row-fluid"
                                                                                        style="margin-top: 0px; margin-right: 25px; width: 959px;">
                                                                                        <!-- block -->
                                                                                        <div class="block" style="margin-top: 20px; margin-right: 25px; margin-left: -11px; display: none">
                                                                                            <div class="block-content collapse in" id="divTimePeriod"
                                                                                                ...
                                                                                                <div class="span3" style="margin-left: 55px;">
                                                                                                    ...
                                                                                                    <div class="controls" style="margin-top: 5px; margin-left: 30px;">
                                                                                                        ...
                                                                                                        <asp:TextBox ID="txtToDate" runat="server" CssClass="mutual_txtbox"
                                                                                        ...
                                                                                        <%-- <input type="button" mutual="Plot Chart" class="btn-sub btn-large" id="btplotChart" style="margin-right: 33px;" onclick="Javascript: btnPlotclick();" />--%>
                                                                                    </div>
                                                                                    <div id="DivLast" runat="server" class="row-fluid"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <div>
                                                                                                                ...
                                                                                                                <%--new chart--%>
                                                                                                                <div id="HighContainer" style="height: 600px;"></div>
                                                                                                            ...
                                                                                                            <%--<div class="mutual_input" style="width: 100%; float: right;
                                                                                                                text-align: right; font-size: 10px; color: #A7A7A7">
                                                                                                                Developed for Cafe mutual by: <a href="https://www.icraanalytics.com"
                                                                                                                    target="_blank" style="font-size: 10px; color: #999999">
                                                                                                                    ICRA Analytics Ltd</a>, <a style="font-size: 10px; color: #999999"
                                                                            ...
                                                                            <tr>
                                                                                <td class="mutual_fact_header">Top 10 Holdings
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="top_text">&nbsp;
                                                                                                            ...
                                                                                                            <asp:Repeater ID="TopCompDetails" runat="server">
                                                                                                                <HeaderTemplate>
                                                                                                                    <table width="100%" border="0" align="left" cellpadding="0"
                                                                                                                        cellspacing="0" class="mutual_table">
                                                                                                                        <tr class="mutual_tableheader">
                                                                                                                            <th class="mutual_tableheader" style="width: 55%;">Company Name</td>
                                                                                                                            <th class="mutual_tableheader" style="width: 30%">Sector</td>
                                                                                                                                <th class="mutual_tableheader" style="width: 15%">
                                                                                                                            Asset %</td>
                                                                                                                        </tr>
                                                                                                                </HeaderTemplate>
                                                                                                                <ItemTemplate>
                                                                                                                    <tr class='<%# Convert.ToBoolean(Container.ItemIndex % 2) ? "value_tablerow" : "value_tablerow" %>'>
                                                                                                                        <td class="mutual_tablerow" style="width: 55%;">
                                                                                                                            <asp:Label ID="lblSubject" runat="server" Text='<%#Eval("CompName") %>' />
                                                                                                                        </td>
                                                                                                                        <td class="mutual_tablerow" style="width: 30%">
                                                                                                                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("Sector_Name") %>' />
                                                                                                                        </td>
                                                                                                                        <td class="mutual_tablerow" style="width: 15%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Repeater ID="TopCompDetails1" runat="server">
                                                                                                                ...
                                                                                                                <ItemTemplate>
                                                                                                                    <tr class='<%# Convert.ToBoolean(Container.ItemIndex % 2) ? "mutual_tablerow" : "mutual_tablerow" %>'>
                                                                                                                        <td class="mutual_tablerow" style="width: 55%;">
                                                                                                                            <asp:Label ID="lblSubject" runat="server" Text='<%#Eval("CompName") %>' />
                                                                                                                        </td>
                                                                                                                        <td class="mutual_tablerow" style="width: 30%">
                                                                            ...
                                                                            <tr>
                                                                                <td class="" style="text-align: right; margin-bottom: 10px; margin-top: 10px;">
                                                                                    <p>
                                                                                        <a href="https://mfi360.icrainsights.com/Stock/Holdings"
                                                                                            target="_blank" style="color: #cc885a; font-size: 12px; font-weight: bold; text-decoration: underline">More Stock Analysis</a>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td class="mutual_fact_header">Statistical Analysis
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="top_text">&nbsp;
                                                                                    ...
                                                                                    <table width="100%" border="0" align="center" cellpadding="0"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr class="top_tableheader">
                                                                                                <th class="mutual_tableheader">Sharpe
                                                                                                </th>
                                                                                                <th class="mutual_tableheader">Sortino
                                                                                                </th>
                                                                                                <th class="mutual_tableheader">Standard Deviation
                                                                                                </th>
                                                                                                <th class="mutual_tableheader">Beta
                                                                                                </th>
                                                                                                <th class="mutual_tableheader">R-Square
                                                                                                </th>
                                                                                            </tr>
                                                                                            <tr class="mutual_tablerow">
                                                                                                <td class="mutual_tablerow" width="20%">
                                                                                                    <label id="lblSharpe" runat="server"></label>
                                                                                                </td>
                                                                                                <td class="mutual_tablerow" width="20%">
                                                                                                    <label id="lblSortino" runat="server"></label>
                                                                                                </td>
                                                                                                <td class="mutual_tablerow" width="25%">
                                                                                                    <label id="lblSdv" runat="server"></label>
                                                                                                </td>
                                                                                                <td class="mutual_tablerow" width="15%">
                                                                                                    <label id="lblBeta" runat="server"></label>
                                                                                                </td>
                                                                                                <td class="mutual_tablerow" width="45%">
                                                                            ...
                                                                            <tr>
                                                                                <td class="" style="text-align: right; margin-bottom: 10px; margin-top: 10px;">
                                                                                    <p>
                                                                                        <a href="https://mfi360.icrainsights.com/SchemePerformance/StatisticalRatio"
                                                                                            target="_blank" style="color: #cc885a; font-size: 12px; font-weight: bold; text-decoration: underline">More Ratios</a>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="width: 49%;" class="mutual_fact_header">Top
                                                                                                5 Sector Holding
                                                                                            </td>
                                                                                            <td style="width: 2%;">&nbsp;
                                                                                            </td>
                                                                                            <td id="TdMc" style="width: 49%;" class="mutual_fact_header">Market Capitalisation
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="vertical-align: top; padding-top: 20px;">
                                                                                                    ...
                                                                                                    <HeaderTemplate>
                                                                                                        <table width="100%" border="0" align="center" cellpadding="0"
                                                                                                            ...
                                                                                                            <tr class="top_tableheader">
                                                                                                                ...
                                                                                                                <th class="mutual_tableheader" style="width: 6%;">Sector
                                                                                                                    Name
                                                                                                                </th>
                                                                                                                <th class="mutual_tableheader" style="width: 6%;">% Allocation
                                                                                                                </th>
                                                                                                            </tr>
                                                                                                    </HeaderTemplate>
                                                                                                    <ItemTemplate>
                                                                                                        <tr class='<%# Convert.ToBoolean(Container.ItemIndex % 2) ? "mutual_tablerow" : "mutual_tablerow" %>'>
                                                                                                            <td class="mutual_tablerow" style="width: 34%;">
                                                                                                                <asp:Label ID="lblSectorName" runat="server" Text='<%#Eval("Sector_Name") %>' />
                                                                                                            </td>
                                                                                                            <td class="mutual_tablerow" style="width: 10%;">
                                                                                                ...
                                                                                                <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" style="margin-top: 15px; text-align: right">
                                                                                                    <tr>
                                                                                                        <td class="" style="text-align: right; margin-bottom: 10px; margin-top: 2px;">
                                                                                                            <p>
                                                                                                                <a href="https://mfi360.icrainsights.com/SectorHolding/Holdings"
                                                                                                                    target="_blank" style="color: #cc885a; font-size: 12px; font-weight: bold; text-decoration: underline">More Sectoral Analysis</a>
                                                                                                            </p>
                                                                                                        </td>
                                                                                            ...
                                                                                            <td>&nbsp;</td>
                                                                                            <td>
                                                                                                <div style="float: left; height: 200px; margin-top: 20px; margin-bottom: 15px; text-align: center; width: 98%" id="dvMarketCapContaner">
                                                                                                </div>
                                                                                                <div style="width: 100%; margin-bottom: 20px; margin-top: 2px" align="right">
                                                                                                    <div>
                                                                                                        <a href="https://mfi360.icrainsights.com/PortfolioAnalysis/Index"
                                                                                                            style="color: #cc885a; font-size: 12px; font-weight: bold; text-decoration: underline"
                                                                                                            target="_blank">Historical Market Cap Analysis</a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="width: 49%;" class="mutual_fact_header">AUM
                                                                                                Movement
                                                                                            </td>
                                                                                            <td style="width: 2%;">&nbsp;
                                                                                            </td>
                                                                                            <td style="width: 49%;" class="mutual_fact_header">Asset
                                                                                                Allocation
                                                                                            </td>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <input type="hidden" id="hdSchemeId" mutual="0" runat="server" />
                                                                                            </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="" style="text-align: right; margin-bottom: 10px; padding-top: 20px;">
                                                                                                <p>
                                                                                                    <a href="https://mfi360.icrainsights.com/Portfolio/AumMonitor"
                                                                                                        target="_blank" style="color: #cc885a; font-size: 12px; font-weight: bold; text-decoration: underline">More AUM Analysis</a>
                                                                                                </p>
                                                                                            </td>
                                                                ...
                                                                <tr>
                                                                    <td class="mutual_dis">Disclaimer: Mutual Fund investments
                                                                ...
                                                                <tr>
                                                                    <td class="mutual_btm_text" style="font-size: 10px; color: #A7A7A7"><%--Developed for Askmefund by: <a href="https://www.icraanalytics.com" target="_blank" style="font-size: 10px; color: #999999">ICRA Analytics Ltd</a>, --%><%--<a style="font-size: 10px; color: #999999" href="https://icraanalytics.com/home/Disclaimer"
                                                                        target="_blank">Disclaimer </a>--%>
                                                                        <div class="mutual_input" style="width: 100%; float: right; text-align: right; font-size: 10px; color: #A7A7A7">
                                                                            Developed for Cafemutual by: <a href="https://www.icraanalytics.com"
