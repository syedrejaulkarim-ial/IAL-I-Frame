<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true"
    CodeBehind="TopFund.aspx.cs" Inherits="iFrames.CafeMutual.TopFund" %>
...
//        }
    ...
    <script type="text/javascript"> 
        ...
        '<%#Eval("SchemeId")%>', '<%#Eval("Sch_Name")%>', '<%#Eval("OptionId")%>', '<%#Eval("Nature")%>', '<%#Eval("SubNature")%>'
        ...
        function BtnReset() {
            window.location.href = "/CafeMutual/topfund.aspx";
}
        $(function () {
            //            $.ajax({
            //                cache: false,
           ...
           $('#DvNav').hide();
            ...
            $('img[name="imgAdd2Watch"]').click(function (SchmId) {

                var dataToPush11 = JSON.stringify({ SchId: SchmId.currentTarget.id });
                $.ajax({

                    cache: false,
                    dataType: "json",
                    data: dataToPush11,
                    url: 'TopFund.aspx/NavValue',
                    type: 'POST',
                    contentType: "application/json; charset=utf-8",
                    success: function (dataConsolidated) {
                        var obj = null;                       
                        obj = dataConsolidated.d;
                        $('#DvNav').show();
                        $('#here_table tbody tr').remove();
                        //$('#here_table').remove();
                        if (flag == 0) {
                            $('#here_table').append('<thead><tr><th style="text-align:left">' + "Scheme Name" + '</th> <th style="text-align:center">' + "Date" + '</th><th style="text-align:right">' + "NAV Value" + '</th></tr>');
                            flag++;
                        }
                            //    <tr>
                            //        <th style="text-align: left">Scheme Name</th>
                            //        <th style="text-align: center">Date</th>
                            //        <th style="text-align: right">NAV Value</th>
                            //    </tr>
                            //</thead>);
                        for (var i = 0; i < obj.length; i++){
                                    
                                    $('#here_table').append( '<tr><td style="text-align:left">' + obj[i].Scheme_Name + '</td> <td style="text-align:center">'+ obj[i].StrDate +'</td><td style="text-align:right">'+ obj[i].Nav +'</td></tr>' );
            ...
            $("#" + $("#HiddenFundRiskStrColor").val().replace("-", "_")).attr("class", cssclass);
             ...
             if (FundRiskValue == null) {
                ...
                $("#mod_low").click(function (Func2) {
                    FundRiskValue = $("#mod_low").attr("for");
                    $("#HiddenFundRisk").val(FundRiskValue);
                ...
                $("#mod_high").click(function (Func2) {
                    FundRiskValue = $("#mod_high").attr("for");
                    $("#HiddenFundRisk").val(FundRiskValue);
                    $("#low").attr("class", "btn-low btn_nowrap");
                    $("#mod_low").attr("class", "btn-mod-low btn_nowrap");
                    $("#mod").attr("class", "btn-mod btn_nowrap");
        ...
        <form id="topform1" runat="server">
            <div class="navbar" align="left" style="margin-left: 7px; margin-top: -55px;">
                <div class="navbar top_bar">
                    <div class="container-fluid">
                        ...
                        <div class="bottom">
                            <div class="">
                               <a href="https://mfi360.icrainsights.com/Account/login" target="_blank"><img src="img/logo_mfi360.png"/></a>
                            </div>
            ...
            <div class="container-fluid" style="padding: 0; padding-left: 18px; padding-right: 10px;">
                <div class="row-fluid">
                    <div class="span12" id="content">
                        <div class="row-fluid" style="margin-top: 0px; /*margin-left: 25px;*/">
                            <div class="span6">
                                ...
                                <asp:Button ID="btnSubmit" class="span6 btn-sub" runat="server" Text="SUBMIT" OnClick="btnSubmit_Click" />&nbsp;&nbsp;
                                <input type="button"   class="span6 btn-sub-reset" value="RESET"  onclick="BtnReset()" />
                                <%--<asp:Button ID="btnReset" class="span6 btn-sub-reset" runat="server" Text="Reset" onclick="BtnReset()" />--%>
                            ...
                            <div class="span6" style="margin-right: -20px;">
                                ...
                                <div class="block1">
                                    ...
                                    <div class="block-content collapse1 in">
                                        ...
                                        <div id="unranged-value" class="ui-slider-grey" style="width: 95%; height: 5px; margin-left: 8px; margin-top: 52px; z-index:1"></div>

                                        <div style="color: #333333; margin-bottom: 25px; margin-left: 0px; padding-top: 8px;">
                                            <img src="images/rupee.png" width="12" height="16" alt="Rs." />500
                                        </div>

                                        <div align="right" style="color: #333333; margin-top: -45px;
                                            margin-right: 10px;">
                                    ...
                                    <div class="block-content collapse in" style="margin-top: 13px;">
                                        ...
                                        <div id="unranged-SIreturn" class="ui-slider-grey" style="width: 95%; height: 5px; margin-left: 8px; margin-top: 45px; z-index:1"></div>

                                        <div style="color: #333333; margin-bottom: 25px; margin-left: 0px; padding-top: 8px;">
                                            5
                                        </div>

                                        <div align="right" style="color: #333333; margin-top: -45px; margin-right: 10px;">
                                            50
                                        </div>
                                    ...
                                    <div class="row block-content collapse in" style="margin-top: 0px; margin-right: 5px; padding-bottom:13px;">
                                        ...
                                        <div class="span12" style="margin:0 1px">
                                            <div id="low" runat="server" title="Low Riskometer" class="btn-low btn_nowrap" for="4">Low</div>
                                            <div id="mod_low" runat="server" title="Moderately Low Riskometer" class="btn-mod-low btn_nowrap" for="5">Mod Low</div>
                                            <div id="mod" runat="server" title="Moderate Riskometer" class="btn-mod btn_nowrap" for="6">Mod</div>
                                            <div id="mod_high" runat="server" title="Moderately High Riskometer" class="btn-mod-high btn_nowrap" for="7">Mod High</div>
                                            <div id="high" runat="server" title="High Riskometer" class="btn-high btn_nowrap" for="8">High</div>
                                            <div id="all" runat="server" title="All" class="btn-all btn_nowrap" for="-1">All</div>
                   ...
                   <!-- block -->
                    <div id="Result" class="block" style="margin-top: 20px;" runat="server">
                            ...
                            <asp:ListView ID="lstResult" runat="server" OnPagePropertiesChanging="lst_PagePropertiesChanging">
                                <LayoutTemplate>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" style="margin-top: 15px; font-size: 12px;">
                                        <tr>
                                            ...
                                            <th align="center">
                                                <asp:Label ID="lblWatchList" runat="server" SkinID="lblHeader" CommandName="Sort" CommandArgument="WatchList" Text="Historical NAV"></asp:Label>
                                            </th>
                                            <%--<th align="center">
                                    ...
                                    <br />
                                        ...
                                        <div class="" style="text-align: right; margin-bottom: 10px;
                                                                                                padding-top: 20px;">
                                                                                                <p >
                                                                                                    <a href="https://mfi360.icrainsights.com/NavIndex/Index"
                                                                                                        target="_blank"
                                                                                            style="color: #cc885a; font-size: 12px; font-weight: bold;
                                                                                                        text-decoration: underline">NAV Analysis</a>
                                                                                                </p>
                                                                                            </div>
                                ...
                                <ItemTemplate>
                                    <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "value_tablerow" : "value_tablerow" %>'>
                                        ...
                                        <td align="center">
                                            <img src="img/add-button.png" style="cursor: pointer" alt="" name="imgAdd2Watch" id='<%#Eval("SchemeId")%>' />                                            
                ...
                <div class="block" id="DvNav" style="margin-top: 60px;">
                    <div class="navbar navbar-inner block-header">
                        <div class="pull-left">
                            <asp:Label ID="Label2" runat="server" Text="">NAV Value: Last 1 Month</asp:Label>
                            <div class="pull-right"></div>
                        </div>
                        <div class="pull-right"></div>

                    </div>
                    <table id="here_table" runat="server" width="100%" border="0" cellpadding="0"
                ...
                <div class="value_input" style="width: 60%; float: left;
                    font-size: 10px; color: #A7A7A7">Note : Returns less
                    than or equal to 1 year are absolute return and returns
                    more than 1 year are compound annualized.</div>
                <div class="value_input" style="width: 30%; float: right;
