<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="TataCalcOMF.aspx.cs" Inherits="iFrames.Tata.TataCalcOMF" %>
                                        ...
                                        <td class="tdstyleSch">
                                            <div class="border_drop">
                                                <asp:DataGrid class="title" ID="dgSchemeList" runat="server" AutoGenerateColumns="false"
                                                    HeaderStyle-Font-Bold="true" Width="100%" Font-Size="11px" Font-Names="Verdena"
                                                    ...
                                                    <columns>
                                                        <asp:TemplateColumn HeaderText="Name of the Scheme">
                                                            ...
                                                            <HeaderStyle BackColor="#265599" ForeColor="White" BorderColor="Black" Width="80%">
                                                            </HeaderStyle>
