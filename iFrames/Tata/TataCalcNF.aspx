<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="TataCalcNF.aspx.cs" Inherits="iFrames.Tata.TataCalcNF" %>
        ...
        function CheckSelectAll() {
            ...
            for (i = 0; i < document.forms[0].elements.length; i++) {
                if ((document.forms[0].elements[i].type == 'checkbox')) {
                    ...
                    // alert(document.forms[0].elements[i].name.indexOf("SelectAllCheckBox"))
                    if (document.forms[0].elements[i].name.indexOf("SelectAllCheckBox") != -1) {
                        // == "idSelectAllCheckBox")) 
                                        ...
                                        <td class="tdstyleSch">
                                            <div class="border_drop">
                                                <asp:DataGrid class="title" ID="dgSchemeList" runat="server" AutoGenerateColumns="false"
                                                    HeaderStyle-Font-Bold="true" Width="96%" Font-Size="11px" Font-Names="Verdena"
                                                    BorderColor="Black" BorderWidth="1" OnItemDataBound="dgItemdatabound">
                                                    <columns>
                                                        <asp:TemplateColumn HeaderText="Name of the Scheme">
                                                            ...
                                                            <HeaderStyle BackColor="#1068B2" ForeColor="White" BorderColor="Black" Width="80%">
                                                            </HeaderStyle>
                                                            <ItemStyle HorizontalAlign="Left" Font-Size="11px" Font-Names="Verdena" Width="80%">
                                                            </ItemStyle>
                                                        </asp:TemplateColumn>
                                                        <asp:TemplateColumn HeaderText="Chart">
                                                            ...
                                                            <HeaderStyle BackColor="#265599" ForeColor="White" BorderColor="Black" Width="5%">
                                                            </HeaderStyle>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-bottom: 10px; padding-top: 10px;">
                                            ...
                                            <%--<asp:LinkButton ID="lnkbtnDownload" runat="server"    OnClick="ExportExcelClick" Visible="false">
                                                                <img src="../Images/excel_icon.png" style="border: 0; margin-left:150px " alt="" width="25" height="25"  title="download excel"/></asp:LinkButton>
                                        </td>--%>
                                    </tr>
                                </table>
                            </td>
