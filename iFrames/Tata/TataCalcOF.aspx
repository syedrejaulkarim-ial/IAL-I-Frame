<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="TataCalcOF.aspx.cs" Inherits="iFrames.Tata.TataCalcOF" %>
                            ...
                            <td>
                                <table id="ContentTable" cellspacing="0px" width="100%">
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtInvestment" runat="server" CssClass="txtboxstyle" Text="10000"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tdstyle1">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtStartDate" CssClass="txtboxstyle" runat="server" Width="178px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-bottom: 10px; padding-top: 10px;">
                                            ...
                                            <asp:Button ID="Resetbtn" runat="server" Text="Reset" OnClick="ResetForm" title="Reset"
                                                CssClass="button" />
