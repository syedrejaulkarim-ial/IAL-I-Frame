<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="SchemeSearch.aspx.cs" Inherits="iFrames.BansalCapital.SchemeSearch" %>
...
<head>
    ...
    <script type="text/javascript">
        function callCross(schid, schname, OptionId, Nature, SubNature) {
            ...
            top.postMessage(data, 'http://www.askmefund.com/schemesearch.aspx');
        }
...
<body>
    <div style="width: 960px">
        <form id="topform1" runat="server">
            <div class="navbar navbar-fixed-top" align="center" style="width: 953px; margin-left: 7px; margin-top: -55px;">
            ...
            <div class="container-fluid" style="padding: 0; padding-left: 18px; padding-right: 12px;">
                <div class="row-fluid">
                    <div class="span3" id="sidebar">
                        <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse" style="margin-left: -10px; padding-top: 0;">
                         <li><a href='http://www.askmefund.com/top-performing-mutual-funds.aspx'  target="_blank">Top Funds</a></li>
                            ...
                            <li class="active"><a href= 'http://www.askmefund.com/schemesearch.aspx'  target="_blank">Scheme Search</a></li>
                    ...
                    <div class="span9" id="content">
                        ...
                        <div class="row-fluid" style="margin-top: 0px; margin-left: 24px;">
                            <div class="span6">

                                <!-- block -->
                                <div class="block1" style="width: 342px; padding-bottom: 19px;">
                                    <div>
                                    ...
                                    <div class="block-content collapse in">
                                        ...
                                        <div class="style-radio"><asp:RadioButtonList ID="rdbOption" runat="server" class="radio" RepeatDirection="Horizontal" style="display:inline-block;margin-left:5px; padding-top:5px;"></asp:RadioButtonList></div>
                                        
                                    </div>--%>
                                        <div class="controls" style="margin-bottom: 65px;">
                                            <div class="span5 lebel-drop">Option</div>
                            ...
                            <div class="span6" style="margin-right: -20px;">
                                ...
                                <div class="block1">
                                    ...
                                    <div class="block-content collapse1 in">
                                        ...
                                        <div align="right" align="right" style="color: #989898; margin-top: -45px; margin-right: 10px;">
                                    ...
                                    <div class="block-content collapse in">
                                        ...
                                        <%--<div style="width: 45%; float:left;"><h6>Perfomance Ranking :</h6></div>--%>
                                        <%--<div class="span12" align="left" style="width: 40%; padding-top:10px; padding-bottom:40px;">--%>
                                    ...
                                    <div class="block-content collapse in" style="margin-top: 0px; margin-right: 5px; padding-bottom: 10px;">
                                        <%--<img src="images/line.jpg" />--%>
                                        <div>
                                            <h6 style="margin-top: -4px;">Fund Risk :</h6>
                                        </div>

                                        <div class=""  style="margin:0 1px">
                                            <div id="low" runat="server" title="Low Riskometer" class="btn-low btn_nowrap" for="4"  style="width:28px;">Low</div>
                                            <div id="mod_low" runat="server" title="Moderately Low Riskometer" class="btn-mod-low btn_nowrap" for="5">Mod Low</div>
                                            <div id="mod" runat="server" title="Moderate Riskometer" class="btn-mod btn_nowrap" for="6"  style="width:30px;">Mod</div>
                ...
                <div class="row-fluid" style="width: 960px;">
                    <!-- block -->
                    <div id="Result" class="block" style="margin-top: 20px; margin-right: 25px; margin-left: -11px;" runat="server">
                        <asp:HiddenField ID="HiddenDivValue" runat="server" />
                        <div class="navbar navbar-inner block-header" style="padding-right: 1px;">
                            ...
                            <asp:ListView ID="lstResult" runat="server" OnPagePropertiesChanging="lst_PagePropertiesChanging">
                                <LayoutTemplate>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered" style="margin-top: 15px; font-size: 12px;">
                                        <tr>
                                            ...
                                            <th align="center" class="value_tableheader">
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                <td class="value_input" style="width: 90%">
                                                    <div style="width: 70%; float: left; text-align: left; font-size: 12px">
                                    ...
                                    <br />
                                                    ...
                                                    <div class="value_input" style="width: 30%; float: right; text-align: right; font-size: 11px; color: #A7A7A7">
                                                        Developed for Askmefund by: <a href="https://www.icraanalytics.com" target="_blank" style="font-size: 11px; color: #999999">ICRA Analytics Ltd</a>, <a style="font-size: 10px; color: #999999" href="https://icraanalytics.com/home/Disclaimer"
                                ...
                                <ItemTemplate>
                                    <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "value_tablerow" : "value_tablerow" %>'>
                                        ...
                                        <td class="value_tablerow" style="width: 35%;">
                                        ...
                                        <td class="value_tablerow" align="center">
                                        ...
                                        <%-- <td class="value_tablerow" style="width:75px;" align="center">
