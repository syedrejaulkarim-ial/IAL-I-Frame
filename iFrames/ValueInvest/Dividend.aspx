<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="Dividend.aspx.cs" Inherits="iFrames.ValueInvest.Dividend" %>
                    ...
                    <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="value_heading" colspan="2">
                                <img src="img/arw1.jpg" />MF Dividends</td>
...
<%--                                                        <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" class="value_table">
                                                            <tr class="value_tableheader">
                                                                ...
                                                                <td class="value_tableheader">Record Date</td>
                                                                <td class="value_tableheader">Dividend (in %)</td>
                                                                <tr>
                                                        ...
                                                        <asp:ListView ID="listvwDividendDetail" runat="server" OnPagePropertiesChanging="lst_PagePropertiesChanging">
                                                            <LayoutTemplate>
                                                                <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" class="value_table">
                                                                    <tr class="value_tableheader">
                                                                        <th align="left">
                                                                            <asp:Label ID="lnkSchName" style="font-weight:bold" runat="server" SkinID="lblHeader" CommandName="Sort" CommandArgument="SchName"
                                                                                Text="Scheme Name" />
                                                                        </th>
                                                                        <th align="left">
                                                                            <asp:Label ID="lnkDate" style="font-weight:bold" runat="server" SkinID="lblHeader" CommandName="Sort" CommandArgument="Date"
                                                                                Text="Record Date" />
                                                                        </th>
                                                                        <th align="left">
                                                                            <asp:Label ID="lnkNav" style="font-weight:bold" runat="server" SkinID="lblHeader" CommandName="Sort" CommandArgument="Dividend"
                                                                                Text="Dividend (%)" />
                                                                        </th>
                                                                    </tr>
                                                            ...
                                                            <EmptyDataTemplate>
                                                                 <tr>
                                                                    <td class="value_tablerow" style="border:none">
                                                                Data not Found
                                                                        </td>
                                                                     </tr>
                                                            </EmptyDataTemplate>
