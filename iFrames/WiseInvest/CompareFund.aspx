<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="CompareFund.aspx.cs" Inherits="iFrames.WiseInvest.CompareFund" %>
...
<body>
    ...
    <table id="tblControls" class="" border="0" cellpadding="0" cellspacing="4">
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnAddScheme" runat="server" Text="Add" CssClass="button" OnClick="btnAddScheme_Click"
                    OnClientClick="Javascript:ValidateControl();" ValidationGroup="scheme" />
            </td>
        </tr>
        <tr>
            <td class="title" style="padding-left: 4px;">
    ...
    <table width="710" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <tr>
                                                                                                    <td class="text" align="right">
                                                                                                        <span style="text-align: right" class="rslt_text1">Developed and Maintained by:<a class="text" href="https://www.icraanalytics.com"
