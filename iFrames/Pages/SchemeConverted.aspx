<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchemeConverted.aspx.cs"
    Inherits="iFrames.Pages.SchemeConverted" %>
...
<body>
    ...
    <div>
        ...
        <table width="550px" border="0" cellpadding="3" cellspacing="3" style="height: 400px;
            ...
            <tr>
                <td valign="top">
                    <table style="margin-top: 30px;">
                        <tr class="mainHeader">
                            <td>
                                SCHEMES CONVERETED OR ROLLED OVER
                                <hr />
                        ...
                        <tr class="SubHeader">
                            <td>
                                Enter mutual fund house or scheme name to know the schemes converted or rolled over
                                till date.
                                <br style="line-height: 15px;" />
                            </td>
                        </tr>
            ...
            <tr class="SubHeader">
                <td>
                    Following is the list of Schemes Converted/Rolled Over.
                    <br style="line-height: 15px;" />
                </td>
            </tr>
            <tr>
                    ...
                    <asp:ListView ID="lstConvertedScheme" runat="server" OnPagePropertiesChanging="lst_PagePropertiesChanging">
                            ...
                            <table cellpadding="3" border="1" cellspacing="3" style="border-color: Black; border-collapse: collapse;">
                                <tr class="ListtableHead">
                                    ...
                                    <th id="sdiv" runat="server">
                                        Converted/Rolled Over T0 New Name
                                    </th>
                                </tr>
                        ...
                        <ItemTemplate>
                            <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "AlternateRow" : "ListtableRow" %>'>
                                ...
                                <td>
                                    <%#Eval("rolled_over_date").ToString() != "" ? Convert.ToDateTime(Eval("rolled_over_date").ToString()).ToString("MMM dd, yyyy") : "NA"%>
                                </td>
                                <td>
...
<script type="text/javascript" language="javascript">
    function test() {
        alert("ok");
        document.getElementById('<%= txtSchemes.ClientID %>').value = "rajat";
        return false;
    }
    </script>
</html>
