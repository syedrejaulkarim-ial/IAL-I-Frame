<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RedemptionRepurchase.aspx.cs" Inherits="iFrames.Pages.RedemptionRepurchase" %>
    ...
    <div>
        <table width="550px" cellpadding="3" cellspacing="3">
            ...
            <tr class="SubHeader" align="center">
                <td>
                    Redemptions/Repurchases during the month of &nbsp;&nbsp;<%=Convert.ToDateTime(ReqDate.ToString()).ToString("MMM, yyyy")%>
                </td>
            </tr>
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0" width="550px">
                        ...
                        <tr>
                            <asp:ListView ID="lstRedRep" runat="server" >
                                <LayoutTemplate>
                                    ...
                                    <%--<asp:DataPager runat="server" ID="dp" PageSize="10" PagedControlID="lstRedRep">
                                        <Fields>
                                ...
                                <ItemTemplate>
                                    <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "AlternateRow" : "ListtableRow" %>'>
                                        ...
                                        <td align="center">
                                            <%#Convert.ToDouble(Eval("Redem_open")) != 0 ? Eval("Redem_open") : "--"%>
                                        </td>                                       
                                        <td align="center">
                                            <%#Convert.ToDouble(Eval("Redem_close")) != 0 ? Eval("Redem_close").ToString() : "--"%>
                                        </td>                                       
                                        <td align="center">
                                            <%#Convert.ToDouble(Eval("TotRedem")) != 0 ? Eval("TotRedem").ToString() : "--"%>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <EmptyDataTemplate>
