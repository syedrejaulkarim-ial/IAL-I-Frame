<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewScheme.aspx.cs" Inherits="iFrames.Pages.NewScheme" %>
            ...
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0" width="550px">
                        ...
                        <tr>
                            <asp:ListView ID="lstNewSchemes" runat="server" >
                                <LayoutTemplate>
                                    ...
                                    <%--<asp:DataPager runat="server" ID="dp" PageSize="10" PagedControlID="lstNewSchemes">
                                        <Fields>
                                ...
                                <ItemTemplate>
                                    <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "AlternateRow" : "ListtableRow" %>'>
                                        ...
                                        <td align="center">
                                            <%#Convert.ToInt32(Eval("new_sch_open")) != 0 ? Eval("new_sch_open").ToString() : "--"%>
                                        </td>
                                        <td align="center">
                                            <%#Convert.ToDouble(Eval("new_sch_amt_open")) != 0 ? Eval("new_sch_amt_open").ToString() : "--"%>
                                        </td>
                                        <td align="center">
                                            <%#Convert.ToInt32(Eval("new_sch_close")) != 0 ? Eval("new_sch_close").ToString() : "--"%>
                                        </td>
                                        <td align="center">
                                            <%#Convert.ToDouble(Eval("new_sch_amt_close")) != 0 ? Eval("new_sch_amt_close").ToString() : "--"%>
                                        </td>
                                        <td align="center">
