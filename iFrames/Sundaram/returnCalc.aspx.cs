...
namespace iFrames.Sundaram
{
    public partial class returnCalc : System.Web.UI.Page
    {
        ...
        private void SetDefaultView()
        {
            ...
            lnkTab1.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button is-active";
            lnkTab2.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab4.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab3.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab5.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
        }
        ...
        {
            MultiView1.ActiveViewIndex = 1;
            lnkTab1.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab2.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button is-active";
            lnkTab4.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab3.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab5.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab2.Focus();
        ...
        protected void lnkTab3_Click(object sender, EventArgs e)
        {
            lnkTab1.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab2.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab3.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button is-active";
            lnkTab4.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab5.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
        ...
        protected void lnkTab4_Click(object sender, EventArgs e)
        {
            ...
            lnkTab1.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab2.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab4.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button is-active";
            lnkTab3.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab5.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab4.Focus();
            CallChartFromView2();
            ...
            using (var principl = new PrincipalCalcDataContext())
            {
                ...
                var allotdate = from ind in principl.T_SCHEMES_MASTERs
                                ...
                                select new
                                {
                                    ...
                                    FaceValue = ind.Face_Value
                                };
                //SIPSchDt.Text = "";
                if (allotdate != null && allotdate.Count() > 0)
                {
                    HdFaceValue.Value = allotdate.FirstOrDefault().FaceValue.ToString();
        ...
        protected void ddlschtrto_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            using (var principl = new PrincipalCalcDataContext())
            {
                ...
                if (allotdate != null && allotdate.Count() > 0)
                {
                    HdFaceValueToSch.Value = allotdate.FirstOrDefault().FaceValue.ToString();
                    //SIPSchDt.Text = "<b>" + Convert.ToDateTime(allotdate.Single().LaunchDate).ToString("dd/MM/yyyy", CultureInfo.InvariantCulture) + "<b/>";
            ...
            try
            {
                using (var optionData = new PrincipalCalcDataContext())
                {
                    ...
                    if (option.Count() > 0)
                    {
                        ...
                        ddlOption.DataBind();
                        ddlOption.Items.Insert(0, new ListItem("select option", "0"));
                    }
                }
            }
            catch (Exception)
        ...
        protected void PopulateFrequency()
        {
            ...
            if (ddlMode.SelectedItem.Text.ToUpper().StartsWith("STP"))
            {
                //ddPeriod_SIP.Items.Add(new ListItem("Weekly", "Weekly"));
                ddPeriod_SIP.Items.Add(new ListItem("Monthly", "Monthly"));
                ddPeriod_SIP.Items.Add(new ListItem("Quarterly", "Quarterly"));
        ...
        public void CalculateReturn()
        {
            ...
            try
            {
                ...
                using (var principl = new SIP_ClientDataContext() { CommandTimeout = 600 })
                {
                    ...
                    #region Dividend per unit Calculation
                    double _div = 0;
                    foreach (var d in divHistoryTbl)
                        if (!string.IsNullOrEmpty(d.DIVIDEND))
                            if (double.TryParse(d.DIVIDEND, out _div))
                                d.DIVIDEND = Math.Round(_div * Convert.ToDouble(HdFaceValue.Value) / 100, 4).ToString();
                    _div = 0;
                    foreach (DataRow d in SipDtable1.Rows)
                        if (!string.IsNullOrEmpty(Convert.ToString(d["DIVIDEND_BONUS"])))
                            if (double.TryParse(Convert.ToString(d["DIVIDEND_BONUS"]), out _div))
                                d["DIVIDEND_BONUS"] = Math.Round(_div * Convert.ToDouble(HdFaceValue.Value) / 100, 4).ToString();
                    #endregion
        ...
        public void CalculateReturnSWP()
        {
            ...
            try
            {
                ...
                if (dSet.Tables.Count > 0)
                {
                    ...
                    #region Dividend per unit Calculation
                    double _div = 0;
                    foreach (DataRow dr in datatTble.Rows)
                        if (!string.IsNullOrEmpty(Convert.ToString(dr["Dividend_Bonus"])))
                            if (double.TryParse(Convert.ToString(dr["Dividend_Bonus"]), out _div))
                                dr["Dividend_Bonus"] = Math.Round(_div * Convert.ToDouble(HdFaceValue.Value) / 100, 4).ToString();
                    #endregion
        ...
        public void CalculateReturnSTP()
        {
            ...
            try
            {
                ...
                else if (ddPeriod_SIP.SelectedItem.Text.ToUpper() == "QUARTERLY")
                {
                ...
                if (dSet.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow d in dtble.Rows)
                    {
                        if (!string.IsNullOrEmpty(Convert.ToString(d["Dividend_Bonus_From"])))
                            if (double.TryParse(Convert.ToString(d["Dividend_Bonus_From"]), out _divFrom))
                                d["Dividend_Bonus_From"] = Math.Round(_divFrom * Convert.ToDouble(HdFaceValue.Value) / 100, 4).ToString();

                        if (!string.IsNullOrEmpty(Convert.ToString(d["Dividend_Bonus_To"])))
                            if (double.TryParse(Convert.ToString(d["Dividend_Bonus_To"]), out _divTo))
                                d["Dividend_Bonus_To"] = Math.Round(_divTo * Convert.ToDouble(HdFaceValueToSch.Value) / 100, 4).ToString();
                    }
                    #endregion
        ...
        private void PerformanceReturn()
        {
            ...
            try
            {
                ...
                if (IsSchemeDividend && lmprdbPayout.Checked)
                {
                    ...
                    var result = iFrames.BLL.AllMethods.DividendPayoutCalcSundaram(Convert.ToDecimal(schmeId), initialInvestment, _fromDate, _toDate, true, out DividendValue, true);
                ...
                else if (IsSchemeDividend && lmprdbReinvest.Checked)
                {
                    ...
                    var initialInvestment = Convert.ToDouble(txtinstallLs.Text);
                    double? DividendValue = default(double?);
                    var result = iFrames.BLL.AllMethods.DividendPayoutCalcSundaram(Convert.ToDecimal(schmeId), initialInvestment, _fromDate, _toDate, false, out DividendValue, true);
        ...
        protected void ShowRelativeDiv()
        {
            ...
            if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP")
            {
                ...
                trSipInvst.Visible = true; //trSipInvst1.Visible = true; 
                trLumpInvst.Visible = false; trInitialInvst.Visible = false; trInitialInvst1.Visible = false;
                ...
                SIP_withdrawl.Visible = true; SIP_withdrawl1.Visible = true;
                ...
                lblTransferWithdrawal.Visible = false; txtTransferWithdrawal.Visible = false; SIP_withdrawl1.Visible = false;
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "LUMP SUM")
            {
                ...
                trLumpInvst.Visible = true; trInitialInvst.Visible = false; trInitialInvst1.Visible = false; trSipInvst.Visible = false; //trSipInvst1.Visible = false;
                trCategory.Visible = true; lblSchemeName.Text = "Scheme Name"; trTransferTo.Visible = false;
                trBenchmark.Visible = true; lblInstallmentAmt.Text = "Installment Amount (₹)";
                lblDiffDate.Text = "SIP Date";
                // trTransferWithdrawal.Visible = false;
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
            {
                ...
                lnkTab1.Visible = true; lnkTab2.Visible = true;
                GridViewResultLS.Visible = false; GridViewLumpSum.Visible = false;
                trInitialInvst.Visible = true; trInitialInvst1.Visible = true; trSipInvst.Visible = true; //trSipInvst1.Visible = false; 
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
            {
                ...
                lnkTab1.Visible = true; lnkTab2.Visible = true;
                GridViewResultLS.Visible = false; GridViewLumpSum.Visible = false;
                trSipInvst.Visible = true; //trSipInvst1.Visible = false; 
                trLumpInvst.Visible = false; trInitialInvst.Visible = true; trInitialInvst1.Visible = true;
                ...
                SIP_withdrawl.Visible = false; SIP_withdrawl1.Visible = false;
        ...
        private void ShowExcel(string FundName)
        {
            ...
            //objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;	font-family: Arial;	color: #ffffff;	font-size: 12px;	font-weight:normal;	line-height: 20px;	background:#2ee9b6;	height:25px; width:15px '");
            objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;	font-family: Arial;	color: #ffffff;	font-size: 11px;background:#2ee9b6;	font-weight:normal;'");
            ...
            try
            {
                ...
                foreach (DataColumn dc in _dt.Columns)
                {
                    ...
                    else if (dc.ColumnName.ToUpper() == "INDEX_VALUE_AMOUNT")
                    {
                        ...
                        chrt.Series[dc.ColumnName].Color = System.Drawing.Color.Green;//#2ee9b6 //System.Drawing.ColorTranslator.FromHtml("#02278b");//
                    ...
                    {
                        CompareToColumn = dc.ColumnName.ToUpper();
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#2ee9b6");// System.Drawing.Color.Blue;//#2ee9b6
                ...
                string localImgPath = @"Sundaram\Img";
                ...
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "Sundaram\\IMG", "Sundaram_SIP_Temp*");
        ...
        public void BindDataTableToBarChart(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt, string strCompareColumn)
        {
            ...
            try
            {
                ...
                #region Delete MyRegion
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "Sundaram\\IMG", "DSP_SIP_Temp*");
                foreach (var f in allImageFiles)
                    if (File.GetCreationTime(f) < DateTime.Now.AddHours(-1))
                        File.Delete(f);
        ...
        public string GETHtmlFile()
        {
            ...
            switch (RadioButtonListCustomerType.SelectedItem.Text.ToUpper().Trim())
            {
                case "DISTRIBUTOR":
                    if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramSIPPDFTemplate.html")));// for din regular SundaramPDFtemplate3 normal
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramswpPDFTemplate.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramstpPDFTemplate.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramPDFTemplateInitial.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramLsPDFTemplate.html")));
                    }
                    break;
                default:
                    if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramSIPPDFTemplateWOD.html")));//
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramswpPDFTemplateWOD.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramstpPDFTemplateWOD.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramPDFTemplateInitialWOD.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Sundaram/Html/SundaramLsPDFTemplateWOD.html")));
                    }
                    break;
            }
        ...
        public void CreateHTMLSIP()
        {
            ...
            var allFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "Sundaram\\PDF", "Sundaram_*");
            foreach (var f in allFiles)
            ...
            try
            {
                ...
                if (ddlMode.SelectedItem.Value.ToUpper().StartsWith("SIP"))
                {
                    gvFirstTablestr = gvFirstTablestr.Replace(@"scope=""col""", "style ='text-align:center;font-family: Arial;color: #ffffff;font-size: 15px;font-weight: normal;background: #2ee9b6;height: 25px;'");
                ...
                path = HttpContext.Current.Server.MapPath("~/Sundaram/PDF/" + "Sundaram" + "_" + Convert.ToString(Session["GUID"]) + ".htm");
                ...
                if (Session["GUID"] != null)
                {
                    ...
                    Response.AppendHeader("Content-Disposition", "attachment; filename=SUNDARAM.pdf");
                    Response.TransmitFile(Server.MapPath("~/Sundaram/PDF/Sundaram_" + pdfName));
                    Response.End();
                }
        ...
        protected void lnkTab5_Click(object sender, EventArgs e)
        {
            ...
            lnkTab4.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab3.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button";
            lnkTab5.CssClass = "text-light-1 lh-12 tabs__button mr-30 js-tabs-button is-active";
            lnkTab5.Focus();
        }
