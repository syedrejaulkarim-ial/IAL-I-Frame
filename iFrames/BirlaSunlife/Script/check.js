...
function checkInvestedValue() {
    ...
    if (mode == 'Lump Sum') {
        ...
        if (isNaN(withdrwAmt)) {
            ...
            if (curState != null) { if (mode == 'STP' && curState) { return true; } }
...
//                alert(mode + " is allowed for minimum 6 Installments");
//                document.getElementById('txtToDate').value = "";
//                document.getElementById('txtToDate').focus();
//                return false;
//            }
//            else if (k < 12 && period == "Quarterly") {
//                alert(mode + " is allowed for minimum 4 Installments");
//                document.getElementById('txtToDate').value = "";
//                document.getElementById('txtToDate').focus();
//                return false;
//            }
...
//                alert("SIP is allowed for minimum 6 Installments");
//                document.getElementById('txtToDate').value = "";
//                document.getElementById('txtToDate').focus();
//                return false;
//            }
...
function validate_SIP() {
    ...
    if (document.getElementById("ddlMode").value == 'Lump Sum') {
        ...
        var transferDate = document.getElementById("ddSIPdate").value;
        dt = addDays(dt, transferDate)
...
function validate_SWP() {
    ...
    //        alert('Enter Withdrawal amount for minimum 6 transaction.');
    //        document.getElementById('txtTransferWithdrawal').value = "";
    //        document.getElementById("txtTransferWithdrawal").focus();
    //        return false;
    //    }
    ...
    if (ind > 0) {
        ...
        if (k < 6 && period == "Monthly") {
            alert("SWP (Monthly) is allowed for minimum 6 Installment");
            document.getElementById('txtfromDate').value = "";
            document.getElementById('txtfromDate').focus();
            return false;
        }
        else if (k < 12 && period == "Quarterly") {
            alert("SWP (Quarterly) is allowed for minimum 4 Installment");
            document.getElementById('txtfromDate').value = "";
            document.getElementById('txtfromDate').focus();
            return false;
        }
    ...
    if (document.getElementById("ddPeriod_SIP").value == "Monthly") {
        if (withamt >= 500) {
            var dayDiff = DateDiff.inMonths(dt, dt2);
            if (dayDiff < 6) {
                alert('There should be at least 6 transfers');
                return false;
            }
        }

        if ((initamt / withamt) < 6) {
            alert('There should be at least 6 monthly transfers');
            return false;
        }

    }

    if (document.getElementById("ddPeriod_SIP").value == "Quarterly") {
        if ((initamt / withamt) < 4) {
            alert('There should be at least 4 quarterly transfers');
            return false;
        }
    }
...
function validate_STP() {
    ...
    if (isNaN(sipwdamunt)) {
        ...
        var curState = $("#chkCapApp").is(':checked');
        if (curState != null) { if (curState) { return true; } }
...
//    if (initamt / withamt < 6) {
//        alert('Enter Transfer amount for a minimum 6 transaction.');
//        document.getElementById("txtTransferWithdrawal").focus();
//        return false;
//    }
...
//        if (k < 5 && period == "Monthly") {
//            alert("STP is allowed for minimum 6 Installment");
//            document.getElementById('txtfromDate').value = "";
//            document.getElementById('txtfromDate').focus();
//            return false;
//        }
...
//    }
    ...
    if (document.getElementById("ddPeriod_SIP").value == "Daily") {
        if (initamt < 10000) {
            alert('For daily frequency minimum investment amount should be Rs 10000');
            return false
        }

        if (withamt == 500) {
            var dayDiff = calcBusinessDays(dt, dt2);
            if (dayDiff < 20) {
                alert('There should be at least 20 transfers of Rs 500 ');
                return false;
            }
        }

        if (withamt == 500) {
            if (initamt / withamt < 20) {
                alert('There should be at least 20 transfers of Rs 500 ');
                return false;
            }
        }
    ...
    if (document.getElementById("ddPeriod_SIP").value == "Weekly" || document.getElementById("ddPeriod_SIP").value == "Monthly" || document.getElementById("ddPeriod_SIP").value == "Quarterly") {
      
        if (withamt > 500 && withamt < 999) {
            if (initamt / withamt < 12) {
                alert('There should be at least 12 transfers. ');
                return false;
            }
        }
    ...
    if (document.getElementById("ddPeriod_SIP").value == "Weekly") {
        var wkDiff = DateDiff.inWeeks(dt, dt2);
        if (withamt > 500 && withamt < 999) {
            if (wkDiff < 12) {
                alert('There should be at least 12 transfers. ');
                return false;
    ...
    if (document.getElementById("ddPeriod_SIP").value == "Weekly" || document.getElementById("ddPeriod_SIP").value == "Monthly") {
        if (initamt < 6000) {
            alert('Minimum investment should be Rs 6000');
            return false;
        }
    }

    if (document.getElementById("ddPeriod_SIP").value == "Monthly") {
        var wkDiff = DateDiff.inMonths(dt, dt2);
    ...
    if (document.getElementById("ddPeriod_SIP").value == "Quarterly") {
        ...
        if (initamt < 8000) {
            alert('For quarterly frequency minimum investment amount should be Rs 8000');
            return false;
        }

//        var qtrDiff = DateDiff.inDays(dt, dt2) / 90;
//            if (qtrDiff < 4) {
//                alert('There should be at least 6 transfers. ');
//                return false;
//            
...
function addDays(startDate, numberOfDays) {
    var returnDate = new Date(
								...
								startDate.getMonth(),
								parseInt(startDate.getDate()) + parseInt(numberOfDays),
								startDate.getHours(),
