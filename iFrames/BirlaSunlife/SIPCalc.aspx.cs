...
namespace iFrames.BirlaSunlife
{
    public partial class BirlaSIPCalc : System.Web.UI.Page
    {
        ...
        {
            this.sipbtnshow.Attributes.Add("onclick", "javascript:return validateBirla();");// Add ClientSide Script for Data Validation function defined in check.js
            if (!IsPostBack)
            {
                FillNature();
                FillPlan();
        ...
        private void AddFrequency()
        {
            ...
            if (ddlMode.Text.ToUpper() == "STP" || ddlMode.Text.ToUpper() == "SWP")
            {
                ddPeriod_SIP.Items.Add(new ListItem() { Text = "Daily", Value = "Daily" });
                ddPeriod_SIP.Items.Add(new ListItem() { Text = "Weekly", Value = "Weekly" });
                ddPeriod_SIP.Items.Add(new ListItem() { Text = "Monthly", Value = "Monthly" });
                ddPeriod_SIP.Items.Add(new ListItem() { Text = "Quarterly", Value = "Quarterly" });
            }
            else if (ddlMode.Text.ToUpper() == "SIP" || ddlMode.Text.ToUpper() == "SIP WITH INITIAL INVESTMENT")
            {
                ddPeriod_SIP.Items.Add(new ListItem() { Text = "Weekly", Value = "Weekly" });
                ddPeriod_SIP.Items.Add(new ListItem() { Text = "Monthly", Value = "Monthly" });
            }
        ...
        private void AddTransferDates()
        {
            ddSIPdate.Items.Clear();

            List<ListItem> ListItems = new List<ListItem>();

            ListItems.Add(new ListItem() { Text = "1", Value = "1" });
            ListItems.Add(new ListItem() { Text = "7", Value = "7" });
            ListItems.Add(new ListItem() { Text = "10", Value = "10" });
            ListItems.Add(new ListItem() { Text = "20", Value = "20" });
            ListItems.Add(new ListItem() { Text = "28", Value = "28" });

            if (ddlMode.Text.ToUpper() == "SIP" || ddlMode.Text.ToUpper() == "SIP WITH INITIAL INVESTMENT")
            {
                ListItems.Add(new ListItem() { Text = "15", Value = "15" });
                if (ddPeriod_SIP.SelectedItem.Value == "Monthly")
                {
                    ListItems.Add(new ListItem() { Text = "2", Value = "2" });
                    ListItems.Add(new ListItem() { Text = "3", Value = "3" });
                    ListItems.Add(new ListItem() { Text = "4", Value = "4" });
                    ListItems.Add(new ListItem() { Text = "5", Value = "5" });
                    ListItems.Add(new ListItem() { Text = "6", Value = "6" });
                    ListItems.Add(new ListItem() { Text = "8", Value = "8" });
                    ListItems.Add(new ListItem() { Text = "9", Value = "9" });
                    
                    ListItems.Add(new ListItem() { Text = "11", Value = "11" });
                    ListItems.Add(new ListItem() { Text = "12", Value = "12" });
                    ListItems.Add(new ListItem() { Text = "13", Value = "13" });
                    ListItems.Add(new ListItem() { Text = "14", Value = "14" });
                    ListItems.Add(new ListItem() { Text = "16", Value = "16" });
                    ListItems.Add(new ListItem() { Text = "17", Value = "17" });
                    ListItems.Add(new ListItem() { Text = "18", Value = "18" });
                    ListItems.Add(new ListItem() { Text = "19", Value = "19" });
                    ListItems.Add(new ListItem() { Text = "21", Value = "21" });
                    ListItems.Add(new ListItem() { Text = "22", Value = "22" });
                    ListItems.Add(new ListItem() { Text = "23", Value = "23" });
                    ListItems.Add(new ListItem() { Text = "24", Value = "24" });
                    ListItems.Add(new ListItem() { Text = "25", Value = "25" });
                    ListItems.Add(new ListItem() { Text = "26", Value = "26" });
                    ListItems.Add(new ListItem() { Text = "27", Value = "27" });
            ...
            ddSIPdate.Items.AddRange(ListItems.OrderBy(p => Convert.ToInt32(p.Value)).ToArray());
        ...
        protected void ddPeriod_SIP_SelectedIndexChanged(object sender, EventArgs e)
        {           
            AddTransferDates();
        }
        ...
        protected void ddlscheme_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (!(ddlMode.Text.ToUpper() == "SIP" || ddlMode.Text.ToUpper() == "SIP WITH INITIAL INVESTMENT" || ddlMode.Text.ToUpper() == "LUMP SUM"))
            {
        ...
        protected void FillNature()
        {
            try
            {
                ...
                ddlNature.Items.Add(new ListItem("All", "-1"));
        ...
        protected void FillOptions()
        {
            try
            {
                ...
                //foreach (DataRow drow in _dt.Rows)
                //{
                //    ddlOption.Items.Add(new ListItem(drow[0].ToString(), drow[1].ToString()));
                //}
                ...
                ddlOption.DataSource = OptionDataTable;
        ...
        protected void FillPlan()
        {
            try
            {
                DataTable PlansDataTable = new DataTable("PlansDataTable");
                PlansDataTable.Columns.Add("Id", typeof(int));
                PlansDataTable.Columns.Add("Plan", typeof(string));
                
                PlansDataTable.Rows.Add(40, "Regular");
                PlansDataTable.Rows.Add(46, "Direct");



                ddlPlan.DataSource = PlansDataTable;
                ddlPlan.DataTextField = "Plan";
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        SchemeOptions.Add(dr["Scheme_Id"].ToString(), dr["OptionId"].ToString());
                    }
                    // drpdwn.DataBind();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                       ...
                       // ViewState["INDEX_NAME"] = dr["INDEX_NAME"].ToString();
						...
						//Add new for TRI by koustav 04.04.2018						
        ...
        //                                 where
        //                                   t_fund_masters.MUTUALFUND_ID == 4 && t_fund_masters.STRUCTURE_ID == 2
        //                                 select new
        //                                 {
        ...
        //                                select d;
        //                }
        //                else if (selected_mode.ToUpper() == "STP" || selected_mode.ToUpper() == "SWP")
        //                {
        //                    fundtable = from d in fundtable
        ...
        public DataTable FetchScheme()
        {
            ...
            dtScheme = AllMethods.getSebiScheme(Convert.ToInt32(ddlNature.SelectedItem.Value),2, -1,Convert.ToInt32(ddlOption.SelectedItem.Value),4,true, Convert.ToInt32(ddlPlan.SelectedItem.Value));
            //ddlSchemes.DataBind();
        ...
        //            var fundtable = (from t_fund_masters in scheme.T_FUND_MASTERs
        //                             where
        //                               t_fund_masters.MUTUALFUND_ID == 4
        ...
        public DataTable FetchSchemeWithout(string schid)
        {
            ...
            try
            {
                DataTable dtSch = AllMethods.getSebiScheme(-1, 2, -1, -1, 4,true);
                var res = (from myRow in dtSch.AsEnumerable()
                           where myRow.Field<decimal>("Scheme_Id") != Convert.ToDecimal(schid)
		...
		public void CalculateReturn()
        {
            ...
            string strsql = String.Empty, schmeId = string.Empty, indexId = string.Empty, Colstr = string.Empty, daydiffCol = string.Empty, selectedScheme = string.Empty;
            ...
            try
            {
                ...
                //bool isdate = DateTime.TryParse(txtfromDate.Text, out myDate);

                //if (DateTime.TryParse(txtfromDate.Text, out myDate))
                //{
                ...
                selectedScheme = ddlscheme.SelectedItem.Text.Trim().ToUpper();
                ...
                else if (ddPeriod_SIP.SelectedItem.Value == "Daily")
                {
                    PrdVal = 5;
                }
                ...
                if (PrdVal == 1)
                {
                    ...
                    tempDate = sipEndDate.AddMonths(-6);//12
                    tmspan = tempDate.Subtract(sipStartDate);
                    daydiff = tmspan.Days;
                    if (daydiff < 0)
                    {
                ...
                using (var principl = new SIP_ClientDataContext() { CommandTimeout = 600000 })
                {
                    ...
                    //move scheme top and index as below edited 26 June 2019
                    //DataTable ordrTbl = new DataTable();
                    //ordrTbl = SipDtable2;
                    //DataRow[] dr = ordrTbl.Select("SCHEME ='" + selectedScheme + "'");
                    //DataRow newRow = ordrTbl.NewRow();
                    //// We "clone" the row
                    //newRow.ItemArray = dr[0].ItemArray;
                    //// We remove the old and insert the new
                    //ordrTbl.Rows.Remove(dr[0]);
                    //ordrTbl.Rows.InsertAt(newRow, 0);
                ...
                cmdScheme.Parameters.Add(new SqlParameter("@DateTo", sipAsonDate.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture)));
                ...
                cmdIndex.Parameters.Add(new SqlParameter("@DateTo", sipAsonDate.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture)));
        ...
        public void CalculateReturnSWP()
        {
            ...
            try
            {
                ...
                if (PrdVal == 1)
                {
                    tempDate = swpEndDate.AddMonths(-6);
                    datedifference = tempDate.Subtract(swpStartDate);
                    daydiff = datedifference.Days;
                    //if (daydiff < 0)
                    //{
                    //    Response.Write("<script>alert(\"SWP is allowed for minimum 6 withdrawal\")</script>");
                    //    return;
                    //}
                }
                else if (PrdVal == 3)
                {
                    tempDate = swpEndDate.AddMonths(-18);
                    datedifference = tempDate.Subtract(swpStartDate);
                    daydiff = datedifference.Days;
                    //if (daydiff < 0)
                    //{
                ...
                List<string> objFundDescList = new List<string>();
                //objFundDescList.AddRange(GetFundDesc(schemeId));
                ...
                datatTbleHistorical = CalculateHistPerf(swpAsonDate);
        ...
        public void CalculateReturnSTP()
        {
            ...
            try
            {
                ...
                string capital_appreciation_flag = "N";
                if (chkCapApp.Checked) { capital_appreciation_flag = "Y"; }

                # region calling SP
                //cmdstp = new SqlCommand("MFIE_SP_STP_CALCULATER_DSPTEST", conn);
                cmdstp = new SqlCommand("Ds_Sp_Stp_Calculater_With_CapApp", conn);
                cmdstp.CommandType = CommandType.StoredProcedure;
                cmdstp.CommandTimeout = 6000;
                ...
                cmdstp.Parameters.Add(new SqlParameter("@capital_appreciation_flag", capital_appreciation_flag));
                ...
                //objFundDescList.AddRange(GetFundDesc(schemeIdtrf));
                //objFundDescList1.AddRange(GetFundDesc(schemeIdtrto));
                ...
                double? investval = default(double?);
                if (!chkCapApp.Checked)
                {
                    //investval = dtble.AsEnumerable().Where(x => x.Field<double?>("INVST_AMOUNT") == dblStpTransferAmnt).Select(x => x.Field<double?>("INVST_AMOUNT")).Sum();
                    investval = dtble.AsEnumerable().Where(x => x.Field<double?>("INVST_AMOUNT") > 0 && x.Field<object>("From_Scheme_ID").ToString() != "0").Select(x => x.Field<double?>("INVST_AMOUNT")).Sum();
                }
                else
                    investval = dtble.AsEnumerable().Where(x => x.Field<double?>("INVST_AMOUNT") > 0 && x.Field<object>("From_Scheme_ID").ToString() != "0").Select(x => x.Field<double?>("INVST_AMOUNT")).Sum();
                ...
                //STPToTable.Rows[0]["Scheme_Name"] = ddlschtrto.SelectedItem.Text.ToString();
                //STPToTable.Rows[0]["Total_Amount_Invested"] = Convert.ToDouble(investmntValue);
                //STPToTable.Rows[0]["Present_Value"] = Convert.ToDouble(amountLeftTo);
                //STPToTable.Rows[0]["Yield"] = Math.Round(Convert.ToDouble(YieldFromTo), 2);

                //gvSTPToSummaryTable.DataSource = STPToTable;
                //gvSTPToSummaryTable.DataBind();
                ...
                DataView dv = new DataView(stpfromDataTable);
                dv.RowFilter = "[Final_Invst_Amount_From] <> 0 OR [Dividend_Bonus_From] IS Not NULL";

                stpFromGridview.DataSource = dv.ToTable();
                stpFromGridview.DataBind();

                // Shifted By Somabrata 16/05/2017
                if (stpfromDataTable.Columns.Contains("INVST_AMOUNT")) stpfromDataTable.Columns.Remove("INVST_AMOUNT");

                dv = new DataView(stptoDataTable);
                dv.RowFilter = "[Final_Invst_Amount_To] <> 0  OR [Dividend_Bonus_To] IS Not NULL";

                stpToGridview.DataSource = dv.ToTable();
                ...
                // BindDataTableToChartGeneralSTPTO(dtChartTO, "TO_DATE", chrtResultSTPTO);

                /////////////// 09-01-2013
                #region STACK Bar Chart
                DataTable tempstpChart = dtSTPFinal.Copy();

                //As these are already remove
                //if (tempstpChart.Rows.Count > 0)
                //{
                //    tempstpChart.Rows.RemoveAt(tempstpChart.Rows.Count - 1);
                //    tempstpChart.Rows.RemoveAt(tempstpChart.Rows.Count - 1);
                //}
                ...
                #region :Historical Performance
                datatTbleHistorical = CalculateHistPerf(stpAsonDate);
        ...
        private void PerformanceReturn()
        {
            ...
            using (var dspData = new SIP_ClientDataContext())
            {
                ...
                var strNature = (//from natr in dspData.T_SCHEMES_NATURE_Clients
                                from natr in dspData.T_SEBI_SCHEMES_NATUREs
                                    where natr.Sebi_Nature_ID == (
                                 ...
                                 select new { tfm.SEBI_NATURE_ID }).First().SEBI_NATURE_ID
                                select new
                                 {
                                     //natr.Nature
                                     natr.Sebi_Nature
            ...
            try
            {
                ...
                else if (Convert.ToString(datatbleReturn.Rows[0][daydiffCol]) == "N/A")
                {
                    daysDiffVal = Convert.ToDouble(datatbleReturn.Rows[0]["Since Inception"]);
                }
                ...
                if (CompundReturnDayValIndex != 0)
                {
					...
					dtLsTable.Rows.Add(ViewState["INDEX_NAME"].ToString(), txtinstallLs.Text.ToString(), CompundReturnDayValIndex, profitIndex, daysDiffValINdex);
				}
        ...
        private void ShowExcel()
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=Aditya_Birla_Sun_Life_Report.xls");
            Response.Charset = "";
            ...
            objFinalstr.Append("<table width='320px'  height='420px' style='text-align:justify'>");

            if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
            {
                if (Session["imgPath"] != null)
                {
                    imgPath = Convert.ToString(Session["imgPath"]);
                    imgPath = imgPath.Substring(imgPath.IndexOf("Img", 0));
                    //imgPath = "http://mfiframes.mutualfundsindia.com" + @"/BirlaSunlife/" + imgPath.Replace("\\", "/");
                    imgPath = "http://mfiframes.mutualfundsindia.com" + @"/BirlaSunlife/" + imgPath.Replace("\\", "/");


                    //objFinalstr.Append("<tr><td width='320px' height='420px'><img src='" + Session["imgPath"].ToString() + "'></td></tr>");
                    objFinalstr.Append("<tr><td width='320px' height='420px'><img src='" + imgPath + "'></td></tr>");
                }
            }
            // 

            objFinalstr.Append("<tr><td><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/></td></tr>");


            objFinalstr.Append(sw.ToString()).Append("<br/>");

            // Add Chart Image


            objFinalstr.Append("<tr  ><td width='100%'>");
            ...
            ImagePath = HttpContext.Current.Server.MapPath("~") + "BirlaSunlife\\img\\";
            ...
            objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;	font-family: Arial;	color: #000;	font-size: 11px;background:#ffcb09;	font-weight:normal;'");
        ...
        public void BindDataTableToChart(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt, string strCompareColumn)
        {
            ...
            try
            {
                ...
                foreach (DataColumn dc in _dt.Columns)
                {
                    ...
                    {
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#9e1b36");// Color.red;
                        chrt.Series[dc.ColumnName].LegendText = "Investment Amount";
                        chrt.Series[dc.ColumnName].BorderDashStyle = ChartDashStyle.Dash;
                        // chrt.Series[dc.ColumnName].ChartType = SeriesChartType.Line;

                    }
                    else if (dc.ColumnName.ToUpper().Contains("INDEX"))
                    {
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#A9A9A9");// Color.DarkGrey;
                        chrt.Series[dc.ColumnName].LegendText = "Index Investment Value";
                        chrt.Series[dc.ColumnName].BorderDashStyle = ChartDashStyle.Solid;
                    }
                    else
                    {
                        CompareToColumn = dc.ColumnName.ToUpper();
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#ffcb09");// System.Drawing.Color.yellow;//#569fd3
                ...
                if (ddlMode.SelectedItem.Value.ToUpper().StartsWith("SIP"))
                {
                    ...
                    chrt.Series["Index_Value_amount"].LegendText = "Index Value";
                ...
                string localImgPath = @"BirlaSunlife\Img";
                ...
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "BirlaSunlife\\IMG", "BirlaSunlife_SIP_Temp*");
                ...
                imgPath = System.IO.Path.Combine(localImgPath, "BirlaSunlife_SIP_Temp" + Guid.NewGuid().ToString("N") + "_" + tmpChartName);
                ...
                ////imgchrtResult.DescriptionUrl = imgPath;

                //string imgname = imgPath.Split('\\')[imgPath.Split('\\').Count() - 1];
                //imgname = "../IMG/" + imgname;
                //imgchrtResult.ImageUrl = imgname;
        ...
        public void BindDataTableToBarChart(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt, string strCompareColumn)
        {
            ...
            try
            {
                ...
                foreach (DataColumn dc in _dt.Columns)
                {
                    ...
                    {
                        CompareToColumn = dc.ColumnName.ToUpper();
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#569fd3");// System.Drawing.Color.Blue;//#569fd3
        ...
        public void BindDataTableToChartGeneral(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt)
        {
            ...
            try
            {
                ...
                #region Delete MyRegion
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "BirlaSunlife\\IMG", "Birla_SIP_Temp*");
                foreach (var f in allImageFiles)
                    if (File.GetCreationTime(f) < DateTime.Now.AddHours(-1))
                        File.Delete(f);
                ...
                imgPath = System.IO.Path.Combine(localImgPath, "Birla_SIP_Temp" + Guid.NewGuid().ToString("N") + "_" + tmpChartName);
        ...
        public void BindDataTableToChartGeneralSTPTO(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt)
        {
            ...
            try
            {
                ...
                #region Delete MyRegion
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "BirlaSunlife\\IMG", "STPTO_Temp*");
                foreach (var f in allImageFiles)
                    if (File.GetCreationTime(f) < DateTime.Now.AddHours(-1))
                        File.Delete(f);
        ...
        public void CreateHTMLDSPSIP()
        {
            ...
            var allFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "BirlaSunlife\\PDF", "Birla_*");
            foreach (var f in allFiles)
                if (File.GetCreationTime(f) < DateTime.Now.AddHours(-1))
                    File.Delete(f);
            ...
            try
            {
                ...
                switch (RadioButtonListCustomerType.SelectedItem.Text.ToUpper().Trim())
                {
                    case "DISTRIBUTOR":
                        if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspPDFtemplate3.html")));//dspPDFtemplate2 for din regular dspPDFtemplate3 normal
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspswpPDFtemplate_test.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspstpPDFtemplate_t.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspPDFTemplateInitial.html")));
                        }
                        else
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspLsPDFTemplate.html")));
                        }
                        break;
                    default:
                        if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspPDFtemplateWOD.html")));//
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspswpPDFtemplateWOD_test.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspstpPDFtemplateWOD_t.html")));
                        }
                        else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspPDFTemplateInitialWOD.html")));
                        }
                        else
                        {
                            strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/DSP/dspLsPDFTemplateWOD.html")));
                        }
                        break;
                }
                ...
                if (!string.IsNullOrEmpty(imagePath))
                {
                    ...
                    if (File.Exists(imagePath))
                    {
                        ...
                        strHTML = strHTML.Replace("<!chartImage!>", "<img alt=''   src='" + imgname + "' height='95%' width='95%' />"); //height='90%'
                    }
                ...
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                {
					...
					strHTML = strHTML.Replace("<!Benchmark!>", ViewState["INDEX_NAME"].ToString());
        ...
        protected void chkCapApp_CheckedChanged(object sender, EventArgs e)
        {
            if (chkCapApp.Checked)
            { txtTransferWithdrawal.Text = "0"; txtTransferWithdrawal.ReadOnly = true; }
            else
            {
                txtTransferWithdrawal.ReadOnly = false;
            }
        }
        ...
        protected void stpFromGridview_Init(object sender, EventArgs e)
        {

        }

        protected void PdfCalculation_Click(object sender, ImageClickEventArgs e)
        {
            CreateHTMLSIP();
        }

        // Export PDF 
        private void CreateHTMLSIP()
        {
            ...
            var allFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "BirlaSunlife\\PDF", "BirlaSunlife_*");
            foreach (var f in allFiles)
            ...
            try
            {
                ...
                if (ddlMode.SelectedItem.Value.ToUpper().StartsWith("SIP"))
                {
                    gvFirstTablestr = gvFirstTablestr.Replace(@"scope=""col""", "style ='text-align:center;font-family: pfhandbookproregular; color: #000;font-size: 15px;font-weight: normal; background: #fff4d9; height: 25px;'");
                    gvFirstTablestr = gvFirstTablestr.Replace(@"class=""grdRow""", "style = 'font-size:15px;	vertical-align:middle;	text-align:left;height: 25px;'");//font-family:Trebuchet MS;
                }
                else
                {
                ...
                gvFirstTablestr = gvFirstTablestr.Replace("img/rimg.png", "../img/rupee_black.png");
                gvFirstTablestr = gvFirstTablestr.Replace(@"border=""1""", "border='0'");
                ...
                GridViewSIPResultstr = "<div><table border='0' align='left' width='100%' cellpadding='0' cellspacing='0'>" + GridViewSIPResultstr.Substring(GridViewSIPResultstr.IndexOf("<th"));
                //added 30 oct 2012
                GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"scope=""col""", "style ='text-align: center;font-family: Arial;color: #ffffff;font-size: 15px;font-weight: normal;background: #2ee9b6;height: 25px;'");
                ...
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "LUMP SUM")
                    ...
                    strHTML = strHTML.Replace("<!InstallmentAmount!>", Convert.ToDouble(txtTransferWithdrawal.Text).ToString("n0"));
                else
                    strHTML = strHTML.Replace("<!InstallmentAmount!>", Convert.ToDouble(txtinstall.Text).ToString("n0"));
                ...
                path = HttpContext.Current.Server.MapPath("~/BirlaSunlife/PDF/" + "BirlaSunlife" + "_" + Convert.ToString(Session["GUID"]) + ".htm");
                ...
                File.WriteAllText(path, strHTML.ToString());
                strHTML = null;
                _SimpleConversion("BirlaSunlife");
                ...
                if (Session["GUID"] != null)
                {
                    ...
                    pdfName = Convert.ToString(Session["GUID"]) + ".pdf";
                    Response.ContentType = "Application/pdf";
                    Response.AppendHeader("Content-Disposition", "attachment; filename=BirlaSunlife.pdf");
                    Response.TransmitFile(Server.MapPath("~/BirlaSunlife/PDF/BirlaSunlife_" + pdfName));
                    Response.End();
                }
        ...
        public string GETHtmlFile()
        {
            ...
            if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
            {
                strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BirlaSunlife/HTML/BirlaSunlifeSIPPDFTemplateWOD.html")));//
            }
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
            {
                strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BirlaSunlife/HTML/BirlaSunlifeswpPDFTemplateWOD.html")));
            }
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
            {
                strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BirlaSunlife/HTML/BirlaSunlifestpPDFTemplateWOD.html")));
            }
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
            {
                strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BirlaSunlife/HTML/BirlaSunlifePDFTemplateInitialWOD.html")));
            }
            else
            {
                strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BirlaSunlife/HTML/BirlaSunlifeLsPDFTemplateWOD.html")));
            }
