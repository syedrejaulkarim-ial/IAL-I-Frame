                        ...
                        <div class="card-body">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-6 col-sm-6 col-md-1 col-lg-1 pt-22 text-right">
                                ...
                                <div id="DivGridContain" runat="server">
                                    <div class="" style="margin-top: 20px;">
                                        <asp:DataGrid class="table table-striped table-bordered"
                                            Style="margin-top: 15px; font-size: 12px;" ID="dglist"
                                            runat="server" AutoGenerateColumns="false"
                                            HeaderStyle-Font-Bold="true" Width="100%" BorderColor="#d9d6d6"
                                            BorderWidth="1"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Latest NAV" HeaderStyle-CssClass="top_tableheader">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateColumn HeaderText="Delete" HeaderStyle-CssClass="top_tableheader">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgbtnDel" runat="server" ImageUrl="~/BansalCapital/images/close.png"
                                        ...
                                        <div id="DivPlotChart" runat="server" class="row-fluid"
                                            ...
                                            <input type="button" value="Plot Chart" class="btn btn-danger btn-xs pull-right"
