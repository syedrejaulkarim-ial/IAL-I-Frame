...
namespace iFrames.BlueChip
{
    public partial class Return_Calc : System.Web.UI.Page
    {
        ...
        public void Reset()
        {
            ...
            Response.Redirect("/BlueChip/Return Calc.aspx");
        }
        ...
        public void BindDataTableToChart(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt, string strCompareColumn)
        {
            ...
            try
            {
                ...
                string localImgPath = @"BlueChip\Img";
                ...
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "BlueChip\\IMG", "Bluechip_SIP_Temp*");
                ...
                imgPath = System.IO.Path.Combine(localImgPath, "Bluechip_SIP_Temp" + Guid.NewGuid().ToString("N") + "_" + tmpChartName);
        ...
        public string GETHtmlFile()
        {
            ...
            switch (RadioButtonListCustomerType.SelectedItem.Text.ToUpper().Trim())
            {
                case "DISTRIBUTOR":
                    if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipSIPPDFTemplate.html")));// for din regular SundaramPDFtemplate3 normal
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipswpPDFTemplate.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipstpPDFTemplate.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipPDFTemplateInitial.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipLsPDFTemplate.html")));
                    }
                    break;
                default:
                    if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipSIPPDFTemplateWOD.html")));//
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipswpPDFTemplateWOD.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipstpPDFTemplateWOD.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipPDFTemplateInitialWOD.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/BlueChip/Html/BlueChipLsPDFTemplateWOD.html")));
                    }
                    break;
            }
        ...
        public void CreateHTMLSIP()
        {
            ...
            var allFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "BlueChip\\PDF", "BlueChip_*");
            foreach (var f in allFiles)
            ...
            try
            {
                ...
                path = HttpContext.Current.Server.MapPath("~/Bluechip/PDF/" + "BlueChip" + "_" + Convert.ToString(Session["GUID"]) + ".htm");
                ...
                if (Session["GUID"] != null)
                {
                    ...
                    Response.AppendHeader("Content-Disposition", "attachment; filename=BlueChip.pdf");
                    Response.TransmitFile(Server.MapPath("~/BlueChip/PDF/BlueChip_" + pdfName));
                    Response.End();
                }
