<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryWiseMutualFund.aspx.cs" Inherits="iFrames.BlueChip.CategoryWiseMutualFund" %>
    ...
    <script type="text/javascript">
        ...
        function FNSetData(data) {
            ...
            for (v = 0; v < data.length; v++) {
                ...
                strTr = strTr + "<td title='" + (schName) + "'><a href='http://www.bluechipindia.co.in/Bluechipwebnew/MutualFund/frmFactSheet.aspx?param=" + data[v].SchemeId + "' target='_blank'>" + (schName.length > 56 ? schName.substring(0, 56)+"..." : schName) + "</a></td>";
