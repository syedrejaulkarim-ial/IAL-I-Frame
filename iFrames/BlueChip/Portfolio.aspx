<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Portfolio.aspx.cs" Inherits="iFrames.BlueChip.Portfolio" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card mt-3" runat="server" visible="false" id="dvPortFolio">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header" style="background: #fff">
                                        <h5>Top Holding <small>(<asp:Label runat="server" ID="lblPortDate"></asp:Label>)</small></h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="">
                        ...
                        <asp:Button ID="btnShowMoreButton" runat="server" CssClass="btn btn-light btn-sm" BackColor="#db3539" ForeColor="White" BorderStyle="Inset"
                            Text="Detailed Portfolio" Visible="false" OnClientClick="return ShowMoreButton(); return false;" />
                        <%--OnClick="ShowMoreButton_Click" --%>
                        <div class="row pt-3">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="card">
                                    <div class="card-header" style="background: #fff">
                                        <h5>Top Sector Holding</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
