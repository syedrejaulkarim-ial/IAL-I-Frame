<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="TopFund.aspx.cs" Inherits="iFrames.Bluechip.TopFund" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                        ...
                                        <asp:RadioButtonList ID="rdbOption" runat="server"
                                            class="radio" RepeatDirection="Horizontal" Style="padding-top: 15px; text-align: center; font-size: 14px; font-weight: normal" Width="100%">
                                        </asp:RadioButtonList>
                                    </div>
                                            ...
                                            <ItemTemplate>
                                                <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "value_tablerow" : "value_tablerow" %>'>
                                                    ...
                                                    <td style="width: 35%;">
                                                        ...
                                                        <a href="http://www.bluechipindia.co.in/Bluechipwebnew/MutualFund/frmFactSheet.aspx?param=<%#Eval("SchemeId")%>" target="_blank"><%#Eval("Sch_Name")%></a>
