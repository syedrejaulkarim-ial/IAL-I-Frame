<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Return Calc.aspx.cs" Inherits="iFrames.BlueChip.Return_Calc" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right pt-3">
                                    <div class="row">
                                        ...
                                        <asp:Button ID="sipbtnshow" runat="server" Text="Calculate" CssClass="btn btn-danger" OnClick="sipbtnshow_Click" />
                                        ...
                                        <asp:Button ID="sipbtnreset" runat="server" OnClick="sipbtnreset_Click" CssClass="btn btn-light" Text="Reset"></asp:Button>
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            <div class="col-md-12 pt-4">
                                                                                                                ...
                                                                                                                <asp:LinkButton ID="LinkButtonGenerateReport" runat="server"
                                                                                                                    ...
                                                                                                                    CssClass="btn btn-danger btn-sm ">Generate PDF</asp:LinkButton>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <%--<table width="100%">
                                                                                                    <tr>
