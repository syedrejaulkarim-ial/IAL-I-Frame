<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="CompareFund.aspx.cs" Inherits="iFrames.BajajCapital.CompareFund" %>
            ...
            <div class="container-fluid" style="padding: 0;">
                                    ...
                                    <div class="block-content collapse in">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:ImageButton ID="btnAddScheme" runat="server" AlternateText="Add" OnClick="btnAddScheme_Click" class="btn btn-danger btn-mini"
                                                OnClientClick="Javascript:return ValidateControl();" ValidationGroup="scheme" ImageUrl="images/images/add.png" Style="margin-top: 0px; float: right;" />
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:ImageButton ID="btnAddIndices" runat="server" AlternateText="Add" ImageUrl="images/images/add.png" OnClick="btnAddIndices_Click" class="btn btn-danger btn-mini"
                                                OnClientClick="Javascript:return Listcount();" ValidationGroup="indices" Style="margin-top: 0px; float: right" />
                ...
                <div id="DivShowPerformance" class="row-fluid" style="margin-top: 0px; margin-right: 25px;" runat="server">
                    ...
                    <div class="span12">
                        ...
                        *Note:- Returns calculated for less than 1 year are Absolute returns and returns
                        ...
                        <div style="margin-top: 70px; margin-right: 0px;">
                            ...
                            <div style="width: 97.5%; float: left;" id="chartContainer">
                                <div class="">
                                    <div style="width: 98%; height: 100%;" id="divChart"></div>
                                </div>
                            </div>
                ...
                <footer style="font-size: 12px; margin-top: 10px; text-align: center">
                    <div class="value_input" style="text-align: right; font-size: 10px; color: #A7A7A7">
                                Developed for Bajaj Capital by: <a href="https://icraanalytics.com" target="_blank" style="font-size: 10px; color: #999999">ICRA Analytics Ltd,</a>
