<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="WatchList.aspx.cs" Inherits="iFrames.BajajCapital.WatchList" %>
...
<html class="no-js">
    ...
    <head>
        ...
        <%--  <script type='text/javascript' src="../DSP/js/jquery.js"></script>
...
//            });
    ...
    <body>
        <div style="width:650px; padding:0; padding:0;">
        ...
        <script src="bootstrap/js/modernizr2.js" type="text/javascript"></script>
