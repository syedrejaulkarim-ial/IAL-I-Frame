...
namespace iFrames.BajajCapital
{
    public partial class TopFund : System.Web.UI.Page
    {
        ...
        private void DataBind()
        {
            ...
            dtResult = AllMethods.getTopFundRank(Convert.ToInt32(ddlRank.SelectedItem.Value), Convert.ToInt32(ddlType.SelectedItem.Value), Convert.ToInt32(ddlCategory.SelectedItem.Value), ddlPeriod.SelectedItem.Value);
