<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="NAV.aspx.cs" Inherits="iFrames.BajajCapital.NAV" %>
...
<head>
    ...
    <%--<script src="../Scripts/HighStockChart/highstock.js"></script>
    <script src="../Scripts/HighStockChart/exporting.js"></script>--%>
...
<body>
    ...
    <form id="Form1" runat="server">
        <div style="width: 650px; margin: 0 auto">
            <div class="navbar" align="center" style="width: 650px; margin-left: 7px; margin-top: -55px; display: none">
            ...
            <div class="">
                <div class="row-fluid">
                    <div class="span12" id="content">
                        <div class="row-fluid" style="margin-top: 10px;">
                                ...
                                <div class="block-content collapse in">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:ImageButton ID="btnAddScheme" runat="server" CssClass="btn btn-danger btn-mini" Text="Add" OnClick="btnAddScheme_Click"
                                            OnClientClick="Javascript:return ValidateControl();" ValidationGroup="scheme" ImageUrl="images/images/add.png" Style="margin-top: -10px;"></asp:ImageButton>
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:ImageButton ID="btnAddIndices" runat="server" CssClass="btn btn-danger btn-mini" Text="Add"
                                            OnClick="btnAddIndices_Click" ImageUrl="images/images/add.png" ValidationGroup="indices" Style="margin-top: -10px;"
                            ...
                            <button class="btn-sub btn-large" style="margin-right: 15px;">Reset</button>
                            <!-- /block -->
                        </div>

                    </div>
                </div>
                <div id="DivGridContain" class="row-fluid" runat="server">
                    <!-- block -->
                    <asp:HiddenField ID="hidSchindSelected" runat="server" />
                    <div class="block" style="margin-top: 20px; border: 1px solid #ccc;">
                        <div class="block-content collapse in">
                ...
                <div id="DivPlotChart" runat="server" class="row-fluid">
                    <!-- block -->
                    <div class="block" style="margin-top: 20px; display: none">
                ...
                <div id="DivLast" runat="server" class="row-fluid" style="display: none">
                ...
                <p>&nbsp;</p>
                <small class="value_input" style="width: 100%; float: right; text-align: right; font-size: 10px; color: #A7A7A7">Developed for Bajaj Capital by: <a href="https://www.icraanalytics.com" target="_blank" style="font-size: 10px; color: #999999">ICRA Analytics Ltd,</a>
