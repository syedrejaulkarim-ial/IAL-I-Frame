...
{
    public abstract class STPBasePage : System.Web.UI.Page
    {
    ...
    public partial class STPCalc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (ddlMode.SelectedItem.Value.ToUpper() == "LUMP SUM" || ddlMode.SelectedItem.Value.ToUpper() == "SWP" || ddlMode.SelectedItem.Value.ToUpper() == "VALUE STP")
            //    LSDisc.Visible = true;
            //else
            //
        ...
        public void CalculateReturnSTP()
        {
            ...
            try
            {
                ...
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP")
                    dblStpTransferAmnt = Convert.ToDouble(txtFlexInstallmentAmt.Text);
                else
                ...
                # region calling SP
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP")
                    cmdstp = new SqlCommand("MFIE_SP_STP_CALCULATER_EDL_Flex", conn);
                else
                    cmdstp = new SqlCommand("MFIE_SP_STP_CALCULATER_EDL", conn);
        ...
        public void CallChartFromView2()
        {
            ...
            if ((ddlMode.SelectedItem.Text.ToUpper() == "VALUE STP")|| (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP"))
            {
        ...
        private void PerformanceReturn()
        {
            ...
            try
            {
                ...
                {
                    if (strSchemeNature.ToUpper() == "EQUITY" && indexId == "12")
                        cmdIndx.Parameters.Add(new SqlParameter("@IndexIDs", indexId + ",13"));
                    else if (strSchemeNature.ToUpper() == "EQUITY" && indexId != "12")
                        cmdIndx.Parameters.Add(new SqlParameter("@IndexIDs", indexId + ",12"));
                    else
                        cmdIndx.Parameters.Add(new SqlParameter("@IndexIDs", indexId));
                }
                else
                ...
                if (IsEquityPlusSchemes == false)
                {
                    //Changed by Arindam Jash on 01/28/2014
                    if (strSchemeNature.ToUpper() == "EQUITY" && indexId == "12")
                        cmdIndex.Parameters.Add(new SqlParameter("@IndexIDs", indexId + ",13"));
                    else if (strSchemeNature.ToUpper() == "EQUITY" && indexId != "12")
                        cmdIndex.Parameters.Add(new SqlParameter("@IndexIDs", indexId + ",12"));
                    else
                        cmdIndex.Parameters.Add(new SqlParameter("@IndexIDs", indexId));
                }
                else
                    cmdIndex.Parameters.Add(new SqlParameter("@IndexIDs", "90,12"));
                //end by syed
                ...
                if (Convert.ToString(dttblIndxReturn.Rows[0][daydiffCol]) != "N/A")
                    ...
                    if (!IsEquityPlusSchemes)
                    {
                        ...
                        for (int rownum = 0; rownum < dttblIndxReturn.Rows.Count; rownum++)
                        {
                            if (strSchemeNature.ToUpper() == "EQUITY" && indexId == "12")
                            {
                                if (dttblIndxReturn.Rows[rownum]["Index_Name"].ToString().Trim().ToUpper() == "S&P BSE SENSEX")
                                {
                                    dttblIndxReturn.Rows[rownum]["Index_Name"] = "S&P BSE Sensex (Additional Benchmark)";
                                    Key = rownum;
                                }
                                else
                                {
                            ...
                            {
                                if (dttblIndxReturn.Rows[rownum]["Index_Name"].ToString().Trim().ToUpper() == "NIFTY 50")
                                {
                                    dttblIndxReturn.Rows[rownum]["Index_Name"] = "Nifty 50 (Additional Benchmark)";
                                    Key = rownum;
                                }
                                else
                                {
                ...
                if (!IsEquityPlusSchemes)
                {
                    ...
                    for (int rownum = 0; rownum < dtIndex.Rows.Count; rownum++)
                    {
                        if (strSchemeNature.ToUpper() == "EQUITY" && indexId == "12")
                        {
                            if (dtIndex.Rows[rownum][0].ToString().Trim().ToUpper() == "S&P BSE SENSEX")
                            {
                                dtIndex.Rows[rownum][0] = "S&P BSE Sensex (Additional Benchmark)";
                                Key = rownum;
                            }
                            else
                            {
                        ...
                        {
                            if (dtIndex.Rows[rownum][0].ToString().Trim().ToUpper() == "NIFTY 50")
                            {
                                dtIndex.Rows[rownum][0] = "Nifty 50 (Additional Benchmark)";
                                Key = rownum;
                            }
                            else
                            {
                ...
                if (CompundReturnDayValIndex_Additional != 0)
                {
                    ...
                    //  dtLsTable.Rows.Add(ddlsipbnmark.SelectedItem.Text, txtinstallLs.Text.ToString(), CompundReturnDayValIndex, profitIndex, daysDiffValINdex);
                    if (indexId == "12")
                        dtLsTable.Rows.Add("S&P BSE Sensex (Additional Benchmark)", txtinstallLs.Text.ToString(), CompundReturnDayValIndex_Additional, profitIndex_Additional, daysDiffValINdex_Additional, "--");
                    else
                        dtLsTable.Rows.Add("Nifty 50 (Additional Benchmark)", txtinstallLs.Text.ToString(), CompundReturnDayValIndex_Additional, profitIndex_Additional, daysDiffValINdex_Additional, "--");
                }
        ...
        private void ShowResult()
        {
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP")
            {
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP")
            {
                if (Convert.ToDouble(txtiniAmount.Text) < 12000)
                {
                    HdMessage.Value = "Minimum initial investment: 12000";
                    return;
                }

                var stpStartDate = new DateTime(Convert.ToInt16(txtfromDate.Text.Split('/')[2]),
                                      Convert.ToInt16(txtfromDate.Text.Split('/')[1]),
                                      Convert.ToInt16(txtfromDate.Text.Split('/')[0]));

                var stpEndDate = new DateTime(Convert.ToInt16(txtToDate.Text.Split('/')[2]),
                                           Convert.ToInt16(txtToDate.Text.Split('/')[1]),
                                           Convert.ToInt16(txtToDate.Text.Split('/')[0]));

                if (ddPeriod_SIP.SelectedItem.Text.ToUpper() == "QUARTERLY")
                {
                    if (stpEndDate < stpStartDate.AddMonths(12))
                    {
                        HdMessage.Value = "Minimum number of installments is 4";
                        return;
                    }
                    if (Convert.ToInt16(txtFlexInstallmentAmt.Text) < 2000)
                    {
                        HdMessage.Value = "Minimum quaterly investment amount: 2000";
                        return;
                    }
                }
                if (ddPeriod_SIP.SelectedItem.Text.ToUpper() == "MONTHLY")
                {
                    if (stpEndDate < stpStartDate.AddMonths(6))
                    {
                        HdMessage.Value = "Minimum number of installments is 6";
                        return;
                    }
                    if (Convert.ToInt16(txtFlexInstallmentAmt.Text) < 1000)
                    {
                        HdMessage.Value = "Minimum monthly investment amount: 1000";
                        return;
                    }
                }
                if (ddPeriod_SIP.SelectedItem.Text.ToUpper() == "DAILY")
                {
                    using (var principl = new PrincipalCalcDataContext())
                    {
                        var allotdate = (from ind in principl.T_NAV_DIVs
                                         where (ind.Scheme_Id == Convert.ToDecimal(ddlschtrto.SelectedItem.Value)
                                         && ind.Nav_Date >= stpStartDate)
                                         orderby ind.Nav_Date
                                         select new
                                         {
                                             CutoffDate = Convert.ToDateTime(ind.Nav_Date)
                                         });
                        if (allotdate.Count() >= 6)
                        {
                            var date = allotdate.Take(6).ToArray().LastOrDefault().CutoffDate;
                            if (stpEndDate < date)
                            {
                                HdMessage.Value = "Minimum number of installments is 6";
                                return;
                        ...
                        //if (stpEndDate < stpStartDate.AddDays(6))
                        //{
                        //    HdMessage.Value = "Minimum number of installments is 6";
                        //    return;
                        //}
                    ...
                    if (Convert.ToInt16(txtFlexInstallmentAmt.Text) < 300)
                    {
                        HdMessage.Value = "Minimum daily investment amount: 300";
                        return;
                    }
                }
                if (ddPeriod_SIP.SelectedItem.Text.ToUpper() == "WEEKLY")
                {
                    if (stpEndDate < stpStartDate.AddDays(42))
                    {
                        HdMessage.Value = "Minimum number of installments is 6";
                        return;
                    }
                    if (Convert.ToInt16(txtFlexInstallmentAmt.Text) < 300)
                    {
                        HdMessage.Value = "Minimum weekly investment amount: 300";
                        return;
                    }
                }

                if (!String.IsNullOrEmpty(txtFlexInstallmentAmt.Text) && !String.IsNullOrEmpty(txtiniAmount.Text))
                {
                    //if (Convert.ToDouble(txtFlexInstallmentAmt.Text) >= 500 && Convert.ToDouble(txtiniAmount.Text) >= 3000)
                    //{
                        //SetDefaultView();
                        if (!divTab.Visible) divTab.Visible = true;
                        if (!gvSWPSummaryTable.Visible) gvSWPSummaryTable.Visible = true;
        ...
        protected void ShowRelativeDiv()
        {
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP")
            {
                ...
                SIP_withdrawl.Visible = false;
                SWP_STP_withdrawl.Visible = true;
                trFlexInstallmentAmt.Visible = false;
                txtinstall.Visible = false;
                ...
                lblTransferWithdrawal2.Visible = true; txtTransferWithdrawal2.Visible = true;
                lblTransferWithdrawal2.Text = "Target Value";
            ...
            else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP")
            {
                ...
                SIP_withdrawl.Visible = false;
                SWP_STP_withdrawl.Visible = false;
                trFlexInstallmentAmt.Visible = true;
            ...
            if (!((ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP") || (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP")))
            {
            ...
            //if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP")
        ...
        private void ShowExcel(string FundName)
        {
            ...
            //objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;	font-family: Verdana;	color: #ffffff;	font-size: 11px;	font-weight:normal;	line-height: 20px;	background:#183885;	height:25px; width:15px '");
            objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;	font-family: Verdana;	color: #ffffff;	font-size: 11px;background:#183885;	font-weight:normal;'");
            //objFinalstr.Replace(@"class=""grdRow""", "style=' border: #d0d6db solid 1px;    text-align: center; background-color: #ffffff;    font-family: Verdana;    color: #000;    font-size: 11px;    font-weight: normal;'");
            //objFinalstr.Replace(@"class=""grdAltRow""", "style='background-color: #f4f4f4;    font-family: Verdana;    color: #000;    font-size: 11px; font-weight: normal;    border: #d0d6db solid 1px;     text-align: center;'");
            ...
            try
            {
                ...
                foreach (DataColumn dc in _dt.Columns)
                {
                    ...
                    else if (dc.ColumnName.ToUpper() == "INDEX_VALUE_AMOUNT")
                    {
                        ...
                        chrt.Series[dc.ColumnName].Color = System.Drawing.Color.Green;//#183885 //System.Drawing.ColorTranslator.FromHtml("#02278b");//
                    ...
                    {
                        CompareToColumn = dc.ColumnName.ToUpper();
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#183885");// System.Drawing.Color.Blue;//#183885
                ...
                else if ((ddlMode.SelectedItem.Value.ToUpper() == "VALUE STP")|| (ddlMode.SelectedItem.Value.ToUpper() == "FLEX STP"))
                {
                ...
                //chrt.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Verdana",15f);//, FontStyle.Bold);
                ...
                // chrt.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Verdana", 11);
                chrt.ChartAreas[0].AxisX.Title = "Time Period";
                chrt.ChartAreas[0].AxisX.TitleFont = new Font("Verdana", 12, FontStyle.Bold);
                chrt.ChartAreas[0].AxisY.TitleFont = new Font("Verdana", 12, FontStyle.Bold);
                ...
                legend.Font = new Font("Verdana", 12, FontStyle.Bold);
                legend.ForeColor = System.Drawing.ColorTranslator.FromHtml("#4F4E50");
                chrt.ChartAreas[0].AxisX.LabelStyle.Font = new Font("Verdana", 12, FontStyle.Bold);
                chrt.ChartAreas[0].AxisY.LabelStyle.Font = new Font("Verdana", 12, FontStyle.Bold);
                ...
                if (((ddlMode.SelectedItem.Text.ToUpper() == "VALUE STP")|| (ddlMode.SelectedItem.Text.ToUpper() == "FLEX STP")) && chrt == chrtResultSTPTO)
                {
        ...
        //        if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP")
        //        {
        ...
        //        legend.Font = new Font("Verdana", 9, FontStyle.Bold);
        ...
        public string GETHtmlFile()
        {
            ...
            switch (RadioButtonListCustomerType.SelectedItem.Text.ToUpper().Trim())
            {
                case "DISTRIBUTOR":
                    ...
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissswpPDFTemplate.html")));
                    }
                    else if ((ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP")|| (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP"))
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissstpPDFTemplate.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissPDFTemplateInitial.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissLsPDFTemplate.html")));
                    }
                    break;
                default:
                    if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                    ...
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissswpPDFTemplateWOD.html")));
                    }
                    else if ((ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP")|| (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP"))
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissstpPDFTemplateWOD.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissPDFTemplateInitialWOD.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/Edelweiss/SipCalc/Html/EdelweissLsPDFTemplateWOD.html")));
                    }
                    break;
            }
        ...
        public void CreateHTMLSIP()
        {
            ...
            try
            {
                ...
                else if ((ddlMode.SelectedItem.Value.ToUpper() == "VALUE STP")|| (ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP"))
                {
                    gvFirstTablestr = FillHtmlGridViewTable(gvSWPSummaryTable);
                }
                else
                ...
                if (ddlMode.SelectedItem.Value.ToUpper().StartsWith("SIP"))
                {
                    gvFirstTablestr = gvFirstTablestr.Replace(@"scope=""col""", "style ='text-align:center;font-family: Verdana;color: #ffffff;font-size: 15px;font-weight: normal;background: #183885;height: 25px;'");
                ...
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP"|| ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "LUMP SUM")
                {
                ...
                //added 30 oct 2012
                GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"scope=""col""", "style ='text-align: center;font-family: Verdana;color: #ffffff;font-size: 15px;font-weight: normal;background: #183885;height: 25px;'");
                ...
                strHTML = strHTML.Replace(@"class=""grdheader""", "style ='font-family:Verdana Narrow; font-size:14px;vertical-align:middle;text-align:center;border-bottom:#c6c8ca solid 1px;height: 25px;font-weight: bold;'");

                strHTML = strHTML.Replace(@"class=""grdRow""", "style = 'font-family:Verdana Narrow;	font-size:14px;	vertical-align:middle;	text-align:center;	border-bottom:#c6c8ca solid 1px;height: 25px;'");
                ...
                if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP" || ddlMode.SelectedItem.Value.Trim().ToUpper() == "VALUE STP"|| ddlMode.SelectedItem.Value.Trim().ToUpper() == "FLEX STP")
                {
                    if (txtiniAmount.Text.Length > 0)
                        strHTML = strHTML.Replace("<!InitialAmount!>", Convert.ToDouble(txtiniAmount.Text).ToString("n0"));
                    if (txtIniToDate.Text.Length > 0)
