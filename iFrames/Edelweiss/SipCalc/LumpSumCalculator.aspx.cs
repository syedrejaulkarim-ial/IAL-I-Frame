...
namespace iFrames.Edelweiss
{
    ...
    public partial class LumpSumCalculator : System.Web.UI.Page
    {
            ...
            try
            {
                using (var scheme = new PrincipalCalcDataContext())
                {
                    ...
                    if (ddlNature.SelectedIndex != 0)
                    {
                        ...
                        var NatureId = Convert.ToDecimal(ddlNature.SelectedValue);
                    ...
                    var scheme_name_1 = SqlScheme.Select(c => new
                    {
                        ...
                        c.Launch_Date,
                        c.Option_ID
                    }).OrderBy(x => x.Sch_Short_Name).Distinct().ToArray();
