...
function validate_SIP() {
    ...
    if (document.getElementById("ddlMode").value == 'Lump Sum') {
       ...
       // document.getElementById('<%=txtinstall.ClientID%>').value;
        //alert('Lump Sum');
        sipamunt = $("#txtinstallLs").val(); 
        if (sipamunt == "") {
...
function validate_SWP() {
    ...
    //        return false;
    //    }
	if (document.getElementById("ddlMode").value != 'SWP') {//Add by koustav 5-apr-2018
		if (parseFloat(document.getElementById("txtTransferWithdrawal2").value) < 500) {
