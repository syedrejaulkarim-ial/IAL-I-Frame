<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SwpCalculator.aspx.cs" Inherits="iFrames.Edelweiss.SwpCalculator" %>
                ...
                <div id="content-container">
                    <div id="page-content">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="trCategory" runat="server" visible="true">
                                <div class="form-group">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <asp:Label ID="lblSchemeName" runat="server" Text="Transfer From" CssClass="lebell">Transfer From</asp:Label>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding: 0">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group has-feedback" id="trInitialInvst" runat="server">
                        ...
                        <%--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                        <div class="col-xs-12 col-md-5 col-lg-5 col-sm-5">
                                            <div class="form-group has-feedback">
                                                <div id="Div4" runat="server" visible="false">
                                                    <div class="row">
                                                        <label class="col-xs-12 col-md-3 col-lg-3 col-sm-3">Initial Date</label>
                                        ...
                                        <div class="col-xs-12 col-md-7 col-lg-7 col-sm-7"></div>
                                    </div>
                                    </div>--%>

                        <div id="trSipInvst" runat="server">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0" runat="server" id="SIP_withdrawl" visible="false">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="form-group">
                                            <asp:Label ID="lblInstallmentAmt" runat="server" Text=" how much do you want to invest? (₹)" CssClass="lebell"></asp:Label>
                                            <div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="divTransferWithdrawal" runat="server">
                                    <div class="row">
                                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding: 0">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-6 col-sm-12">
                                        <div class="form-group has-feedback lebell">
                                            <asp:Label ID="lblDiffDate" runat="server" Text="SWP Date" Style="text-align: left;" CssClass=""></asp:Label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding: 0;">
                                    <div class="form-group has-feedback" id="SWP_STP_withdrawl" runat="server">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                        <div class="form-group has-feedback">
                                            <label>
                                                <asp:Label ID="lblTransferWithdrawal2" runat="server" Text=" Withdrawal Amount (₹)"></asp:Label></label>
                                        </div>
                                        <div id="Swp_Persentage_payout" runat="server">
                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-6 col-sm-12" style=" margin-top: 16px;">
                                        <label style="display:none"> Withdrawal Amount (₹)</label>
                                        ...
                                        <div style="font-size: 12px; margin-top: 2px;" id="Swp_Persentage_payout_message" runat="server">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0; margin-bottom: 12px;">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding: 0">
                                    <div class="col-xs-12 col-md-6 col-lg-6 col-sm-12">
                                        <div class="form-group has-feedback">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group has-feedback" runat="server" id="Div1">
                                        <label>Value of Investment as on</label>
                                        <div class="input-group" style="display: block;">
                                            <asp:TextBox ID="txtvalason" runat="server" class="form-control" placeholder="Select Date" />
                                        </div>
                                        <span style="font-size: 11px;">('Value of Investment as on' should be greater than 'To Date')</span>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0" id="tr_SIP_Sinc" runat="server" visible="false">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                    <div class="col-xs-12 col-md-5 col-lg-5 col-sm-5 form-group" style="padding: 0">
                                        <div id="Div6" runat="server">
                                            <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                                                <label class="container1">
                                                    <input type="checkbox" id="chkInception4sip" runat="server" onclick="setIncDate();" />
                                                    <span class="checkmark"></span>
                                                    <span style="margin-left: 10px;">Calculate return from inception </span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left: 0" id="tr_Cal_Type" runat="server" visible="false">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-xs-12 col-md-5 col-lg-5 col-sm-5">
                                        <div class="row">
                                            <div class="form-group has-feedback">
                                                <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                                                    <div class="form-group has-feedback row" style="margin-bottom: 0px">
                                                        ...
                                                        <div class="col-xs-12 col-md-8 col-lg-8 col-sm-12"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="trLumpInvst" runat="server" visible="false">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0; padding-bottom: 10px;">
                                    <div class="col-xs-12 col-md-5 col-lg-5 col-sm-5">
                                        <div class="row">
                                            <div class="form-group has-feedback">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0;" id="tr_Cal_Incp" runat="server">
                                <div style="">
                                    <label class="container1">
                                        <asp:Label ID="Label3" runat="server" Text=""></asp:Label>
                                        <input type="checkbox" id="chkInception" runat="server" onclick="setIncDate();" />
                                        <span class="checkmark"></span>
                                        <span style="margin-left: 20px;">Calculate from Inception</span>
                                    </label>
                                    <div class="form-group">
                                        <div class="row">
                                            <%-- <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="row" style="padding-left:15px">
                           <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="padding-top: 0px;">
                                <input ID="sipbtnreset" type="button" class="btn btn-default" value="Reset"/>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                            <div class="row" id="resultDiv" runat="server" visible="false" style="background: #f7f9fc; padding: 12px;">
