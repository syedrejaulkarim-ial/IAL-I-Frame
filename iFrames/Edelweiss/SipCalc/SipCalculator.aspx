<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SipCalculator.aspx.cs" Inherits="iFrames.Edelweiss.SipCalculator" %>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div id="trSipInvst" runat="server" >
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0" runat="server" id="SIP_withdrawl">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    <asp:Label ID="lblInstallmentAmt" runat="server" Text="Installment Amount (₹)" CssClass="lebell"></asp:Label>
                                                    <div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0" visible="false">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="col-xs-12 col-md-6 col-lg-6 col-sm-12" id="tr_SIP_Sinc" runat="server">
