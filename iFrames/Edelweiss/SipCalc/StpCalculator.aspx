<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StpCalculator.aspx.cs" Inherits="iFrames.Edelweiss.StpCalculator" %>
                    ...
                    <div id="page-content">
                            <%--<div class="panel-heading">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="trCategory" runat="server" visible="false">
                                            <div class="form-group">
                                                 <label>Category</label>
                                                 <asp:DropDownList ID="ddlNature" runat="server" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="ddlNature_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <asp:Label ID="lblSchemeName" runat="server" Text=" Scheme Name" CssClass="lebell">Transfer From</asp:Label>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="trTransferTo" runat="server">
                                            <div class="form-group">
                                                <label>Transfer To (₹)</label>
                                                <asp:DropDownList ID="ddlschtrto" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlschtrto_SelectedIndexChanged" class="form-control"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group has-feedback">
                                        ...
                                        <%--<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" visible="false">
                                            <div class="form-group has-feedback">
                                   ...
                                   <%-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0" id="trInception" runat="server" visible="false">
                                    ...
                                    <div id="trInitialInvst" runat="server" visible="true">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                            ...
                                            <div class="form-group has-feedback lebell">
                                                <asp:Label ID="lblDiffDate" runat="server" Text="STP Date" Style="text-align: left;" CssClass=""></asp:Label>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                            <div class="col-xs-12 col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group has-feedback lebell">
                                    <label>
                                        <asp:Label ID="Label4" runat="server" Text="Transfer Amount (₹)"></asp:Label>
                                    </label>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"></div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0" id="tr_SIP_Sinc" runat="server">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                                            ...
                                                            <div class="form-group has-feedback row" style="margin-bottom: 0px">
                                                                ...
                                                                <div class="col-xs-12 col-md-2 col-lg-2 col-sm-3">
                                                                    <asp:RadioButton ID="rdbReinvest" Checked="true" runat="server"
                                                                        GroupName="rdbCalc" />&nbsp;Reinvest</div>
                                                                    <div class="col-xs-12 col-md-2 col-lg-2 col-sm-3"><asp:RadioButton ID="rdbPayout" runat="server" GroupName="rdbCalc" />&nbsp;Payout</div>
