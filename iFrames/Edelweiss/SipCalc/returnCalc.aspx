<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="returnCalc.aspx.cs" Inherits="iFrames.Edelweiss.returnCalc" %>
                    ...
                    <div id="page-content">
                            <%--<div class="panel-heading">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0" id="trCategory" runat="server" visible="true">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <div class="row">
                                                    <label>
                                                ...
                                                <div class="col-xs-12 col-md-5 col-lg-5 col-sm-5">
                                                    <div class="row">
                                                        <div class="form-group has-feedback lebell">
                                                            <asp:Label ID="lblDiffDate" runat="server" Text=" date of SIP debit" Style="text-align: left;" CssClass=""></asp:Label>
                                                            <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="padding-top:50px;">
                                        <asp:Button ID="sipbtnshow" runat="server" class="btn btn-info"
                                            Text="Calculate" OnClick="sipbtnshow_Click"></asp:Button>
