<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="NAVGraphMrg.aspx.cs" Inherits="iFrames.LNT.NAVGraphMrg" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function btnPlotclick() {
            ...
            $.ajax({
                type: "POST",
                url: "NAVGraphMrg.aspx/getChartData",
                async: false,
        ...
        .tabbable-line > .nav-tabs {
            ...
            .tabbable-line > .nav-tabs > li {
                ...
                .tabbable-line > .nav-tabs > li.open, .tabbable-line > .nav-tabs > li:hover {
                    border-bottom: 4px solid #ffcb0594;
                }
        ...
        <form id="Form1" runat="server">
            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container">
                        <div class="row">
                            <div class="span3">
                                <img src="img/logo.svg" height="40" style="padding-top: 5px; padding-bottom: 5px" />
                            </div>
                            <div class="span9 pull-right" style="text-align: right; margin-top: 5px;">
            ...
            <div class="container-fluid" style="padding: 0;">
                ...
                <%--<div id="DivShowPerformance" class="row-fluid" style="margin-top: 0px; margin-right: 25px;" runat="server">
                    <!-- block -->
                    <div class="span12">
                        <div class="block" style="margin-top: 20px; margin-right: 0px;">
                ...
                <%--Added by B K Rao--%>
                <div class="row-fluid" id="DataShow" runat="server">
                                            ...
                                            <div class="span12">
                                                <div class="" style="margin-top: 0px; margin-right: 0px;">
                                                    ...
                                                    <div class="block-content collapse in">
                                                        ...
                                                        <asp:Repeater ID="GrdCompFund" runat="server" Visible="true">
                                                            <HeaderTemplate>
                                                                <table class="table table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th colspan="2" align="center" style="text-align: center;" class="non-over-night">1Yr</th>
                                                                            <th colspan="2" align="center" style="text-align: center" class="non-over-night">3 Yrs</th>
                                                                            <th colspan="2" align="center" style="text-align: center" class="non-over-night">5 Yrs</th>
                ...
                <footer style="font-size: 12px; margin-top: 10px; text-align: center">
                    <div class="value_input" style="text-align: right; font-size: 10px; color: #A7A7A7">
                                Developed for L&T AMC by: <a href="https://www.icraanalytics.com" target="_blank" style="font-size: 10px; color: #999999">ICRA Analytics Ltd,</a>
