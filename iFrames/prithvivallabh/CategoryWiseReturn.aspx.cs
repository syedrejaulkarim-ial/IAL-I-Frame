...
{
    public partial class CategoryWiseReturn : System.Web.UI.Page
    {
        ...
        public static string getTopFundData(int SebiSubNatureId, int SebiNatureId, string period)
        {
            ...
            DataTable dtResult = AllMethods.getSebiTopFundRank(25, 2, SebiNatureId, period, SebiSubNatureId, 2, -1, 500, -1, -1);
