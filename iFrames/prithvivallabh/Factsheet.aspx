<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Factsheet.aspx.cs" Inherits="iFrames.prithvivallabh.Factsheet" %>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card mt-3" runat="server" visible="false"
                        id="dvFactSheet">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                                    ...
                                    <span class="badge badge-soft-inverse">
                                        ...
                                        <img id="imgArrow" src="img/arwup.svg" class="pt-0"
                                            runat="server" />
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-lg-right pl-0">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="card">
                                        <div class="card-header" style="background: #fff">
                                            <h7>Investment Info</h7>
                                        </div>
                                        <div class="card-body">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                                <table width="100%" border="0" align="left" cellpadding="0"
                                                    cellspacing="0" class="table" style="margin-bottom: 0px">
                                                    <tr>
                                                        <td style="border: none" id="tdFundName" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblFundType"></asp:Label></strong>
                                                            <p class="text-grey">Fund Type</p>
                                                        </td>
                                                        <td style="border: none; display: none">
                                                            <input type="hidden" id="hdSchemeId" value="0" runat="server" />
                                                        </td>
                                                        <td style="border: none; display: none" id="tdEntryLoad"
                                                            runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblEntry"></asp:Label></strong>
                                                            <p>Entry Load</p>
                                                        </td>
                                                        <td style="border: none" id="tdAssetSize" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblAsset"></asp:Label></strong>
                                                            <p>Average Asset Size (₹ cr.)</p>
                                                        </td>
                                                        <td style="border: none" id="tdStructure" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblInvestMent"></asp:Label></strong>
                                                            <p>Investment Plan</p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border: none" id="tdExitLoad" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblExit"></asp:Label></strong>
                                                            <p>Exit Load</p>
                                                        </td>
                                                        <td style="border: none" id="tdMinInvest" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblMinIvest"></asp:Label></strong>
                                                            <p>Minimum Investment (₹)</p>
                                                        </td>
                                                        <td style="border: none" id="tdLunchDate" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblIncepDate"></asp:Label></strong>
                                                            <p>Launch Date	</p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border: none" id="tdFundMan" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblFundMan"></asp:Label></strong>
                                                            <p>Fund Manager	</p>
                                                        </td>
                                                        <td style="border: none" id="tdLastDiv" runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblLastDiv"></asp:Label></strong>
                                                            <p>
                                                                Last Dividend
                                                            </p>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="border: none; display: none" id="tdBenchMark"
                                                            runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblBench"></asp:Label></strong>
                                                            <p>
                                                                Benchmark
                                                            </p>
                                                        </td>
                                                        <td style="border: none; display: none" id="tdEmail"
                                                            runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblWebSite"></asp:Label></strong>
                                                            <p>
                                                                Email / Website
                                                            </p>
                                                        </td>
                                                        <td style="border: none; display: none" id="tdBonus"
                                                            runat="server">
                                                            <strong>
                                                                <asp:Label runat="server" ID="lblBonus"></asp:Label></strong>
                                                            <p>
                                                                Bonus
                                                            </p>
                                                        </td>
                                                        ...
                                                        <asp:Repeater ID="PeerPerformance" runat="server">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th rowspan="2" style="text-align: right; white-space: nowrap">
                                                                                AUM (₹ Cr)
                                                                            </th>
                                                                            <th colspan="7" style="text-align: center; padding-top: 0px;
                                                                                padding-bottom: 0px">Return (%)
                                                                            </th>
                                                                        </tr>
                                                                        <tr>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr id="dvTrID" runat="server">
                                                                    <td>                                                                        
                                                                        <a href="/prithvivallabh/Factsheet.aspx?param=<%#Eval("SchemeId")%>"
                                                                            target="_blank"><%#Eval("SchemeName")%></a>
                                                                    </td>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    ...
                                                    <asp:Repeater ID="TopCompDetails" runat="server">
                                                        <HeaderTemplate>
                                                            <table width="100%" border="0" align="left" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th style="text-align: right; border-right: none">Asset
                                                                        %</th>
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblSubject" runat="server" Style="font-weight: 500"
                                                                        Text='<%#Eval("CompName") %>' />
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    ...
                                                    <asp:Repeater ID="TopCompDetails1" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label4" runat="server" Style="font-weight: 500"
                                                                        Text='<%#Eval("CompName") %>' />
                                                                </td>
                                                                <td>
                            ...
                            <div class="row pt-3">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="card">
                                        <div class="card-header" style="background: #fff">
                                            <h7>Statistical Analysis</h7>
                                        </div>
                                        <div class="card-body pt-3">
                                            <div class="category-style-03 text-center justify-content-center"
                                                ...
                                                <div class="category-item" style="margin-right: 0px;">
                                                    <div class="card text-center">
                                                        <div class="card-header" style="background: #fff">
                                                            <h8>R-Square</h8>
                                                        </div>
                                                    ...
                                                    <asp:Repeater ID="RepTopSector" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr class='<%# Convert.ToBoolean(Container.ItemIndex % 2) ? "value_tablerow" : "value_tablerow" %>'>
                                                                <td>
                                                                    <asp:Label ID="lblSectorName" runat="server" Style="font-weight: 500"
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="">
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                                    <div style="float: left; height: 240px; margin-top: 0px; text-align: center; width: 98%"
