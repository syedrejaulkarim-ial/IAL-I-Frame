<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompareFund.aspx.cs" Inherits="iFrames.prithvivallabh.CompareFund" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12 col-md-1 col-lg-1 pt-22 text-right"
                                        style="padding-left: 0">
                                        <asp:ImageButton ID="btnAddScheme" runat="server" AlternateText="Add"
                                            OnClick="btnAddScheme_Click" class="btn btn-success btn-xs mt-2"
                                            OnClientClick="Javascript:return ValidateControl();"
                                            ValidationGroup="scheme" ImageUrl="images/images/add.svg" />
                                    </div>
                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <label>Option</label>
                                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-2 col-sm-2 col-md-1 col-lg-1 pt-22 text-right"
                                        ...
                                        <asp:ImageButton ID="btnAddIndices" runat="server"
                                            AlternateText="Add" ImageUrl="images/images/add.svg"
                                            OnClick="btnAddIndices_Click" class="btn btn-success btn-xs mt-2"
