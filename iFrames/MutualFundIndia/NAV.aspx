<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always"
    EnableViewStateMac="true" CodeBehind="NAV.aspx.cs"
    Inherits="iFrames.MutualFundIndia.NAV" %>
<!DOCTYPE html >
<html lang="en-US">
<head>
<meta charset="utf-8">
...
<meta name="viewport" content="width=device-width,initial-scale=1">
    ...
    <script type="text/javascript" language="javascript">
         ...
         //        if (IsAllChecked) {
         //            //$('input[name="SelectAllCheckBox"]')[0].checked = true;
         //            //$('input[name="SelectAllCheckBox"]')[0].prop('checked', true);
         ...
         function ValidateControl() {
            ...
            if (listCount >= 5) {
                alert("The List can contain maximum 5 Items");
                return false;
            }
            return true;
        }
        ...
        function SelectUnique(CheckBoxControl) {
            if (CheckBoxControl.checked == true) {
    ...
    <script type="text/javascript">
        ...
        function PlotAuto(dataConsolidated, ImageArray) {
            $("#DivLast").show();
            document.getElementById("DivLast").style.visibility = "visible";//Added on 8-march-2021
            var max = dataConsolidated.MaxDate;
            var min = dataConsolidated.MinDate;
            var data = dataConsolidated.SimpleNavReturnModel;
            var tt = [[]];
    ...
    <form id="form1" runat="server">
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        ...
                        <div class="form-group col-xs-6 col-sm-4 col-md-7 col-lg-7">
                            ...
                            <%--<button type="button" class="btn btn-success btn-xs pull-right" ng-click="AddLevel();">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div id="DivGridContain" runat="server">
                        <div class="" style="margin-top: 20px;">
                            <asp:DataGrid class="table table-bordered"
                                Style="margin-top: 15px;" ID="dglist"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Latest NAV" HeaderStyle-CssClass="">
                                        <ItemTemplate>
                                            <asp:Label ID="lblNAV" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Latest_NAV")%>'></asp:Label>
                                        </ItemTemplate>
                                        <%--<HeaderStyle BackColor="#37689a" ForeColor="White" Width="5%"></HeaderStyle>--%>
                                        <ItemStyle HorizontalAlign="Left" Width="5%"></ItemStyle>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Key" HeaderStyle-CssClass="">
                                        <ItemTemplate>
                            ...
                            <div>
                                <table>
                                    <tr>
                                        <td style="float: left;">
                                            <asp:Label ID="lblGridMsg" runat="server" Text="" Font-Bold="true"
                            ...
                            <div id="DivPlotChart" runat="server" class="row-fluid"
                                ...
                                <input type="button" value="Plot Chart" class="btn btn-primary btn-xs pull-right"
                                    id="btplotChart" onclick="Javascript: btnPlotclick();"
                                    style="margin-top: 10px;" />

                            </div>
                            <div id="DivLast" runat="server" class="row-fluid"
                                style="margin-top: 0px; display: none; margin-bottom: 10px;">
