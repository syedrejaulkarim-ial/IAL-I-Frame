<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always"
    EnableViewStateMac="true" CodeBehind="CompareFund.aspx.cs"
    Inherits="iFrames.MutualFundIndia.CompareFund" %>
...
<head>
    ...
    <%--<meta http-equiv="Content-Security-Policy" content="default-src 'unsafe-inline' https://fonts.gstatic.com; script-src * 'self' 'unsafe-inline' 'unsafe-eval'; style-src * 'self' 'unsafe-inline' 'unsafe-eval'; img-src * 'self'; frame-src * 'self'; connect-src  * 'self'">--%>
            ...
            <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="form-group col-xs-6 col-sm-6 col-md-4 col-lg-4">
                            ...
                            <div>
                                <asp:ListBox ID="ddlFundHouse" runat="server"
                                    class="form-control form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="ddlMutualFund_SelectedIndexChanged" SelectionMode="multiple"></asp:ListBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-xs-6 col-sm-6 col-md-1 col-lg-1 pd-t-30 text-right">
                            <asp:ImageButton ID="btnAddScheme" runat="server" AlternateText="Add"
                                OnClick="btnAddScheme_Click" class=""
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        ...
                        <div class="form-group col-xs-6 col-sm-4 col-md-7 col-lg-7">
                        ...
                        <div class="form-group col-xs-6 col-sm-6 col-md-1 col-lg-1 pd-t-35 text-right">
                            <asp:ImageButton ID="btnAddIndices" runat="server"
                                AlternateText="Add" ImageUrl="images/images/add.png"
                                OnClick="btnAddIndices_Click" class=""
                                OnClientClick="Javascript:return Listcount();"
                                ValidationGroup="indices" />
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pr-0 pt-3"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div id="DivFundShow" runat="server">
                        <div class="table-responsive" style="margin-top: 20px;">
                            <asp:DataGrid class="table table-bordered" ID="dglist" runat="server" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true" Width="100%" OnItemCommand="dglist_ItemCommand">
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Name" HeaderStyle-CssClass="">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Chart" HeaderStyle-CssClass="">
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkItem" runat="server" onclick="UnCheckItem(this)"></asp:CheckBox>
                                    ...
                                    <asp:TemplateColumn HeaderText="Delete" HeaderStyle-CssClass="">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgbtnDel" runat="server" ImageUrl="images/close.png" AlternateText="Delete"
                        ...
                        <div class=" pd-b-15">
                            <asp:Button ID="btnCompareFund" runat="server" Text="Show Performance"
                                class="btn btn-primary btn-xs pull-right" OnClientClick="validateList();"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div id="DivShowPerformance" runat="server">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="GrdCompFund" runat="server" class="table table-bordered"
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lbl1Mth" CssClass="text-right" runat="server"
                                                Text='<%#Eval("Per_30_Days").ToString() != "" ? Eval("Per_30_Days", "{0:0.00}") : "N/A"%>' />
                                        </ItemTemplate>
                                ...
                                <%#Eval("Per_91_Days").ToString() != "" ? Eval("Per_91_Days", "{0:0.00}") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="Lnk6mth" runat="server" Font-Bold="true"
                                                Text="6M"
                                ...
                                <%#Eval("Per_182_Days").ToString() != "" ? Eval("Per_182_Days", "{0:0.00}") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="Lnk1yr" runat="server" Font-Bold="true"
                                                Text="1Y"
                                ...
                                <%#Eval("Per_1_Year").ToString() != "" ? Eval("Per_1_Year", "{0:0.00}") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="Lnk3yr" runat="server" Font-Bold="true"
                                                Text="3Y"
                                ...
                                <%#Eval("Per_3_Year").ToString() != "" ? Eval("Per_3_Year", "{0:0.00}") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="LnkSI" runat="server" Font-Bold="true"
                                ...
                                <%#Eval("Per_Since_Inception").ToString() != "" ? Eval("Per_Since_Inception", "{0:0.00}") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                ...
                                <%#Eval("Nav_Rs").ToString() != "" ? Eval("Nav_Rs", "{0:0.00}") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                ...
                                <%#Eval("Nature").ToString() != "" ? Eval("Nature") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                ...
                                <%#Eval("Structure_Name").ToString() != "" ? Eval("Structure_Name") : "N/A"%> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
