<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Return Calc.aspx.cs" Inherits="iFrames.MutualFundIndia.Return_Calc" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        //function OnCalSelection(Input) {
        //    if (Input == "PC") {
        //        $('#ddlMode').val("Lump Sum");
        //        PageMethods.OnCalPCSelection_Click();
        //    }
        //    if (Input == "SIP") {
        //        $('#ddlMode').val("SIP");
        //        PageMethods.OnCalSIPSelection_Click();
        //    }
...
<body>
    <form id="form1" runat="server">
        ...
        <section class="about-us-content pd-b-10">
            <div class="container">
                <div class="row">
                    <div class="col-12 pd-b-10">
                        <h3 class="h1 text-center after-50 pd-b-30" id="PageHeader" runat="server"></h3>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row">
                        ...
                        <div class="card rounded-1">
                            <div class="card-header border-bottom p-3">
                                <span class="h5 m-0">Calculators</span>
                            </div>
                            <div class="list-group list-group-flush">
                            
                                <a href="https://mfiframes.mutualfundsindia.com/MutualFundIndia/Return%20Calc.aspx?param=Lump Sum" ID="PCCal" runat="server"  class="list-group-item list-group-item-action d-flex justify-content-between py-3 active">
                                    <div>      
                                ...
                                <a href="https://mfiframes.mutualfundsindia.com/MutualFundIndia/Return%20Calc.aspx?param=SIP" ID="SIPCal" runat="server" class="list-group-item list-group-item-action d-flex justify-content-between py-3">
                                    <div>
                                ...
                                <a href="https://mfiframes.mutualfundsindia.com/MutualFundIndia/Return%20Calc.aspx?param=STP" ID="STPCal" runat="server" class="list-group-item list-group-item-action d-flex justify-content-between py-3">
                                    <div>
                                        <span>STP Calculator</span>
                                    </div>
                                    <div>
                                        <i class="fa fa-angle-right"></i>
                                    </div>
                                ...
                                <a href="https://mfiframes.mutualfundsindia.com/MutualFundIndia/Return%20Calc.aspx?param=SWP" ID="SWPCal" runat="server" class="list-group-item list-group-item-action d-flex justify-content-between py-3">
                                    <div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-sm-6 col-md-10 col-lg-10">
                                                <div runat="server" visible="true">
                                                    ...
                                                    <asp:Label ID="lblSchemeName" Text="Scheme Name" runat="server" CssClass="label"></asp:Label>
                                            ...
                                            <div class="form-group col-xs-6 col-sm-6 col-md-2 col-lg-2">
                                                <div visible="true" id="trInception1" runat="server">
                                                    <label id="LabelInception">Inception Date</label>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                        <div class="form-group">
                                            <div id="trBenchmark" runat="server">
                                                <label id="Span3" class="">Benchmark</label>
                                        ...
                                        <div id="trInitialInvst" runat="server" visible="false">
                                            <div class="row">
                                                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    <asp:Label class="" runat="server" ID="lblInitial" CssClass="label">Initial Amount (₹)</asp:Label>
                                                    <asp:TextBox ID="txtiniAmount" runat="server" CssClass="form-control form-control-sm"
                                                        MaxLength="10" ReadOnly="false"></asp:TextBox>
                                                </div>
                                                <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    <asp:Label ID="lblSIPinit" runat="server" CssClass="label">Initial Date </asp:Label>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                        <div id="trSipInvst" runat="server" visible="true">
                                            <div>
                                                <div runat="server" id="SIP_withdrawl" class="row">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                    ...
                                                    <div class="" id="dvWithDrawSPdspn" runat="server">
                                                        <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6" id="dvWithDrawSP" runat="server">
                                                            <asp:Label ID="lblTransferWithdrawal" runat="server"
                                                                Text="Withdrawal Amount" CssClass="label"></asp:Label>
                                                ...
                                                <div id="SWP_STP_withdrawl" runat="server" visible="false">
                                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                                        <asp:Label ID="lblTransferWithdrawal2" runat="server"
                                                            Text="Withdrawal Amount" class="label"></asp:Label>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right pt-3">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 text-right">
                                                ...
                                                <asp:Button ID="sipbtnshow" runat="server" Text="Calculate" CssClass="btn btn-primary" OnClick="sipbtnshow_Click" Style="margin-right: 10px" />
                                                ...
                                                <asp:Button ID="sipbtnreset" runat="server" OnClick="sipbtnreset_Click" class="btn btn-light" Style="margin-right: 15px;" Text="Reset"></asp:Button>
                                            </div>
                ...
                <div id="returns-calc-form">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="">
                                <div id="resultDiv" runat="server" visible="false">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="display: none" class="table table-bordered">
                                        <tr align="left">
                    ...
                    would be Rs <strong>131779.37</strong>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblIfInvested" CssClass="rslt_text" runat="server" Text="Had you invested ₹ Y at Date A, the total value of this investment at Date C would have become Q">
                                                </asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" id="TableRemark" class="table" cellpadding="0" cellspacing="0" align="center" style="margin-bottom: 0rem;">
                                        <tr>
                                            <td style="border-top:none">
                                                <div id="divTab" runat="server" visible="false" style="padding: 0">
                                                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="padding: 0">
                                                        <tr align="left">
                                                            <td align="left" valign="top" style="padding: 0;border-top:none">
                                                                                ...
                                                                                <tr>
                                                                                    <td style="border-top:none">
                                                                                        <asp:View ID="View1" runat="server">
                                                                                            <table width="100%">
                                                                                                <tr>
                                                                                                    <td align="right" style="padding-right: 20px; border:none; padding:0">
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:View ID="View2" runat="server">
                                                                                            ...
                                                                                            <div id="divshowChart" runat="server" visible="true"
                                                                                                ...
                                                                                                <asp:Chart ID="chrtResult" runat="server" AlternateText="Bluechip"
                                                                                                    Visible="true"
                                                                                                    BorderlineWidth="2" Width="650px" Height="580px"
                                                                                                    IsSoftShadows="false">
                                                                                                    <%--BackGradientStyle="Center"  BorderlineColor="RoyalBlue" BackColor="Gray"--%>
                                                                                                    <Titles>
                                                                                                        <asp:Title Font="Trebuchet MS, 14pt, style=Bold" Text="Bluechip"
                                                                                                            ForeColor="26, 59, 105">
                                                                                                        </asp:Title>
                                                                                                    </Titles>
                                                                                                    <Legends>
                                                                                            ...
                                                                                            <ScaleView SizeType="Years" />--%>
                                                                                                ...
                                                                                                <br />
                                                                                                <asp:Chart ID="chrtResultSTPTO" runat="server" AlternateText="Bluechip"
                                                                                                    Visible="false"
                                                                                                    BorderlineWidth="2" Width="650px" Height="580px"
                                                                                                    IsSoftShadows="false">
                                                                                                    <Titles>
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    <div class="col-md-12 pt-4">
                                                                                                        ...
                                                                                                        <asp:LinkButton ID="LinkButtonGenerateReport" runat="server"
                                                                                                            ...
                                                                                                            CssClass="btn btn-warning btn-sm ">Generate PDF</asp:LinkButton>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <%--<table width="100%">
                                                                                                    <tr>
        ...
        <section class="about-us-content pd-b-30">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
