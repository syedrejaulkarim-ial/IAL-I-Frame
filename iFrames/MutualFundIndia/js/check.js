...
function setIncDate() {    
    ...
    var val = $('#chkInception').is(':checked');
    var val1 = $('#chkInception4sip').is(':checked');
    var selectionType = $('#ddlMode').val();
    if (selectionType.toUpperCase() != 'LUMP SUM') {
      //  alert('test');
        if ($('#chkInception').is(':checked')) {
            ...
            $("#txtLumpfromDate").val('');
            //$("#txtLumpfromDate").attr("readonly", false);
           // $('#txtLumpfromDate').attr("disabled", false);
        }

        if ($('#chkInception4sip').is(':checked')) {           
            $("#txtfromDate").val($("#SIPSchDt").val());
            $("#txtIniToDate").val($("#SIPSchDt").val());
...
function validate_SIP() {
    ...
    if (document.getElementById("ddlscheme").value == '0' || document.getElementById("ddlscheme").value == '-1') {
    ...
    if (document.getElementById("ddlMode").value == 'Lump Sum') {
        ...
        if (isNaN(sipamunt)) {
            ...
            if (sipamunt < 1000) {
                alert('Minimum  installment amount should be Rs. 1000/- ');
                document.getElementById('txtinstallLs').value = "";
                document.getElementById("txtinstallLs").focus();
                return false;
            }
    ...
    if (i <= 0) {
        alert("Current Date should be Less than Today");
    ...
    if (!IsValidDate(sipEnddata, sipAsondata)) {
        alert("Current Date should be greater than End Date ");
        document.getElementById('txtvalason').value = "";
        document.getElementById('txtvalason').focus();
        return false;
    }
...
function validate_STP() {
    ...
    if (document.getElementById("ddlscheme").value == '0' || document.getElementById("ddlscheme").value == '-1') {
        alert('Please select From Scheme.');
        document.getElementById("ddlscheme").focus();
        return false;
    }

    if (document.getElementById("ddlschtrto").value == '0' || document.getElementById("ddlschtrto").value == '-1') {
        alert('Please select To Scheme.');
    ...
    //alert(sipamunt);
    if (sipamunt == "") {
        alert("Initial Investment Amount cannot be Blank");
        document.getElementById('txtiniAmount').focus();
        return false;
    }
    ...
    if (!IsValidDate(sipEnddata, sipAsondata)) {
        alert("Current Date should be greater than To Date ");
        document.getElementById('txtvalason').value = "";
        document.getElementById('txtvalason').focus();
        return false;
    }
