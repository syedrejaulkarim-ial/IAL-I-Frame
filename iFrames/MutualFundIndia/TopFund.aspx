<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="TopFund.aspx.cs" Inherits="iFrames.MutualFundIndia.TopFund" %>
...
//        }
    ...
    <!-- Do not delete It will required for login , Invest now -->
      ...
      <script type="text/javascript">
          //function ClickLink() {
          //    $('#PageHeader', parent.document).html('<h1>clicked</h1>');
          //}
          $(function () {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 pd-b-10">
                        <h3 class="h1 text-center after-50 pd-b-30">Top Fund</h3>
                    </div>
                </div>
            </div>
        </section>--%>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                           ...
                                           <%--<div class="mt-2">
                                               ...
                                               <label class="custom-control-label" for="customRadio1">Growth</label>
                                      ...
                                      <asp:RadioButtonList ID="rdbOption" runat="server" class="custom-control-input" RepeatDirection="Horizontal" Style="padding-top: 15px; text-align: center; font-size: 14px; font-weight: normal" Width="100%"></asp:RadioButtonList>
                                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 text-right">
                                            <asp:Button ID="btnSubmit" class="btn btn-primary" Style="margin-right: 10px" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
                                            <asp:Button ID="btnReset" class="btn btn-light" Style="margin-right: 15px;" runat="server" Text="Reset" OnClick="btnReset_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <asp:ListView ID="lstResult" runat="server" OnPagePropertiesChanging="lst_PagePropertiesChanging">
                                                ...
                                                <asp:Label ID="Label1" runat="server" SkinID="lblHeader" CommandName="Sort" CommandArgument="ICRON_Rank" Text="ICRON Rank" />
                                                    ...
                                                    <asp:Label ID="lnkDate" runat="server" SkinID="lblHeader" CommandName="Sort" CommandArgument="Date" Text="Date" />      
                                                                ...
                                                                <th colspan="8" style="text-align: center;">Return (%) </th>
                                                            </tr>
                                    ...
                                    <br />
                                                ...
                                                <ItemTemplate>
                                                    <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "value_tablerow" : "value_tablerow" %>'>
                                                        ...
                                                        <td style="width: 35%;">
                                                            ...
                                                            <a href="https://mfiframes.mutualfundsindia.com/MutualFundIndia/Factsheet.aspx?param=<%#Eval("SchemeId")%>"><%#Eval("Sch_Name")%></a>
                                        ...
                                        <div class="pt-3">
                                            ...
                                            <div style="font-size: 10px; color: #A7A7A7">
                                                Developed by: <a href="https://www.icraanalytics.com" target="_blank" style="font-size: 10px; color: #999999">ICRA Analytics Ltd</a>, <a style="font-size: 10px; color: #999999" href="https://icraanalytics.com/home/Disclaimer" target="_blank">Disclaimer </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
