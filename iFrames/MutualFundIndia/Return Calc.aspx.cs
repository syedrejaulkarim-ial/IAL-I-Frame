    ...
    public partial class Return_Calc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    var decryptedString = Request.QueryString["param"];
					ddlMode.SelectedItem.Value = decryptedString;
					ddlMode.SelectedItem.Text = decryptedString;
					PopulateFrequency();
					ShowRelativeDiv();
					if(decryptedString == "Lump Sum")
					{
						STPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						SWPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						SIPCal.Attributes.Add("class","list-group-item list-group-item-action d-flex justify-content-between py-3");
						PCCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3 active");
						PageHeader.InnerHtml = "Performance Calculator";

					}
					if (decryptedString == "SIP")
					{
						SWPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						STPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						PCCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						SIPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3 active");
						PageHeader.InnerText = "SIP Calculator";
					}
					if (decryptedString == "STP")
					{
						SIPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						PCCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						SWPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						STPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3 active");
						PageHeader.InnerText = "STP Calculator";
					}
					if (decryptedString == "SWP")
					{
						STPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						SIPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						PCCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3");
						SWPCal.Attributes.Add("class", "list-group-item list-group-item-action d-flex justify-content-between py-3 active");
						PageHeader.InnerText = "SWP Calculator";
					}
					//ddlMode.ClearSelection();
					//ddlMode.Items.FindByValue(Convert.ToString(decryptedString)).Selected = true;
		...
		protected void OnPCCalSelection_Click(object sender, EventArgs e)
		{
			ddlMode.SelectedItem.Value = "LUMP SUM";
			ddlMode.SelectedItem.Text = "LUMP SUM";
			PopulateFrequency();
			ShowRelativeDiv();
		...
		public void OnCalSIPSelection_Click(object sender, EventArgs e)
		{
			ddlMode.SelectedItem.Value = "SIP";
			ddlMode.SelectedItem.Text = "SIP";
			PopulateFrequency();
			ShowRelativeDiv();
		...
		protected void OnCalSelection(object sender, EventArgs e)
		{
			PopulateFrequency();
			ShowRelativeDiv();
			// txtinstall.Text = "";
        ...
        public void Reset()
        {
            ...
            Response.Redirect("/MutualFundIndia/Return Calc.aspx");
        }
        ...
        private void ShowExcel(string FundName)
        {
            ...
            objFinalstr.Replace(@"class=""grdHead""", "style ='text-align: center;		color: #ffffff;	font-size: 11px;background:#e46812;	font-weight:normal;'");
        ...
        public void BindDataTableToChart(DataTable _dt, string xField, System.Web.UI.DataVisualization.Charting.Chart chrt, string strCompareColumn)
        {
            ...
            try
            {
                ...
                foreach (DataColumn dc in _dt.Columns)
                {
                    ...
                    {
                        CompareToColumn = dc.ColumnName.ToUpper();
                        chrt.Series[dc.ColumnName].Color = System.Drawing.ColorTranslator.FromHtml("#e46812");// System.Drawing.Color.Blue;//#e46812
                ...
                string localImgPath = @"MutualFundIndia\Img";
                ...
                var allImageFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "MutualFundIndia\\IMG", "MutualFundIndia_SIP_Temp*");
                ...
                imgPath = System.IO.Path.Combine(localImgPath, "MutualFundIndia_SIP_Temp" + Guid.NewGuid().ToString("N") + "_" + tmpChartName);
                ...
                {
                    Session["BLUE_CHIP_GRP_IMG_PATH_STP"] = imgPath;
                    chrtResultSTPTO.SaveImage(imgPath);
                }
                else
                {
                    Session["BLUE_CHIP_GRP_IMG_PATH"] = imgPath;
        ...
        public string GETHtmlFile()
        {
            ...
            switch (RadioButtonListCustomerType.SelectedItem.Text.ToUpper().Trim())
            {
                case "DISTRIBUTOR":
                    if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaSIPPDFTemplate.html")));// for din regular SundaramPDFtemplate3 normal
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaswpPDFTemplate.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiastpPDFTemplate.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaPDFTemplateInitial.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaLsPDFTemplate.html")));
                    }
                    break;
                default:
                    if (ddlMode.SelectedItem.Value.ToUpper() == "SIP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaSIPPDFTemplateWOD.html")));//
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SWP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaswpPDFTemplateWOD.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "STP")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiastpPDFTemplateWOD.html")));
                    }
                    else if (ddlMode.SelectedItem.Value.Trim().ToUpper() == "SIP WITH INITIAL INVESTMENT")
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaPDFTemplateInitialWOD.html")));
                    }
                    else
                    {
                        strHTML.Append(File.ReadAllText(HttpContext.Current.Server.MapPath("~/MutualFundIndia/Html/MutualFundIndiaLsPDFTemplateWOD.html")));
                    }
                    break;
            }
        ...
        public void CreateHTMLSIP()
        {
            ...
            var allFiles = Directory.GetFiles(HttpContext.Current.Server.MapPath("~") + "MutualFundIndia\\PDF", "MutualFundIndia_*");
            foreach (var f in allFiles)
            ...
            try
            {
                ...
                if (ddlMode.SelectedItem.Value.ToUpper().StartsWith("SIP"))
                {
                    gvFirstTablestr = gvFirstTablestr.Replace(@"scope=""col""", "style ='text-align:center;color: #ffffff;font-size: 14px;font-weight: normal;background: #e46812;height: 25px;'");
                ...
                string imagePath = Convert.ToString(Session["BLUE_CHIP_GRP_IMG_PATH"]);
                ...
                //added 30 oct 2012
                GridViewSIPResultstr = GridViewSIPResultstr.Replace(@"scope=""col""", "style ='text-align: center;color: #ffffff;font-size: 14px;font-weight: normal;background: #e46812;height: 25px;'");
                ...
                path = HttpContext.Current.Server.MapPath("~/MutualFundIndia/PDF/" + "MutualFundIndia" + "_" + Convert.ToString(Session["GUID"]) + ".htm");
                ...
                strHTML = null;
                _SimpleConversion("MutualFundIndia");
                ...
                if (Session["GUID"] != null)
                {
                    ...
                    Response.AppendHeader("Content-Disposition", "attachment; filename=MutualFundIndia.pdf");
                    Response.TransmitFile(Server.MapPath("~/MutualFundIndia/PDF/MutualFundIndia_" + pdfName));
                    Response.End();
                }
