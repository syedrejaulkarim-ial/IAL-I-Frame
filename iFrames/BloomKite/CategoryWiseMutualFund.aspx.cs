...
{
    public partial class CategoryWiseMutualFund : System.Web.UI.Page
    {
        ...
        protected void loadData(int category_id, int subcategory_id)
        {
        ...
        public static string getTopFundData(int SebiSubNatureId,int SebiNatureId)
        {
            ...
            DataTable dtResult = AllMethods.getSebiTopFundRank(20, -1, SebiNatureId, "Per_1_Year", SebiSubNatureId, 2, -1, 500, -1, -1);
