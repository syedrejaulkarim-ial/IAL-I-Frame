<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="Factsheet.aspx.cs"
    Inherits="iFrames.BloomKite.Factsheet" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../Styles/jquery.jqplot.css" rel="stylesheet"
        type="text/css" />
...
<body>
    <form id="form1" runat="server">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2 style="text-align: center">Fund Factsheet</h2>
            <div class="card-body">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                                ...
                                                <asp:Repeater ID="PeerPerformance" runat="server">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr id="dvTrID" runat="server">
                                                            <td>
                                                                <%--<a href="http://development-bloomkite.s3-website.us-east-2.amazonaws.com/factsheet?param=<%#Eval("AmfiCode")%>&title=MutualFunds"
                                                                    target="_blank"><%#Eval("SchemeName")%></a>--%>
                                                                <a href="https://www.bloomkite.com/factsheet?param=<%#Eval("AmfiCode")%>&title=MutualFunds"
                                                                    target="_blank"><%#Eval("SchemeName")%></a>
                                                            </td>
                                                    ...
                                                    <HeaderTemplate>
                                                        <table width="100%" border="0" align="left" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="text-align: right; border-right: none;white-space: nowrap">Asset
                                                                        %</th>
                                        ...
                                        <div class="category-style-03 text-center justify-content-center"
                                            ...
                                            <div class="category-item">
                                                <div class="card text-center">
                                                    <div class="card-header" style="background: #fff">
                                                        <h5 style="font-size:14px">Sharpe</h5>
                                                    </div>
                                            ...
                                            <div class="category-item">
                                                <div class="card text-center">
                                                    <div class="card-header" style="background: #fff">
                                                        <h5 style="font-size:14px">Sortino</h5>
                                                    </div>
                                                    <div class="card-body bg-grey">
                                            ...
                                            <div class="category-item">
                                                <div class="card text-center">
                                                    <div class="card-header" style="background: #fff">
                                                        <h5 style="font-size:14px">Standard Deviation</h5>
                                                    </div>
                                                    <div class="card-body bg-grey">
                                            ...
                                            <div class="category-item">
                                                <div class="card text-center">
                                                    <div class="card-header" style="background: #fff">
                                                        <h5 style="font-size:14px">Beta</h5>
                                                    </div>
                                                    <div class="card-body bg-grey">
                                            ...
                                            <div class="category-item" style="margin-right: 0px;">
                                                <div class="card text-center">
                                                    <div class="card-header" style="background: #fff">
                                                        <h5 style="font-size:14px">R-Square</h5>
                                                    </div>
                                                    <div class="card-body bg-grey">
