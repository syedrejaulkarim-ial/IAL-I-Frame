    ...
    return function (t) {
        ...
        var o = {},
            r = function () {
                ...
                return t.setDefaults = function (t, e) {
                    ...
                    var o, r, i;
                    if (void 0 === n && (n = !1), e.fontStyle && this.jsPDFDocument.setFontStyle && this.jsPDFDocument.setFontStyle(e.fontStyle), e.font) {
                        var l = this.getFontList()[e.font],
                            a = e.fontStyle;
                        l && a && -1 === l.indexOf(a) && this.jsPDFDocument.setFontStyle(l[0]), this.jsPDFDocument.setFont(e.font, e.fontStyle)
                    }
        ...
        function i(t, e, n, i, a, s) {
            for (var u = new r.HtmlRowInput(i), d = 0; d < i.cells.length; d++) {
                ...
                if (a || "none" !== c.display) {
                    var f = void 0;
                    s && (f = o.parseCss(t, h, e, c, n)), u.push({
                        rowSpan: h.rowSpan,
                        colSpan: h.colSpan,
                        styles: f,
                        _element: h,
            ...
            var f = function (t, e, n) {
                ...
                g = function (t, e) {
                    ...
                    return {
                        ...
                        showHead: p,
                        showFoot: f,
                        tableLineWidth: null !== (h = e.tableLineWidth) && void 0 !== h ? h : 0,
                        tableLineColor: null !== (c = e.tableLineColor) && void 0 !== c ? c : 200
                    }
                }(n, c),
                y = function (t, e, n) {
                    var r = e.head || [],
        ...
        function h(t, e, n, o) {
            ...
            r.addTableBorder(t, e, n, o), c(t), e.pageNumber++ , e.pageCount++ , o.x = i.left, o.y = i.top, "everyPage" === e.settings.showHead && e.head.forEach((function (n) {
                return d(t, e, n, o)
            }))
        }
        ...
        e.drawTable = function (t, e) {
            ...
            var v = a.assign({}, f);
            e.startPageNumber = y.pageNumber(), y.applyStyles(y.userStyles), "firstPage" !== n.showHead && "everyPage" !== n.showHead || e.head.forEach((function (t) {
                return d(y, e, t, f)
                ...
                return d(y, e, t, f)
            })), r.addTableBorder(y, e, v, f), e.callEndPageHooks(y, f), e.finalY = f.y, t.lastAutoTable = e, t.previousAutoTable = e, t.autoTable && (t.autoTable.previous = e), y.applyStyles(y.userStyles)
        }, e.addPage = h
    }, function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        function r(t, e) {
            var n = function t(e, n) {
                var o = n(e);
                return "rgba(0, 0, 0, 0)" === o || "transparent" === o || "initial" === o || "inherit" === o ? null == e.parentElement ? null : t(e.parentElement, n) : o
            }(t, e);
            if (!n) return null;
        ...
        e.calculateWidths = function (t, e) {
            ...
            a && (a = r(n, a, (function (t) {
                ...
                return t.minWidth
            }))), (a = Math.abs(a)) > .1 / t.scaleFactor() && (a = a < 1 ? a : Math.round(a), console.error("Of the table content, " + a + " units width could not fit page")),
                function (t) {
                    ...
                    for (var n = {
                        ...
                        for (var l = r[o], a = 0, s = t.columns; a < s.length; a++) {
                            ...
                            if (d) {
                                ...
                                }) : "ellipsize" === d.styles.overflow ? d.text = i(d.text, h, d.styles, e, "...") : "hidden" === d.styles.overflow ? d.text = i(d.text, h, d.styles, e, "") : "function" == typeof d.styles.overflow && (d.text = d.styles.overflow(d.text, h)), d.contentHeight = d.getContentHeight(e.scaleFactor());
                                var c = d.contentHeight / d.rowSpan;
                                d.rowSpan > 1 && n.count * n.height < c * d.rowSpan ? n = {
                                    height: c,
                                    count: d.rowSpan
                                } : n && n.count > 0 && n.height > c && (c = n.height), c > l.height && (l.height = c)
                            }
                        }
                        n.count--
                    }
