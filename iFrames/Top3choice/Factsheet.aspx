<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="Factsheet.aspx.cs" Inherits="iFrames.Top3choice.Factsheet" %>
...
#chartAssetAllocationContainer
{
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //});
            if (($("#hdSchemeId").val() > 0) && ($("#hdSchemeId").val() != 'null')) {
            ...
            <tr>
                <td>
                    <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2">
                                <img src="img/arw1.jpg" /><span class="value_heading">Fund Fact Sheet</span>
                                </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <table id="tblResult" width="100%" border="0" align="left" cellpadding="0" cellspacing="0" runat="server" visible="false">
                                    ...
                                    <tr>
                                        <td class="value_btm_text">Developed and Maintained by: <a href="https://www.icraanalytics.com"
                                                                                                                target="_blank">ICRA Analytics Ltd</a>, <a href="https://icraanalytics.com/home/Disclaimer"
                                                                                                            target="_blank">Disclaimer </a> </td>
                                    </tr>
                                </table>
