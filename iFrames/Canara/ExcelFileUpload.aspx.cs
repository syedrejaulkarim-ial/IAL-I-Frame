        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FileUpload1.HasFile)
                {
                    ...
                    string path1 = HttpContext.Current.Server.MapPath("~/Canara/UploadFile/");
                    ...
                    filepath = HttpContext.Current.Server.MapPath("~/Canara/UploadFile/") + FileUpload1.FileName;
                    fileext = System.IO.Path.GetExtension(filepath);
                    if (fileext.ToLowerInvariant() == ".xlsx")
                    {
                        filename = System.IO.Path.GetFileNameWithoutExtension(filepath);
                        filepath = HttpContext.Current.Server.MapPath("~/Canara/UploadFile/") + filename + "_" + todate + fileext;

                        if (Directory.Exists(HttpContext.Current.Server.MapPath("~/Canara/UploadFiles")))
                        {
                            string[] filePaths = Directory.GetFiles(HttpContext.Current.Server.MapPath("~/Canara/UploadFile"));
