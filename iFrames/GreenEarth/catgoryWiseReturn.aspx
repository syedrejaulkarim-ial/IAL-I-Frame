<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="catgoryWiseReturn.aspx.cs" Inherits="iFrames.GreenEarth.catgoryWiseReturn" %>
...
<body>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h5 style="color:#000">Category wise Mutual Fund Returns (%)</h5>
            </div>
            <div class="card-body">
                <div class="">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pt-2">
                            ...
                            <div class="tabbable boxed parentTabs" >
                                ...
                                <div id="myTabContent" class="tab-content pt-2">
                                                        ...
                                                        <asp:Repeater ID="RepeaterHybrid" runat="server">
                                                            <ItemTemplate>
                                                                <li onclick="FnFetchTopfundData('<%#Eval("Sebi_Sub_Nature_ID").ToString()%>','1','Per_1_Year')"
                                                                    role="presentation" <%# Container.ItemIndex == 0 ? " class='active'" : ""%>>
                                                                    <a href="#SN_<%#Eval("Sebi_Sub_Nature_ID")%>"><%#Eval("Sebi_Sub_Nature")%></a></li>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                    </ul>
                                                </div>
                                    ...
                                    <div class="tab-content" id="dvTopFundData">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (RtnData.length > 0)
                        FNSetData(RtnData, 'Per_1_Year', subNatureId);
                },
                error: function (msg) {
        ...
        function shortbyPeriod(period) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    var RtnData = JSON.parse(msg.d);
                    if (RtnData.length > 0)
                        FNSetData(RtnData, period, subNatureId);
                },
                error: function (msg) {
                    alert("An Error Occured.");
                }
        ...
        function FNSetData(data, period, SN_Id) {
            ...
            Html = Html + "<thead><tr>" +
                ...
                "<th align='center' style='text-align: center'><a onclick='shortbyPeriod(\"" + 'Fund_Size' + "\")' style='text-align:center;cursor:pointer;text-decoration:none; color: #fff;'>AUM (Cr.) &nbsp;<img id='lstResult_Label1' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +

                "<th id='1Week' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Per_7_Days' + "\")' style='text-align:center;cursor:pointer;text-decoration:none; color: #fff;'>1W &nbsp;<img id='Per_7_Days' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +
                "<th id='1Month' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Per_30_Days' + "\")' style='text-align:center;cursor:pointer;text-decoration:none;color: #fff;'>1M &nbsp;<img id='Per_30_Days' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +
                "<th id='3Month' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Per_91_Days' + "\")' style='text-align:center;cursor:pointer;text-decoration:none;color: #fff;'>3M &nbsp;<img id='Per_91_Days' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +
                "<th id='6Month' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Per_182_Days' + "\")' style='text-align:center;cursor:pointer;text-decoration:none;color: #fff;'>6M &nbsp;<img id='Per_182_Days' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +
                "<th id='1Year' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Per_1_Year' + "\")' style='text-align:center;cursor:pointer;text-decoration:none;color: #fff;'>1Y &nbsp;<img id='Per_1_Year' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +
                "<th id='3Year' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Per_3_Year' + "\")' style='text-align:center;cursor:pointer;text-decoration:none;color: #fff;'>3Y &nbsp;<img id='Per_3_Year' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +
                "<th id='5Year' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Per_5_Year' + "\")' style='text-align:center;cursor:pointer;text-decoration:none;color: #fff;'>5Y &nbsp;<img id='Per_5_Year' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th>" +
                "<th id='SI' style='text-align: center;'><a onclick='shortbyPeriod(\"" + 'Since_Inception' + "\")' style='text-align:center;cursor:pointer;text-decoration:none;color: #fff;'>SI &nbsp;<img id='Since_Inception' src='/GreenEarth/images/down-arrow.png' style='height: 12px; width: 12px;'></a></th></tr></thead>";
            for (v = 0; v < data.length; v++) {
                var schName = data[v].Sch_Name;               
                var strTr = "<tr class='home_body'>";                
                //strTr = strTr + "<td>" + data[v].Sch_Name + "</td>";
                strTr = strTr + "<td title='" + (schName) + "'><a href='/GreenEarth/Factsheet.aspx?param=" + data[v].SchemeId + "' target='_blank'>" + (schName.length > 56 ? schName.substring(0, 56)+"..." : schName) + "</a></td>";
