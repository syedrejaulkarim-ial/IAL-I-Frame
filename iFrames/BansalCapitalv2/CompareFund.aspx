                        ...
                        <div class="block-content collapse in">
                            ...
                            <asp:GridView ID="GrdCompFund" runat="server" class="table table-striped table-bordered" Style="font-size: 12px;" Width="100%" AutoGenerateColumns="false"
                                ...
                                <%#Eval("Structure_Name").ToString() != "" ? Eval("Structure_Name") : "NA"%> </asp:Label>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label ID="Label4" runat="server" SkinID="lblHeader" Text="Watch List"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label ID="Label5" runat="server" SkinID="lblHeader" Text="Invest Now"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
