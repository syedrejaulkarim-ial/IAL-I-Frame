...
{
    public partial class compareFnd : System.Web.UI.Page
    {
        #region GlobalVar
   ...
   Convert.ToInt32(rdbOption.SelectedValue), lstMutFund, false);
        ...
        public string SetHyperlinkFundDetail(string schemeId, string SchemeName)
        {
            ...
            if (schemeId != "-1")
                ...
                resultStr = " <a href='/Finvoy/Factsheet.aspx?param=" + schemeId + "' id='urlID' target='_blank'>" + SchemeName + "</a>";
            else
        ...
        {
            Response.Redirect("/Finvoy/compareFnd.aspx");
            //ddlSchemes.Items.Clear();
            //getFundHouse();
            //getIndicesName();
            //LoadNature();
