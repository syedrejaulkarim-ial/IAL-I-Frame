<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="compareFnd.aspx.cs"
    Inherits="iFrames.Finvoy.compareFnd" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function btnPlotclick() {
            ...
            $.ajax({
                type: "POST",
                url: "compareFnd.aspx/getChartData",
                async: false,
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-2 col-sm-2 col-md-2 col-lg-1 pt-22 text-right"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-2 col-sm-2 col-md-1 col-lg-1 pt-22 text-right"
                                        style="padding-left: 0">
                                    ...
                                    <div class="" style="margin-top: 20px;">
                                        ...
                                        <div style="text-align: right; padding-bottom:10px" class="pt-1">
                                            <asp:Button ID="btnCompareFund" runat="server" Text="Show Performance"
                                                class="btn btn-warning btn-xs pul-right" OnClientClick="validateList();"
