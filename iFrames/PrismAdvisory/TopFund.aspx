<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopFund.aspx.cs" Inherits="iFrames.PrismAdvisory.TopFund" %>
                     ...
                     <ItemTemplate>
                                    <tr class='<%# Convert.ToBoolean(Container.DataItemIndex % 2) ? "" : "" %>'>
                                        ...
                                        <td style="width: 35%;">
                                           ...
                                           <a href="/PrismAdvisory/Factsheet.aspx?param=<%#Eval("SchemeId")%>" target="_blank"><%#Eval("Sch_Name")%></a>
                                        </td>
