<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ICRAFundManager.aspx.cs" Inherits="iFrames.ICRA.ICRAFundManager" %>
        ...
        $(document).ready(function () {
            ...
            /*  $("#BtnExcle").click(function (e) {
                  ...
                  $.ajax({
                      ...
                      data: dataToPush,
                      dataType: "json",
                      url: 'ICRAFundManager.aspx/ExportToExcel',
                      type: 'POST',
                      asynchronus: true,
            ...
            $("#BtnSubmit").click(function (e) {
                ...
                $.ajax({
                    ...
                    data: dataToPush,
                    dataType: "json",
                    url: 'ICRAFundManager.aspx/ShowSchemeWiseReport',
                    type: 'POST',
                    asynchronus: true,
                    contentType: "application/json; charset=utf-8",
                    beforeSend: function () {
                    ...
                    success: function (dataConsolidated) {
                        ...
                        if (SchData.PageDataReturnHeader.length > 0) {
                            ...
                            for (i = 0; i < SchData.PageDataReturnHeader.length; i++) {
                                HeadRow1 = HeadRow1 + '<th colspan=2>' + SchData.PageDataReturnHeader[i] + '</th>';
                            }
            ...
            function GenerateTable() {
                ...
                $.ajax({
                    ...
                    data: dataToPush,
                    dataType: "json",
                    url: 'ICRAFundManager.aspx/ShowFundManagerSchemeWiseReport',
                    type: 'POST',
                    asynchronus: true,
                    contentType: "application/json; charset=utf-8",
                    beforeSend: function () {
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label-select">Option</label>
                                        <div class="col-sm-5">
                                     ...
                                     <asp:DropDownList ID="ddlFundHouse" runat="server" AutoPostBack="true"
                                            OnSelectedIndexChanged="ddlMutualFund_SelectedIndexChanged" class="form-control">
                                        </asp:DropDownList>
                                              </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label-select"> Scheme</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label-select">Benchmark</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label-select">Value of Investment</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label-select">Value as on Date</label>
                                        <div class="col-sm-3">
