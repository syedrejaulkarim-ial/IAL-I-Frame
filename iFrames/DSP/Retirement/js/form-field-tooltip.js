...
function DHTMLgoodies_formTooltip()
{
	...
	this.tooltipBgColor = '#e3e8ec';
	this.tooltipBorderColor = '#d7d7d7 1px solid';
	this.tooltipBorderWidth = '1px';
	this.closeMessage = '';
...
DHTMLgoodies_formTooltip.prototype = {
     ...
     * @public
     */	
	 settooltipBorderColor : function(newBorderColor)
	{
		this.tooltipBorderColor = newBorderColor;
	}
