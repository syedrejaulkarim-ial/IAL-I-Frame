...
{
    public partial class DSPCalc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (eventTarget != null)
            {
                buttonClicked = (eventTarget.Substring(eventTarget.LastIndexOf("$") + 1).Equals("LinkButtonGenerateReport") || eventTarget.Substring(eventTarget.LastIndexOf("$") + 1).Equals(""));
            }
            if (!buttonClicked)
            {
                Response.Write("<div id=\"loading\" style=\"position:absolute; width:100%; text-align:center; top:300px;\"><img src=\"IMG\\Loading.gif\" border=0></div>");
                Response.Flush();
            }
        ...
        protected void sipbtnshow_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                if (Convert.ToDouble(txtinstallLs.Text) >= 500)
                {
        ...
        protected void FillNature()
        {
            try
            {
                using (var natureData = new PrincipalCalcDataContext())
                {
                    ...
                    string[] natureExcluded = { "N.A", "Speciality", "ETF", "Dynamic/Asset Allocation", "Balanced", "Liquid", "Debt", "Regular" };
        ...
        public System.Data.DataTable FetchScheme()
        {
            ...
            //changed Scheme Filteration - Liquid will be in Fixed Income and Dynamic/Asset will be in Hybrid - 01/04/21
            ...
            try
            {
                ...
                using (var scheme = new PrincipalCalcDataContext())
                {
                    ...
                    else// WHEN THE NATURE IS SELECTED
                    {
                        ...
                        {
                            lstnatureSelected.Add("Debt"); lstnatureSelected.Add("Balanced"); lstnatureSelected.Add("Dynamic/Asset Allocation"); //Dynamic Asset Allocation Added in Hybrid
                        }
                        ...
                        if (selected_nature == "Hybrid")
                        {
                            fundtable = (from t_fund_masters in scheme.T_FUND_MASTERs
                                         where
                                             t_fund_masters.MUTUALFUND_ID == 9 && t_fund_masters.STRUCTURE_ID != 3 &&
                                           ((t_fund_masters.NATURE_ID == 22 && t_fund_masters.SUB_NATURE_ID == 8) || (t_fund_masters.NATURE_ID == 7) || (t_fund_masters.NATURE_ID == 11))
                                         select new
                                         {
                                             t_fund_masters.FUND_ID,
                                             t_fund_masters.NATURE_ID,
                        ...
                        //changed on 01/04/2021 - SIP will contain liquidity same fund will be there in every dropdown
                        if (selected_mode.ToUpper().StartsWith("SIP"))
                        {
                            var d = from ft in fundtable
        ...
        private void ShowExcel()
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=DSP_Detail_Report.xls");
            Response.Charset = "";
        ...
        public void CreateHTMLDSPSIP()
        {
            ...
            try
            {
                ...
                if (Session["GUID"] != null)
                {
                    ...
                    string Filpath = Server.MapPath("~/DSP/PDF/DSP_" + pdfName);
                    System.IO.FileInfo file = new System.IO.FileInfo(Filpath);
                    if (file.Exists)
                    {
                        Response.Clear();
                        Response.AddHeader("Content-Disposition", "attachment; filename=DSP_Sample.pdf" + file.Name);
