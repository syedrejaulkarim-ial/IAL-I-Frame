<%@ Page Language="C#" AutoEventWireup="true" ViewStateEncryptionMode="Always" EnableViewStateMac="true" CodeBehind="NAVGraph.aspx.cs" Inherits="iFrames.HSBC.Tools.NAVGraph" %>
    ...
    <div style="width: 81%; margin: 0 auto">
        <form id="Form1" runat="server">
           ...
           <%-- <div class="navbar" align="center" style="width: 953px; margin-left: 7px; margin-top: -55px; display: none">
            ...
            <asp:HiddenField ID="txtNAV_dt" runat="server"/>
                            ...
                            <div class="span12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-content collapse in">                                       
                                        <%--<div class="controls" style="margin-bottom: 10px;" id="Div_Dividend">
                        ...
                        <div class="tabbable-panel" style="padding: 0;">
                            <div class="tabbable-line">
                                ...
                                <%#Eval("Per_3_Year").ToString() != "" ? Eval("Per_3_Year") : "NA"%> </asp:Label>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        <asp:LinkButton ID="Lnk5yr" runat="server" Font-Bold="true" Text="5 Yrs"
                                                                            Font-Overline="false" CommandName="Per_5_Year" CssClass="text"></asp:LinkButton>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl5yr" runat="server">
                                <%#Eval("Per_5_Year").ToString() != "" ? Eval("Per_5_Year") : "NA"%> </asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                ...
                                <%#Eval("Per_Since_Inception").ToString() != "" ? Eval("Per_Since_Inception") : "NA"%> </asp:Label>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        ...
                                                                        <asp:Label ID="Label5" runat="server" SkinID="lblHeader" Text='<%#txtNAV_dt.Value%>'></asp:Label>
                                                                        <asp:Label ID="Label6" runat="server" SkinID="lblHeader" Text=")"></asp:Label>    
                                                                ...
                                                                <table class="table table-bordered">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th rowspan="2">Calculation Date</th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr style="border-width: 1px; border-style: solid;
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td align="center" class="over-night">
                                                                        <%# Eval("Calculation_Date").ToString()%>
                                                                    </td>
