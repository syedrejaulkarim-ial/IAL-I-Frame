...
{
    public partial class returnCalcUat : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                foreach (DataColumn dc in _dt.Columns)
                {
                    ...
                    else if (dc.ColumnName.ToUpper() == "INDEX_VALUE_AMOUNT")
                    {
                        ...
                        chrt.Series[dc.ColumnName].Color = System.Drawing.Color.Green;//#02509b //System.Drawing.ColorTranslator.FromHtml("#02278b");//
